...
#
CaseGuid        8BEF5682-0CD0-4158-9DBB-C48EA68D72D1
CaseName        Transmit.Conf5.Case1
CaseCategory    UDP6
CaseDescription {Test the Transmit Conformance of UDP6 - Invoke Transmit() when    \  
                 TxData.FragmentCount is zero.EFI_INVALID_PARAMETER should be returned.}
################################################################################
...
# BeginScope
#
BeginScope _UDP6_TRANSMIT_CONF5_
...
# 
# Check point: Call Transmit function when TxData.FragmentCount is zero.  \
...
RecordAssertion $assert $Udp6TransmitConf5AssertionGuid001            \
                "Udp6.Transmit -conf- Call Transmit when TxData.FragmentCount is zero" \
...
# EndScope
#
EndScope    _UDP6_TRANSMIT_CONF5_
#
# End Log 
#
EndLog