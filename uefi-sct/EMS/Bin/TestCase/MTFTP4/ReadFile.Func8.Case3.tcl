...
#
CaseGuid        50E6CB5F-7742-43a2-A07E-7D1766AE4AC0
CaseName        ReadFile.Func8.Case3
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile, server  \
                 responds data packet with data length bigger than blocksize.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION8_CASE3_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION8_CASE3_
...
#
# If have captured the packet. server responds data packet with data length    
...
SendPacket [ Mtftp4CreateData 1234 $EFI_MTFTP4_OPCODE_DATA 1 600]
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid017                    \
                "Mtftp4.ReadFile - server responds data packet with data length\
                 bigger than blocksize."                                       \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
