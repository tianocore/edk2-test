...
#
CaseGuid        D95CEB56-65F4-42aa-9BF6-4B23D4BDEE54
CaseName        ReadDirectory.Func1.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadDirectory -   \
                 return a list of files on the MTFTPv4 server that are logically\
                (or operationally) related to Token->Filename.}
################################################################################
...
#
# If have captured the packet. return a list of files on the MTFTPv4 server that
# are logically (or operationally) related to Token->Filename.
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadDirectoryFuncAssertionGuid001               \
                "Mtftp4.ReadDirectory - return a list of files on the MTFTPv4  \
