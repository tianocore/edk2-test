...
#
CaseGuid        D5EBAC8F-C773-457e-8B81-68F2524B7BB2
CaseName        ReadDirectory.Conf4.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_UNSUPPORTED conformance of       \
                 Mtftp4.ReadDirectory when one or more options in the          \
                 Token->OptionList are in the unsupported list of this         \
                 implementation.}
################################################################################
...
BeginScope _MTFTP4_READDIRECTORY_CONFORMANCE4_CASE1_
...
RecordAssertion $assert $Mtftp4ReadDirectoryConfAssertionGuid010               \
                "Mtftp4.ReadDirectory - returns EFI_UNSUPPORTED when one or    \
                 more options in the R_Token->OptionList are in the unsupported\
                 list of this implementation."                                 \
...
EndScope _MTFTP4_READDIRECTORY_CONFORMANCE4_CASE1_
