...
#
CaseGuid          6211A5AC-028B-4a72-A873-77E1ADB6284C
CaseName          GetInfo.Conf1.Case3
CaseCategory      MTFTP4
CaseDescription   {This case is to test the EFI_INVALID_PARAMETER conformance  \
                   of Mtftp4.GetInfo when OptionCount is not zero and          \
                   OptionList is NULL.}
################################################################################
...
BeginScope _MTFTP4_GETINFO_CONFORMANCE1_CASE3_
...
Mtftp4->GetInfo {&@R_OverrideData, &@R_Filename, NULL, @R_OptionCount, NULL,   \
                 &@R_PacketLength, &@R_Packet, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4GetInfoConfAssertionGuid005                     \
                "Mtftp4.GetInfo() - returns EFI_INVALID_PARAMETER              \
                 when OptionCount is not zero and OptionList is NULL."         \
...
EndScope _MTFTP4_GETINFO_CONFORMANCE1_CASE3_
