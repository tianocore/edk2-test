...
#
CaseGuid        5332336E-D374-4266-91CC-59C27D11DFF7
CaseName        WriteFile.Conf7.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the function of Mtftp4.WriteFile - User  \
                 aborts the upload process in TimeoutCallback routine.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_WRITEFILE_CONFORMANCE7_CASE2_
  EndLog
}
...
BeginScope _MTFTP4_WRITEFILE_CONFORMANCE7_CASE2_
...
Mtftp4->WriteFile {&@R_Token, 1, 2, 1, &@R_Status}
...
RecordAssertion $assert $Mtftp4WriteFileConfAssertionGuid014                   \
                "Mtftp4.WriteFile - returns EFI_ABORTED,User aborts the upload \
                 process in TimeoutCallback routine."                          \
