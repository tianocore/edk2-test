...
#
CaseGuid          4933D2DC-CBFE-4a9b-AA64-4808A5400F36
CaseName          UrgHandling.Func2.Case4
CaseCategory      TCP
CaseDescription   {This item is to test the [EUT] correctly receives urgent    \
                   ...
                   pointer exceed the sequence of FIN flag.}
################################################################################
...
BeginLogPacket UrgHandling.Func2.Case4    "host $DEF_EUT_IP_ADDR and host      \
                                                $DEF_ENTS_IP_ADDR"
...
UpdateTcpSendBuffer TCB -c $L_TcpFlag -p DataPayload -u 512
SendTcpPacket TCB
ReceiveTcpPacket TCB 5
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4UrgHandlingFunc2AssertionGuid004                  \
                "Tcp4.Receive - Receive data."                                 \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
