...
#
CaseGuid          820BD81C-EA90-27a8-2284-BF2BC9E6AC35
CaseName          Receive.Func3.Case4
CaseCategory      TCP
...
BeginLogPacket Receive.Func3.Case4 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
set    L_FragmentLength_1        100
set    L_SpaceLength             400
set    L_FragmentLength_2        500
set    L_FragmentLength_3        300
set    L_OverlapLength           100
...
# OS send DATA & ACK segment
#
set tmp_seq   [ expr ${TCB.l_isn} + ${TCB.l_next_seq} + $L_SpaceLength ]
set L_TcpFlag [ expr $PSH | $ACK ]
...
# OS send DATA & ACK segment
#
set tmp_seq   [ expr ${TCB.l_isn} + ${TCB.l_next_seq} + $L_SpaceLength - { $L_FragmentLength_3 - $L_OverlapLength } ]
set L_TcpFlag [ expr $PSH | $ACK ]
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4ReceiveFunc3AssertionGuid004                      \
