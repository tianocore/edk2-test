...
#
CaseGuid          2619F2E7-BC0F-414f-A114-D54D3C73750C
...
BeginLogPacket Receive.Conf1.Case1 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#
# Check Point: Call Tcp4.Receive, without previous call [TCP4]->Configure().
#
...
RecordAssertion $assert $Tcp4ReceiveConf1AssertionGuid001                      \
                "Tcp4.Receive - Call Receive() to receive a packet without     \
                 calling Configure() previously."                              \
