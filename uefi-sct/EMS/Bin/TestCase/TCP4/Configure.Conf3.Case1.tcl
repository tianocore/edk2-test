...
#
CaseGuid          5CE924F9-4E3C-4395-B091-E28C1C56E418
CaseName          Configure.Conf3.Case1
CaseCategory      TCP
CaseDescription   {This case is to test the conformance - EFI_ACCESS_DENIED.   \
                  -- Configuring TCP instance when it is not in Tcp4StateClosed\
                  state.}
################################################################################
...
#
# Check Point: Call Tcp.Configure() to configure the TCP instance,
#              when it is not in Tcp4StateClosed state.
#
Tcp4->Configure {&@R_Configure_Tcp4ConfigData, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_ACCESS_DENIED]
RecordAssertion $assert $Tcp4ConfigureConf3AssertionGuid001                    \
                "Tcp4.Configure - Call Configure() when it is not in           \
