...
BeginLogPacket Options.Func5.Case2 "host $DEF_EUT_IP_ADDR and host             \
                                         $DEF_ENTS_IP_ADDR"
...
# boundary
#
CreatePayload CombinedOptions Data 8 0x01 0x01 0x02 0x04 0x01 0x00 0x01 0x01
...
if { ${TCB.received} == 1 } {
  if { ${TCB.r_f_ack} != 1 } {
    set assert fail
    RecordAssertion $assert $Tcp4OptionsFunc3AssertionGuid002                  \
