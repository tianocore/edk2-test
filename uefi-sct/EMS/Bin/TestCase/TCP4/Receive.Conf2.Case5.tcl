...
#
CaseGuid          8F4D5EAB-3497-463b-99FA-884A5DFDA4DB
CaseName          Receive.Conf2.Case5
CaseCategory      TCP
...
BeginLogPacket Receive.Conf3.Case5 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
CreatePayload HelloWorld STRING 14 "Hello, World!"
...
#
# Check Point: Call Tcp4.Receive() to receive a packet,
#              with the Token->Packet.RxData->DataLength is not the sum of all \
#              FragmentBuffer length in FragmentTable.
#
BS->CreateEvent "$EVT_NOTIFY_SIGNAL, $EFI_TPL_CALLBACK, 1, &@R_Context,        \
...
SetVar R_RxData.DataLength                [expr $L_FragmentLength - 1]
...
RecordAssertion $assert $Tcp4ReceiveConf2AssertionGuid005                      \
                "Tcp4.Receive - Call Receive() to receive a packet with        \
                 with the Token->Packet.RxData->DataLength being not the sum of\
                 all FragmentBuffer length in FragmentTable."                  \
