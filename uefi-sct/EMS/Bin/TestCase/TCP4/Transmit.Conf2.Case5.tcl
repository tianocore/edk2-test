...
#
CaseGuid          801B762F-3D1F-4c0d-834A-CCDA48CE04E2
CaseName          Transmit.Conf2.Case5
CaseCategory      TCP
CaseDescription   {This case is to test the conformance - EFI_INVALID_PARAMETER\
                  -- Token->Packet.DataLength is not equal to the sum of       \
                  fragment lengths.}
################################################################################
...
BeginLogPacket Transmit.Conf.Case "host $DEF_EUT_IP_ADDR and host              \
                                             $DEF_ENTS_IP_ADDR"
#
...
#              with Token->Packet.DataLength is not equal to the sum of        \
#              fragment lengths.
#
BS->CreateEvent "$EVT_NOTIFY_SIGNAL, $EFI_TPL_CALLBACK, 1, &@R_Context,        \
...
SetVar R_TxData.DataLength                [expr $L_FragmentLength + 1]
...
RecordAssertion $assert $Tcp4TransmitConf2AssertionGuid005                     \
