...
#
CaseGuid          7A1BC81F-EA90-87a8-8582-DA2BC9E60C1A
CaseName          Receive.Func3.Case1
CaseCategory      TCP
...
BeginLogPacket Receive.Func3.Case1 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
# OS send DATA & ACK segment
#
set tmp_seq   [ expr ${TCB.l_isn} + $L_FragmentLength_1 + $L_SpacepLength ]
set L_TcpFlag [ expr $PSH | $ACK ]
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4ReceiveFunc3AssertionGuid001                      \
