...
#
CaseGuid          012DEE80-A4C2-48fb-A713-427B23598DF5
CaseName          Connect.Conf3.Case2
CaseCategory      TCP
...
BeginLogPacket Connect.Conf3.Case2 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#              with ConnectionToken->CompletionToken.Event is NULL.
#
...
RecordAssertion $assert $Tcp4ConnectConf3AssertionGuid002                      \
                "Tcp4.Connect - Call Tcp4.Connect() for an active TCP instance \
                 with ConnectionToken->CompletionToken.Event is NULL."          \
