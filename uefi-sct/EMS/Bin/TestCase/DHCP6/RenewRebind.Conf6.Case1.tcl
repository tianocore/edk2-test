...
#
CaseGuid        4B3E8C8E-611A-4fe0-9BC7-4A3023306060
CaseName        RenewRebind.Conf6.Case1
CaseCategory    DHCP6
...
proc CleanUpEutEnvironment {} {
    ...
    # EndScope
    #
    EndScope _DHCP6_RENEWREBIND_CONF6
    #
    # End Log 
    #
    EndLog
...
# BeginScope
#
BeginScope  _DHCP6_RENEWREBIND_CONF6
...
# o Dhcp6Callback              3   0:NULL 1:Abort 2:CallbackContext++ 3:Abort in RenewRebind,Release.
# o CallbackContext            0          
# o OptionCount                0        
# o OptionList                 0          
...
#
# Check point: Call RenewRebind() with RebindRequest FALSE.
#              The user returns EFI_ABORTED at Dhcp6EnterRenewing event.
#              EFI_ABORTED should be returned.
#
Dhcp6->RenewRebind  "FALSE, &@R_Status"
GetAck
set assert    [VerifyReturnStatus R_Status $EFI_ABORTED]
RecordAssertion $assert $Dhcp6RenewRebindConf6AssertionGuid001        \
                "Dhcp6.RenewRebind - The user returns error from callback function."   \
