...
#
CaseGuid        CDD82386-5799-46da-B712-8DBD98F8EAF2
CaseName        Configure.Conf2.Case5
CaseCategory    DHCP6
CaseDescription {Test the Configure Conformance of DHCP6 - Invoke Configure()       \
                 with OptionList containing IA for Temporary Addresses Option.  \
...
#
# Build an option of IA_TA
#
UINT8          R_OpData(4)
SetVar         R_OpData                             {0x00 0x00 0x00 0x01}
EFI_DHCP6_PACKET_OPTION                             R_OptPacketIATA
SetVar         R_OptPacketIATA.OpCode               $Dhcp6OptIATA
SetVar         R_OptPacketIATA.OpLen                12
SetVar         R_OptPacketIATA.Data                 @R_OpData

POINTER        R_OptionPtr
SetVar         R_OptionPtr                          &@R_OptPacketIATA
...
# o CallbackContext            0          
# o OptionCount                1
# o OptionList                 Invalid:   Contains IATA option           
...
RecordAssertion $assert $Dhcp6ConfigureConf2AssertionGuid005                   \
                "Dhcp6.Config - Option List contains IA for Temporary Addresses Option"         \
