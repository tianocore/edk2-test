...
#
CaseGuid        2767049E-E87B-4ca5-B26C-D1ECBEBBE369
CaseName        RenewRebind.Conf4.Case1
CaseCategory    DHCP6
CaseDescription {Test the RenewRebind Conformance of DHCP6 - Invoke RenewRebind() \
                 with RebindRequest FALSE when the instance is in the Dhcp6Renewing state. \
...
proc CleanUpEutEnvironment {} {
    ...
    # EndScope
    #
    EndScope _DHCP6_RENEWREBIND_CONF4_
    #
    # End Log 
    #
    EndLog
...
# BeginScope
#
BeginScope  _DHCP6_RENEWREBIND_CONF4_
...
#
# Check point: After start successful, call RenewRebind() with RebindRequest FALSE.
#              The instance stays in Dhcp6Renewing state until Reply is received.
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                  \
                "Dhcp6.RenewRebind - Renew Child 1"                  \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
#
# Check point: Call RenewRebind() with RebindRequest FALSE when the instance in Dhcp6Renewing state.
#              EFI_ALREADY_STARTED should be returned.      
#
Dhcp6->RenewRebind "FALSE, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_ALREADY_STARTED]
RecordAssertion $assert $Dhcp6RenewRebindConf4AssertionGuid001                 \
