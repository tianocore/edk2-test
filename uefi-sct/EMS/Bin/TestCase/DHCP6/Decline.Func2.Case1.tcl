...
#
CaseGuid        CF4381B3-88EA-43cb-AC9B-64C4827B94E0
CaseName        Decline.Func2.Case1
CaseCategory    DHCP6
...
# EndScope
#
EndScope _DHCP6_DECLINE_FUNC2_
#
# End Log 
#
EndLog
...
# BeginScope
#
BeginScope  _DHCP6_DECLINE_FUNC2_
...
#
# Check point: Call Decline to inform that all the Ipv6 address that assigned \
#              have already been used by other nodes
#
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Dhcp6DeclineFunc2AssertionGuid001 \
                "Dhcp6.Decline- Inform that all Ipv6 addresses assigned have already been used by other nodes" \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"

#
# Check point: After the Decline exchange process returns,the state of IA should be Dhcp6Init.
#
