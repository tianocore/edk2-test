...
#
CaseGuid        E45097BC-2AEE-48bc-8669-CFA2AEE101EB
CaseName        Release.Conf3.Case1
CaseCategory    DHCP6
CaseDescription {Test the Release Conformance of DHCP6 - Invoke Release() \
                 when AddressCount larger than zero and Addresses NULL. \
...
proc CleanUpEutEnvironment {} {
    ...
    # EndScope
    #
    EndScope _DHCP6_RELEASE_CONF3_
    #
    # End Log 
    #
    EndLog
...
# BeginScope
#
BeginScope  _DHCP6_RELEASE_CONF3_
...
#
# Check point: Call Release() with AddressCount 0 and Addresses NULL
#              EFI_INVALID_PARAMETER should be returned.
#
Dhcp6->Release "1, NULL, &@R_Status"
GetAck

set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Dhcp6ReleaseConf3AssertionGuid001           \
                "Dhcp6.Release - AddressCount larger than zero while Address NULL." \
