...
#
CaseGuid        1F1BDA84-D3AD-4be8-8502-CCFD8F000598
CaseName        Release.Conf5.Case1
CaseCategory    DHCP6
...
proc CleanUpEutEnvironment {} {
    ...
    # EndScope
    #
    EndScope _DHCP6_RELEASE_CONF5_
    #
    # End Log 
    #
    EndLog
...
# BeginScope
#
BeginScope  _DHCP6_RELEASE_CONF5_
...
#
# Check point: Call Release().
#              The user returns EFI_ABORTED at Dhcp6SendRelease event.
#              EFI_ABORTED should be returned.
#
...
RecordAssertion $assert $Dhcp6ReleaseConf5AssertionGuid001       \
                "Dhcp6.Release - The user returns error from callback function."  \
