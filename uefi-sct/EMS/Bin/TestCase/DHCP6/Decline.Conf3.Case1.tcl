...
proc CleanUpEutEnvironment {} {
    ...
    # EndScope
    #
    EndScope _DHCP6_DECLINE_CONF3_
    #
    # End Log 
    #
    EndLog
...
# BeginScope
#
BeginScope  _DHCP6_DECLINE_CONF3_
...
#
# Check point: Call Decline() with AddressCount 0
#              EFI_INVALID_PARAMETER should be returned.
#
UINT32                                   R_AddressCount
EFI_IPv6_ADDRESS                         R_Addresses
SetVar R_AddressCount                    0
...
RecordAssertion $assert $Dhcp6DeclineConf3AssertionGuid001           \
                "Dhcp6.Decline - AddressCount is zero."                       \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"

#
# Check point: Call Decline() with Addresses NULL.
#              EFI_INVALID_PARAMETER should be returned.
#
SetVar R_AddressCount                    1

Dhcp6->Decline  "@R_AddressCount, 0, &@R_Status"
GetAck

set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Dhcp6DeclineConf3AssertionGuid002          \
                "Dhcp6.Decline - Addresses is NULL."                       \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"
