...
#
CaseGuid        44E24E1E-B763-4ca2-A33A-B47B8337CA45
CaseName        Release.Func4.Case1
CaseCategory    DHCP6
...
# EndScope
#
EndScope _DHCP6_RELEASE_FUNC4_
#
# End Log 
#
EndLog
...
# BeginScope
#
BeginScope  _DHCP6_RELEASE_FUNC4_
...
RecordAssertion $assert $Dhcp6ReleaseFunc4AssertionGuid001 \
                "Dhcp6.Release-Release all the Ipv6 addresses that have already assigned to IA with no response from server" \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_NO_RESPONSE"
#
# Check point: the Release function will be succeed with no response from server\
#              while the state of IA should be Dhcp6Init.
#
...
RecordAssertion $assert  $Dhcp6ReleaseFunc4AssertionGuid002 \
                "When Release finished, the state of IA should be Dhcp6Init"
