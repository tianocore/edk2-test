...
CaseGuid        697BF2B9-16A2-4a0f-ACF5-9DA66BA0A22D
CaseName        Stop.Func1.Case1
CaseCategory    IP4Config
CaseDescription {Test the function of IP4Config.Stop}
...
proc CleanUpEutEnvironment {} {
  ...
  EndScope _IP4CONFIG_STOP_FUNC1
...
# BeginScope
#
BeginScope _IP4CONFIG_STOP_FUNC1
...
#
# Check Point: Call Ip4Config->Stop to Stop configuration.
#
Ip4Config->Stop "&@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Ip4ConfigStopFunc1AssertionGuid001                    \
