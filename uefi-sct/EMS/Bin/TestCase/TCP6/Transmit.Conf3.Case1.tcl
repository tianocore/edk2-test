...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_TRANSMIT_CONF3_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_TRANSMIT_CONF3_CASE1_
...
SetVar R_Transmit_CompletionToken.Event 0
...
RecordAssertion $assert $Tcp6TransmitConf3AssertionGuid001                     \
                "Tcp6.Transmit - Call Transmit() with event NULL."     \
