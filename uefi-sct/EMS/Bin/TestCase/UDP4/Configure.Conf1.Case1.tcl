...
#
CaseGuid        0837794D-5FBD-47f3-82C2-8E733E6CAAC5
CaseName        Configure.Conf1.Case1
CaseCategory    Udp4
CaseDescription {Test the Configure Conformance of UDP4 - Invoke Configure()   \
                 with the parameter StationAddress being a multicast address.The\
...
# Begin Scope
#
BeginScope _UDP4_CONFIGURE_CONFORMANCE1_CASE1_
...
set targetport                 999
set hostport                   666
set invalid_station_address    224.0.0.1
...
SetIpv4Address R_Udp4ConfigData.StationAddress      $invalid_station_address
...
RecordAssertion $assert $Udp4ConfigureConf1AssertionGuid001                    \
...
# End scope
#
EndScope _UDP4_CONFIGURE_CONFORMANCE1_CASE1_
