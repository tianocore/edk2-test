...
#
CaseGuid        CD43E5FC-8217-41e1-9E62-AD4D4FAF48D4
CaseName        ReadFile.Func4.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadFile function of MTFTP6,invoke ReadFile()with aborted\
                 by user for asynchronous calling.EFI_SUCCESS should be returned.
                }
################################################################################
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READFILE_FUNCTION4_CASE1_
...
BeginScope _MTFTP6_READFILE_FUNCTION4_CASE1_
...
#
# Check Point: Call ReadFile with aborted by user for asynchronous \
...
Mtftp6->ReadFile "&@R_Token, 2, 4, 4, &@R_Status"
GetAck
...
RecordAssertion $assert $Mtftp6ReadFileFunc4AssertionGuid002     \
...
RecordAssertion $assert $Mtftp6ReadFileFunc4AssertionGuid003       \
                "When returned, the R_Token.Status should be EFI_ABORTED"
