...
#
CaseGuid        B5FC04F4-C894-42fb-8553-90AA5239115A
CaseName        WriteFile.Conf7.Case1
CaseCategory    MTFTP6
CaseDescription {Test WriteFile conformance of MTFTP6,invoke WriteFile()      \
                 when ServerIp in Override data is an invalid unicast address.\   
...
BeginScope _MTFTP6_WRITEFILE_CONFORMANCE7_CASE1_
...
#
# Check Point: Call WriteFile when ServerIp in Override data is an invalid unicast address. \
#              EFI_INVALID_PARAMETER should be returned.
# 
...
RecordAssertion $assert $Mtftp6WriteFileConf7AssertionGuid001                        \
                "Mtftp6.WriteFile -Conf- Call WriteFile when ServerIp in Override data is an invalid unicast address."\
...
EndScope _MTFTP6_WRITEFILE_CONFORMANCE7_CASE1_
