...
#
CaseGuid        850F40E6-2F43-4967-80DA-67E25FFF72D2
CaseName        ReadDirectory.Conf7.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadDirectory conformance of MTFTP6,invoke ReadDirectory()    \
                 when ServerIp in OverrideData is an invalid unicast address.  \
...
BeginScope _MTFTP6_READDIRECTORY_CONFORMANCE7_CASE1_
...
#
# Check Point: Call ReadDirectory when ServerIp in OverrideData is an invalid unicast address. \
#              EFI_INVALID_PARAMETER should be returned.
# 
...
RecordAssertion $assert $Mtftp6ReadDirectoryConf7AssertionGuid001       \
                "Mtftp6.ReadDirectory -Conf- Call ReadDirectory when ServerIp in OverrideData is an invalid unicast address."  \
...
EndScope _MTFTP6_READDIRECTORY_CONFORMANCE7_CASE1_
