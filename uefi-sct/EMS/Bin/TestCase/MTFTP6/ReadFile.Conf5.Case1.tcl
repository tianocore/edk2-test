...
#
CaseGuid        E06CE30B-681A-4ab4-9003-33AF62698BB7
CaseName        ReadFile.Conf5.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadFile conformance of MTFTP6,invoke ReadFile() \
                 when one or more options in option list is wrong format.\
...
BeginScope _MTFTP6_READFILE_CONFORMANCE5_CASE1_
...
#
# Check Point: Call ReadFile when one or more options in optionlist is \
#              wrong format.EFI_NO_RESPONSE should be returned.
# 
...
RecordAssertion $assert $Mtftp6ReadFileConf5AssertionGuid001    \
                "Mtftp6.ReadFile -Conf- Call ReadFile when one or more options in optionlist is wrong format"   \
...
EndScope _MTFTP6_READFILE_CONFORMANCE5_CASE1_
