...
#
CaseGuid           E1865607-E7D5-4435-8048-6EC18F026193
CaseName           Neighbors.Conf5.Case1
CaseCategory       IP6
CaseDescription    { Test the Neighbors Function of IP6 - invoke Neighbors()        \
                     when TargetIpAddress is not a valid unicast Ipv6 Address       \
...
# Begin Scope ...
#
BeginScope        IP6_NEIGHBORS_CONF5_CASE1_
...
SetIpv6Address        R_TargetIp6Address   "ff02::1"
...
#
# Check point: Call Neighbors Function when *TargetIpAddress is not a valid unicast IPv6 address.
#             EFI_INVALID_PARAMETER should be returned.
#
Ip6->Neighbors "@R_DeleteFlag, &@R_TargetIp6Address, &@R_TargetLinkAddress, @R_Timeout, @R_Override, &@R_Status"
GetAck
set assert [VerifyReturnStatus  R_Status  $EFI_INVALID_PARAMETER]
RecordAssertion  $assert $Ip6NeighborsConf5AssertionGuid001                        \
...
# End scope
#
EndScope         IP6_NEIGHBORS_CONF5_CASE1_
#
# End log
#
EndLog
