...
#
CaseGuid           4D00DB3F-B194-4403-B725-7A1E2BF92E41
...
# Begin Scope ...
#
BeginScope       IP6_TRANSMIT_CONF3_CASE1_
...
#
# Check point:Call Transmit when Token->Event is NULL.EFI_INVALID_PARAMETER should be returned.
#
Ip6->Transmit        " &@R_Token, &@R_Status"
GetAck
set assert           [VerifyReturnStatus  R_Status  $EFI_INVALID_PARAMETER]
RecordAssertion      $assert           $Ip6TransmitConf3AssertionGuid001     \
                     "Ip6->Transmit -Conf- Call the function Transmit  "                     \
...
# End scope
#
EndScope          IP6_TRANSMIT_CONF3_CASE1_
#
# End log
#
EndLog
