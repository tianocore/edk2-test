...
#
CaseGuid           39973ECF-40D1-43b9-8AAB-5D9CBC1012AA
CaseName           Transmit.Conf8.Case1
CaseCategory       IP6
CaseDescription    { Test the Transmit Function of IP6 - invoke Transmit()             \
                     when Token->Packet.TxData->FragmentTable[].FragmentBuffer is NULL \    
...
# Begin Scope ...
#
BeginScope         IP6_TRANSMIT_CONF8_CASE1_
...
SetVar                R_FragmentBuffer                 0
SetVar                R_TxData.FragmentTable           @R_FragmentTable
SetVar                R_Token.Packet                   &@R_TxData

#
#Check point:Call Transmit Function when Token->packet.TxData->FragmentTable[].FragmentBuffer is NULL.
#            EFI_INVALID_PARAMETER should be returned.
#
Ip6->Transmit        " &@R_Token, &@R_Status"
GetAck
set assert            [VerifyReturnStatus  R_Status  $EFI_INVALID_PARAMETER]
RecordAssertion       $assert           $Ip6TransmitConf8AssertionGuid001                                     \
                      "Ip6->Transmit -Conf- Call the function Transmit  withToken->Packet.TxData->FragmentTable[].FragmentBuffer is NULL " \
...
# End scope
#
EndScope           IP6_TRANSMIT_CONF8_CASE1_
#
# End log
#
EndLog
