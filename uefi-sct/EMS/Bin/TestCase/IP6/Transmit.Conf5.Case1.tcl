...
#
CaseGuid           F0A71414-3C7E-458b-8AD5-766B466E6F1E

CaseName           Transmit.Conf5.Case1
CaseCategory       IP6
CaseDescription    { Test the Transmit Function of IP6 - invoke Transmit()    \
                     when Token->Packet. TxData->ExtHdrsLength is not zero    \
                     and Token->Packet. TxData->ExtHdrs is NULL.              \      
...
# Begin Scope ...
#
BeginScope         IP6_TRANSMIT_CONF5_CASE1_
...
SetVar                R_TxData.ExtHdrsLength           3
...
RecordAssertion       $assert           $Ip6TransmitConf5AssertionGuid001            \
...
# End scope
#
EndScope          IP6_TRANSMIT_CONF5_CASE1_
#
# End log
#
EndLog
