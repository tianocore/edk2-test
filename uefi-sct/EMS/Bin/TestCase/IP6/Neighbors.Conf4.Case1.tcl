...
#
CaseGuid           762FA315-A5DD-4b6c-B74D-9F90F15301CC
CaseName           Neighbors.Conf4.Case1
CaseCategory       IP6
CaseDescription    { Test the Neighbors Function of IP6 - invoke Neighbors()     \
                     when TargetLinkAddress is invalid     \
...
# Begin Scope ...
#
BeginScope        IP6_NEIGHBORS_CONF4_CASE1_
...
SetEthMacAddress      R_TargetLinkAddress  "00:97:3B:34:CD:9A:00"
UINT32                                     R_Timeout
SetVar                R_Timeout            0
BOOLEAN                                    R_Override
...
#
# Check point:Call Neighbors Function when *TargetLinkAddress is invalid.EFI_INVALID_PARAMETER should be returned.
#
Ip6->Neighbors "@R_DeleteFlag, &@R_TargetIp6Address, &@R_TargetLinkAddress, @R_Timeout, @R_Override, &@R_Status"
GetAck
set assert       [VerifyReturnStatus  R_Status  $EFI_INVALID_PARAMETER]
RecordAssertion  $assert $Ip6NeighborsConf4AssertionGuid001                        \
...
# End scope
#
EndScope          IP6_NEIGHBORS_CONF4_CASE1_
#
# End log
#
EndLog
