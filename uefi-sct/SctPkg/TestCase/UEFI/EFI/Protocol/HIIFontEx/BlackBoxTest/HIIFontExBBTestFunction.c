...
Abstract:
    for EFI Driver HII FontEx Protocol's function Test
  ...
  )
{
  ...
  //Call check points
  //
  BBTestStringToImageExFunctionTestCheckpoint1 (StandardLib, HIIFontEx);

  BBTestStringToImageExFunctionTestCheckpoint2 (StandardLib, HIIFontEx, GraphicsOutput);

  //
  // check point 3 check system font glyph
  //
  BBTestStringToImageExFunctionTestCheckpoint3 (StandardLib, HIIFontEx, GraphicsOutput);

  // check point 4 check customized test font glyph
  BBTestStringToImageExFunctionTestCheckpoint4 (StandardLib, HIIDatabase, HIIFontEx, GraphicsOutput);
  ...
  //
  BBTestStringToImageExFunctionTestCheckpoint5 (StandardLib, HIIFontEx, GraphicsOutput);

  
  // check point 6 test RowInfoArray / RowInfoArraySize / ColumnInfoArray with sysinfo != NULL
  BBTestStringToImageExFunctionTestCheckpoint6 (StandardLib, HIIDatabase, HIIFontEx, GraphicsOutput);
  ...
  )
{
  ...
  //Call check points
  //
  BBTestStringIdToImageExFunctionTestCheckpoint1 (StandardLib, HIIDatabase, HIIString, HIIFontEx);

  BBTestStringIdToImageExFunctionTestCheckpoint2 (StandardLib, HIIDatabase, HIIString, HIIFontEx, GraphicsOutput);
  ...
  )
{
  ...
  BBTestGetGlyphExFunctionTestCheckpoint1 (StandardLib, HIIFontEx);
  ...
  )
{
  ...
  //Call check points
  //
  BBTestGetFontInfoExFunctionTestCheckpoint1 (StandardLib, HIIFontEx);

  BBTestGetFontInfoExFunctionTestCheckpoint2 (StandardLib, HIIFontEx);
  ...
  )
{
  ...
  BBTestGetGlyphInfoFunctionTestCheckpoint1 (StandardLib, HIIFontEx);
  ...
  )
{
  ...
  //
  // Call HIIFontEx->StringToImageEx with valid parameters
  //
  for ( Index = 0; ValidFlags[Index] != 0; Index++ ){
    ...
    StandardLib->RecordAssertion (
                   StandardLib,
                   AssertionType,
                   gHIIFontExBBTestFunctionAssertionGuid001,
  ...
  )
{
  ...
  for ( Index = 0; ValidFlags[Index] != 0; Index++ ){
    ...
    StandardLib->RecordAssertion (
                   StandardLib,
                   AssertionType,
                   gHIIFontExBBTestFunctionAssertionGuid002,
                   L"HII_FONT_EX_PROTOCOL.StringToImageEx - StringToImageEx() returns EFI_SUCCESS with valid parameters.",
                   L"%a:%d: Status - %r",
                   __FILE__,
                   (UINTN)__LINE__,
  ...
  )
{
  ...
  for (TestString[0] = L' '; TestString[0] <= L'~'; TestString[0]++) {
    do {
      ...
      //
      // Compare with the image buffer from GetGlyphEx & StringToImageEx
      //
      if (SctCompareMem (
  ...
  )
{
  ...
  //
  // Call HIIFontEx->StringIdToImageEx with valid parameters
  //
  for ( Index = 0; ValidFlags[Index] != 0; Index++ ){
  ...
  )
{
  ...
  //
  // Call GetGlyphEx with valid parameters
  //
  Status = HIIFontEx->GetGlyphEx (
                      HIIFontEx,
                      Char,
  ...
  )
{
  ...
  //
  // Call GetGlyphInfo with valid parameters.
  //  
  ...
  StandardLib->RecordAssertion (
                 StandardLib,
                 AssertionType,
                 gHIIFontExBBTestFunctionAssertionGuid025,
                 L"HII_FONT_EX_PROTOCOL.GetGlyphInfo - GetGlyphInfo() returns EFI_SUCCESS with valid parameters.",
                 L"%a:%d: Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
