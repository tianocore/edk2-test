...
extern EFI_GUID gBlackBoxEfiHttpProtocolGuid;
extern EFI_GUID gBlackBoxEfiHttpServiceBindingProtocolGuid;
  
typedef struct _EFI_HTTP_PROTOCOL EFI_HTTP_PROTOCOL;
typedef struct _EFI_SERVICE_BINDING_PROTOCOL EFI_HTTP_SERVICE_BINDING_PROTOCOL;
