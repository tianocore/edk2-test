...
Abstract:
  ...
  SDMMC Pass Thru protocol from the UEFI specification.

--*/

#ifndef __SD_MMC_PASS_THRU_FOR_TEST_H__
#define __SD_MMC_PASS_THRU_FOR_TEST_H__
...
extern EFI_GUID gBlackBoxEfiSdMmcPassThruProtocolGuid;
