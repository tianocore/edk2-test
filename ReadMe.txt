1. The branches/sct-next-IA wants to provide one solution to run SCT on Shell2.0
2. The user need to patch 4 files in ShellPkg of EDKII to make the SCT run. The 
...
5. The IA32/X64 Binary is provided.
