  ...
  )
{
  ...
  LowerBytes  = (UINT32) SctSwapBytes16 ((UINT16) Value);
  HigherBytes = (UINT32) SctSwapBytes16 ((UINT16) (Value >> 16));
  ...
  )
{
  ...
  SctWriteUnaligned16 ((UINT16*)Buffer, (UINT16)Value);
  SctWriteUnaligned16 ((UINT16*)Buffer + 1, (UINT16)(Value >> 16));
  return Value;
}
