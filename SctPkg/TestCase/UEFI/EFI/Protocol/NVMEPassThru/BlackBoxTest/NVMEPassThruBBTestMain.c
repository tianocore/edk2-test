...
Abstract:
  ...
  Test Driver of NVME PassThru Protocol
...
#define EFI_NVME_PASSTHRU_TEST_GUID \
...
EFI_BB_TEST_PROTOCOL_FIELD gBBTestProtocolField = {
  EFI_NVME_PASSTHRU_PROTOCOL_TEST_REVISION,
  EFI_NVME_PASSTHRU_TEST_GUID,
  L"NVME PassThru Protocol Test",
  L"UEFI NVME PassThru Protocol Black-Box Test"
};
...
EFI_BB_TEST_ENTRY_FIELD gBBTestEntryField[] = {
  {
    EFI_NVME_PASSTHRU_PROTOCOL_TEST_ENTRY_GUID0101,
    L"PassThruFunction",
    L"Function auto test for NVME PassThru Protocol PassThru().",
  ...
  {
    EFI_NVME_PASSTHRU_PROTOCOL_TEST_ENTRY_GUID0102,
    L"GetNextNamespaceFunction",
    L"Function auto test for NVME PassThru Protocol GetNextNamespace().",
    EFI_TEST_LEVEL_MINIMAL,
    gSupportProtocolGuid,
    EFI_TEST_CASE_AUTO,
  ...
  {
    EFI_NVME_PASSTHRU_PROTOCOL_TEST_ENTRY_GUID0103,
    L"BuildDevicePathFunction",
    L"Function auto test for NVME PassThru Protocol BuildDevicePath().",
    EFI_TEST_LEVEL_MINIMAL,
    gSupportProtocolGuid,
    EFI_TEST_CASE_AUTO,
  ...
  {
    EFI_NVME_PASSTHRU_PROTOCOL_TEST_ENTRY_GUID0104,
    L"GetNamespaceFunction",
    L"Function auto test for NVME PassThru Protocol GetNamespace().",
    EFI_TEST_LEVEL_MINIMAL,
    gSupportProtocolGuid,
    EFI_TEST_CASE_AUTO,
  ...
  {
    EFI_NVME_PASSTHRU_PROTOCOL_TEST_ENTRY_GUID0201,
    L"PassThruConformance",
    L"Conformance auto test for NVME PassThru Protocol PassThru().",
    EFI_TEST_LEVEL_MINIMAL,
    gSupportProtocolGuid,
    EFI_TEST_CASE_AUTO,
  ...
  {
    EFI_NVME_PASSTHRU_PROTOCOL_TEST_ENTRY_GUID0202,
    L"GetNextNamespaceConformance",
    L"Conformance auto test for NVME PassThru Protocol GetNextNamespace().",
    EFI_TEST_LEVEL_MINIMAL,
    gSupportProtocolGuid,
    EFI_TEST_CASE_AUTO,
  ...
  {
    EFI_NVME_PASSTHRU_PROTOCOL_TEST_ENTRY_GUID0203,
    L"BuildDevicePathConformance",
    L"Conformance auto test for NVME PassThru Protocol BuildDevicePath().",
    EFI_TEST_LEVEL_MINIMAL,
    gSupportProtocolGuid,
    EFI_TEST_CASE_AUTO,
  ...
  {
    EFI_NVME_PASSTHRU_PROTOCOL_TEST_ENTRY_GUID0204,
    L"GetNamespaceConformance",
    L"Conformance auto test for NVME PassThru Protocol GetNamespace().",
    EFI_TEST_LEVEL_MINIMAL,
    gSupportProtocolGuid,
    EFI_TEST_CASE_AUTO,
