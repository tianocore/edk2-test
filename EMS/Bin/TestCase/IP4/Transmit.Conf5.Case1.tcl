...
CaseDescription {Test the Transmit Conformance of IP4 - Invoke Transmit() when \
                 the instance has not been started.The return status should be \
                 EFI_NOT_STARTED.}
################################################################################
...
# BeginScope
#
BeginScope _IP4_TRANSMIT_CONFORMANCE5_CASE1_
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4.Transmit - Conf - Conf - Reset Child"                     \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
RecordAssertion $assert $Ip4TransmitConf5AssertionGuid001                      \
                "Ip4.Transmit - Conf - not started"                            \
...
# End scope
#
EndScope _IP4_TRANSMIT_CONFORMANCE5_CASE1_
