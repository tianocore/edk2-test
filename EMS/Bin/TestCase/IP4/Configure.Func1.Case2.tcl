...
#
CaseGuid        979D01BA-EEA4-45c6-8C7D-313BBC593646
CaseName        Configure.Func1.Case2
CaseCategory    IP4
CaseDescription {Test the Configure Function of IP4 - Invoke Configure() and   \
                 call Receive() to receive a packet.}
################################################################################
...
# Begin scope ...
#
BeginScope   _IP4_CONFIGURE_FUNCTION1_CASE2_
...
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4SB.CreateChild - Func - Create Child"                      \
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4.Configure - Func - Config Child"                          \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
CreatePacket 2 -t ip -ipv4_prot 251 -ipv4_tos 1 -ipv4_ttl 8 -ipv4_payload aaa
CreatePacket 3 -t ip -ipv4_prot 252 -ipv4_tos 1 -ipv4_ttl 8 -ipv4_payload aaa
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4.Configure - Func - Receive a packet"                      \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4.Configure - Func - Check R_Token"                         \
...
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4.Configure - Func - Check Event"                           \
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4SB.Configure - Func - Destroy Child"                       \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
# End scope
#
EndScope _IP4_CONFIGURE_FUNCTION1_CASE2_
