...
#
CaseGuid        CD4B4CBE-2F57-44ef-B285-C9AE56AE97BD
CaseName        Transmit.Func5.Case1
CaseCategory    IP4
CaseDescription {Test the Transmit Function of IP4 - Invoke Transmit() to      \
                 transmit a packet when TxData.DestinationAddress set as       \
                 "172.16.210.255" and FragmentTable.FragmentBuffer filled with \
                 char data.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndScope _IP4_TRANSMIT_FUNCTION5_CASE1_
...
# BeginScope
#
BeginScope _IP4_TRANSMIT_FUNCTION5_CASE1_
...
RecordAssertion $assert $Ip4TransmitFunc5AssertionGuid001                      \
