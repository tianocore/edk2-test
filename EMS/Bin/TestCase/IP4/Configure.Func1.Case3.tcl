...
#
CaseGuid        6BF17693-E220-415d-868D-41784044D7E4
CaseName        Configure.Func1.Case3
CaseCategory    IP4
CaseDescription {Test the Configure Function of IP4 - Invoke Configure() and   \
                 call Receive() to receive a packet from different RemoteEther \
                 and RemoteIp}
################################################################################
...
# Begin scope ...
#
BeginScope   _IP4_CONFIGURE_FUNCTION1_CASE3_
...
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4SB.Configrue - Func - Create Child"                        \
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4.Configrue - Func - Config Child"                          \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4.Configrue - Func - Receive a packet"                      \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4.Configrue - Func - Destroy Child"                         \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
# End scope
#
EndScope _IP4_CONFIGURE_FUNCTION1_CASE3_
