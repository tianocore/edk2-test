...
#
CaseGuid        65B4D482-CA26-4178-95F2-0E54C9BB37E1
CaseName        Transmit.Func3.Case1
CaseCategory    IP4
CaseDescription {Test the Transmit Function of IP4 - Invoke Transmit() to      \
                 transmit a packet when TxData.OptionsLength set as 4.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndScope _IP4_TRANSMIT_FUNCTION3_CASE1_
...
# Begin scope
#
BeginScope _IP4_TRANSMIT_FUNCTION3_CASE1_
...
puts $ETH_SRC
ValidatePacket aaa -t ip "(ipv4_ver=4)AND(ipv4_ihl=6)AND(ipv4_tos=0)AND        \
...
RecordAssertion $assert $Ip4TransmitFunc3AssertionGuid001                      \
