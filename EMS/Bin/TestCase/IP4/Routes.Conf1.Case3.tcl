...
#
CaseGuid        86067A50-5A52-4ad9-8EF1-328B59216395
CaseName        Routes.Conf1.Case3
CaseCategory    IP4
CaseDescription {Test the Routes Conformance of IP4 - Invoke Routes() with the \
                 parameter GatewayAddress being not a valid unicast IPv4       \
...
# BeginScope
#
BeginScope _IP4_ROUTES_CONFORMANCE1_CASE3_
...
RecordAssertion $assert $GenericAssertionGuid                                  \
                "Ip4.Routes - Conf - with invalid R_GatewayAddress"            \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"

Ip4ServiceBinding->DestroyChild {@R_Handle, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Ip4RoutesConf1AssertionGuid008                        \
...
# End scope
#
EndScope _IP4_ROUTES_CONFORMANCE1_CASE3_
