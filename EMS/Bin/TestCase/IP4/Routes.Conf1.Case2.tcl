...
#
CaseGuid        09CDF2B0-4723-4a8f-BAF5-D8E43B7F7CF7
CaseName        Routes.Conf1.Case2
CaseCategory    IP4
CaseDescription {Test the Routes Conformance of IP4 - Invoke Routes() with the \
                 parameter SubnetMask being not a valid subnet mask.The return \
...
# BeginScope
#
BeginScope _IP4_ROUTES_CONFORMANCE1_CASE2_
...
SetIpv4Address R_SubnetMask     "255.255.255.1"
SetIpv4Address R_GatewayAddress "172.16.210.161"
Ip4->Routes {FALSE, &@R_SubnetAddress, &@R_SubnetMask,                         \
             &@R_GatewayAddress, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Ip4RoutesConf1AssertionGuid007                        \
                "Ip4.Routes - Conf - With invalid R_SubnetMask"                \
...
# End scope
#
EndScope _IP4_ROUTES_CONFORMANCE1_CASE2_
