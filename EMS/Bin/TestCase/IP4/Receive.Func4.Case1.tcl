...
#
CaseGuid        C20A06FA-9893-4556-BFEB-94DFC1603BE3
CaseName        Receive.Func4.Case1
CaseCategory    IP4
...
# BeginScope
#
BeginScope _IP4_RECEIVE_FUNCTION4_CASE1_
...
if {[string compare -nocase $DestinationAddress 172.16.210.255] != 0} {
  set assert fail
}
...
# End scope 
#
EndScope _IP4_RECEIVE_FUNCTION4_CASE1_
