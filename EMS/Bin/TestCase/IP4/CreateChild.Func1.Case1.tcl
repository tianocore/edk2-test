...
#
CaseGuid        D603C574-2111-4e7b-A058-79C8A591354B
CaseName        CreateChild.Func1.Case1
CaseCategory    IP4
CaseDescription {Test the function of IP4SB.CreateChild() - Create multi       \
...
# BeginScope
#
BeginScope _IP4_CREATECHILD_FUNCTION1_CASE1_
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Ip4CreateChildFunc1AssertionGuid001                   \
...
# End scope
#
EndScope _IP4_CREATECHILD_FUNCTION1_CASE1_
