...
#
CaseGuid        49018706-40CC-491c-B9CC-EB6216D85932
CaseName        Groups.Conf2.Case1
CaseCategory    IP4
CaseDescription {Test the Groups Conformance of IP4 - Invoke Groups() to join a\
                 group address when it is already in the group table.          \
                 The return status should be EFI_ALREADY_STARTED.}
################################################################################
...
# BeginScope
#
BeginScope _IP4_GROUPS_CONFORMANCE2_CASE1_
...
RecordAssertion $assert $Ip4GroupsConf2AssertionGuid001                        \
                "Ip4.Groups - Conf - join a group again"                       \
...
# End scope
#
EndScope _IP4_GROUPS_CONFORMANCE2_CASE1_
