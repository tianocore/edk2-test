...
#
CaseGuid        8659D6DF-8DBE-4c9b-84A2-46A461957F78
CaseName        Transmit.Conf4.Case1
CaseCategory    IP4
CaseDescription {Test the Transmit Conformance of IP4 - Invoke Transmit() when \
                 there is no route found to the destination address.The return \
                 status should be EFI_NOT_FOUND.}
################################################################################
...
# BeginScope
#
BeginScope _IP4_TRANSMIT_CONFORMANCE4_CASE1_
...
SetIpv4Address R_TxData.DestinationAddress "172.16.220.162"
SetVar R_TxData.TotalDataLength            1
SetVar R_TxData.FragmentCount              1

SetVar R_FragmentBuffer                    "IpConfigureTest"
SetVar R_FragmentTable.FragmentLength      1
...
RecordAssertion $assert $Ip4TransmitConf4AssertionGuid001                      \
                "Ip4.Transmit - Conf - not found in route table"               \
...
# End scope
#
EndScope _IP4_TRANSMIT_CONFORMANCE4_CASE1_
