...
#
CaseGuid        c07fe751-bfb8-4cef-b6d4-30736f59e58f
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _DHCP4_RENEWREBIND_CONF2
  EndLog
}
...
#
BeginLog
BeginScope  _DHCP4_RENEWREBIND_CONF2
...
if { ${CCB1.received} == 0} {
	set assert fail
	GetAck
  RecordAssertion $assert $Dhcp4RenewRebindConf2AssertionGuid001               \
