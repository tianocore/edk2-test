...
#
CaseGuid        EF72823F-69C4-45b0-A1A5-1724D7219F1C
CaseName        Parse.Conf1.Case4
CaseCategory    DHCP4
CaseDescription {This case is to test the Conformance - EFI_INVALID_PARAMETER  \
                -- Packet is not Well-formed DHCP packet - No End option.}
...
SetVar  R_Packet.Length                   [expr [Sizeof EFI_DHCP4_HEADER] + 27]
...
SetVar  R_Packet.Dhcp4.Option     {0x35 0x01 0x03 0x3d 0x07 0x01 0x00 0x0d 0x60\
                                  ...
                                  0x2d 0x6d 0x6f 0x62 0x6c}
SetVar  R_OptionCnt               5

#
# Check Point: Call Dhcp4->Parse while No End Option.
#
Dhcp4->Parse "&@R_Packet, &@R_OptionCnt, &@R_PtrOptions, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Dhcp4ParseConf1AssertionGuid004                       \
                "Dhcp4.Parse - Conf - (InvalidPara)No End Opt."                \
