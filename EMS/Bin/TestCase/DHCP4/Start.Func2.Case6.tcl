...
#
CaseGuid        4c0f86de-77e6-4b43-a0de-6cb0924eebc6
CaseName        Start.Func2.Case6
CaseCategory    DHCP4
CaseDescription {This case is to test the Functionality.                       \
	              -- Call Start in Dhcp4InitReboot State and synchronous Mode. - \
	              Sequence C.}
...
if { ${CCB.received} == 0 } {
  set assert fail
  GetAck
	RecordAssertion $assert $Dhcp4StartFunc2AssertionGuid006                     \
