...
#
CaseGuid        7c6805e0-b2e7-4d0e-9782-6a46ee66bee1
CaseName        Build.Conf1.Case4
CaseCategory    DHCP4
...
#
# Check Point: Call Dhcp4->Build while DeleteCount is not zero and DeleteList 
#              is NULL.
#
Dhcp4->Build "&@R_Packet, 1, NULL, 1, &@R_PtrOptList, &@R_NewPacket, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Dhcp4BuildConf1AssertionGuid004                       \
                "Dhcp4.Build - Conf - (InvalidPara)DeleteCount is not zero and \
                DeleteList is NULL."                                           \
