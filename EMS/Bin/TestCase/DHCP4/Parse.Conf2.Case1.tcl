...
#
CaseGuid        8836270b-5a03-41ff-b8e5-a2665a6059f6
CaseName        Parse.Conf2.Case1
CaseCategory    DHCP4
CaseDescription {This case is to test the Conformance - EFI_BUFFER_TOO_SMALL   \
	              -- OptionCount smaller than the number of options that were    \
	              found in the Packet.}
...
RecordAssertion $assert $Dhcp4ParseConf2AssertionGuid001                       \
                "Dhcp4.Parse - Conf - (BufferTooSmall)OptionCount too small."  \
