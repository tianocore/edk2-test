...
#
CaseGuid        559eadce-7f12-4554-817f-524f86a81db9
CaseName        Parse.Conf1.Case5
CaseCategory    DHCP4
CaseDescription {This case is to test the Conformance - EFI_INVALID_PARAMETER  \
                -- Packet is not Well-formed DHCP packet - Length < Header Size}
...
SetVar  R_Packet.Length                   [expr [Sizeof EFI_DHCP4_HEADER] + 3]
...
#
# Check Point: Call Dhcp4->Parse while Length too short.
#
Dhcp4->Parse "&@R_Packet, &@R_OptionCnt, &@R_PtrOptions, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Dhcp4ParseConf1AssertionGuid005                       \
                "Dhcp4.Parse - Conf - (InvalidPara)Length too short."          \
