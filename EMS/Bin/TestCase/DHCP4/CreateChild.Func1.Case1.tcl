...
#
CaseGuid        AF58F3E4-296E-445d-BC96-BE437A098839
CaseName        CreateChild.Func1.Case1
CaseCategory    DHCP4
CaseDescription {This case is to test the Function of Dhcp4ServiceBinding.CreateChild.}
...
# BeginScope
#
BeginScope _DHCP4_CREATECHILD_FUNC1
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Dhcp4CreateChildFunc1AssertionGuid001                 \
...
EndScope    _DHCP4_CREATECHILD_FUNC1
#
# End Log 
#
EndLog