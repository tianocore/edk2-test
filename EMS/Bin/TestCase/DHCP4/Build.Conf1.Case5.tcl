...
#
CaseGuid        0ece87a3-34c7-4bd2-b552-1999916f831f
CaseName        Build.Conf1.Case5
CaseCategory    DHCP4
...
#
# Check Point: Call DDhcp4->Build while NewPacket is NULL.
#
Dhcp4->Build "&@R_Packet, 0, NULL, 1, &@R_PtrOptList, NULL, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Dhcp4BuildConf1AssertionGuid005                       \
                "Dhcp4.Build - Conformance - (InvalidPara)NewPacket is NULL."  \
