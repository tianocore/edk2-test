...
#
CaseGuid        c13eba81-07b6-4aa8-ab7c-017f2a917136
...
#
# Check Point: Call Dhcp4.GetModeData to verify in the Dhcp4Init State.
#
...
RecordAssertion $assert $Dhcp4GetModeDataFunc2AssertionGuid001                 \
                "Dhcp4.GetModeData - Get Mode Data in Dhcp4Init State"         \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"      \
...
# 	2). Respond with DHCPOFFER packet to DHCP client
#
...
#
# Check Point: Call Dhcp4.GetModeData to verify in the Dhcp4Selecting State.
#
Dhcp4->GetModeData "&@R_ModeData, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
