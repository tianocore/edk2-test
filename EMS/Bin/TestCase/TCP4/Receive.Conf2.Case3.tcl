...
#
CaseGuid          686A6E35-586B-477d-9877-F0A51942C06F
CaseName          Receive.Conf2.Case3
CaseCategory      TCP
...
BeginLogPacket Receive.Conf3.Case3 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#              with Token->Packet.RxData is NULL.
#
BS->CreateEvent "$EVT_NOTIFY_SIGNAL, $EFI_TPL_CALLBACK, 1, &@R_Context,        \
...
RecordAssertion $assert $Tcp4ReceiveConf2AssertionGuid003                      \
                "Tcp4.Receive - Call Receive() to receive a packet with        \
                Token->Packet.RxData being NULL."                              \
