...
#
CaseGuid          85A20AF8-E859-4bee-9230-59B8A3DD77CF
...
BeginLogPacket Connect.Conf3.Case1 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#              with ConnectionToken is NULL.
#
SetVar R_Connect_ConnectionToken NULL

Tcp4->Connect {&@R_Connect_ConnectionToken, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp4ConnectConf3AssertionGuid001                      \
