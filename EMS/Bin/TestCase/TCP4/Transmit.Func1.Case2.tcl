...
#
CaseGuid          8010E84F-AA90-47a7-1583-FE5BC4E6AC4F
...
CaseDescription   {This case is to test the Functionality.                     \
                  ...
                  by sending 16 bytes data segment to [EUT],                   \
...
BeginLogPacket Transmit.Func1.Case2 "host $DEF_EUT_IP_ADDR and host            \
                                             $DEF_ENTS_IP_ADDR"
#
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4TransmitFunc1AssertionGuid002                     \
...
#
# Check Point: [PSH] bit and [ACK] bit should both be set in data segment,
#              according to following two conditions:
#              (1) EFI_TCP4_TRANSMIT_DATA.Push set to TRUE and,
#              (2) it is the last segment data to be transmitted.
#
if { ${TCB.received} == 1 } {
  #
