...
#
CaseGuid          AE945C00-0B6B-4e19-8186-5BBDA4D2EAA5
CaseName          RstHandling.Func3.Case5
CaseCategory      TCP
CaseDescription   {This item is to test the <EUT> correctly validate the rcvd  \
                   RST segment while in FIN_WAIT_1 state. RST is valid if      \
...
proc CleanUpEutEnvironmentEnd {} {
  EndLogPacket
  EndScope _TCP4_RSTHANDLING_FUNC3_CASE5_
  EndLog
}
...
# BeginScope on OS.
#
BeginScope _TCP4_RSTHANDLING_FUNC3_CASE5_

BeginLogPacket RstHandling.Func3.Case5 "host $DEF_EUT_IP_ADDR and host         \
                                             $DEF_ENTS_IP_ADDR"
...
set assert pass
RecordAssertion $assert $GenericAssertionGuid                                  \
                "<FIN_WAIT_1>: On recv invalid RST, remain in FIN_WAIT_1"
...
RecordAssertion pass $Tcp4RstHandlingFunc3AssertionGuid005                     \
                "<FIN_WAIT_1>: On recv invalid RST, remain in FIN_WAIT_1"      \
                "respond to following FIN|ACK correctly"
