...
#
CaseGuid          09C82D42-20CB-4d81-915B-F3596C47E977
CaseName          CnntOpening.Func1.Case5
CaseCategory      TCP
CaseDescription   {This item is to test the [EUT] correctly establishes the    \
                   TCP connection through passive open with specified          \
...
BeginLogPacket CnntOpening.Func1.Case5 "host $DEF_EUT_IP_ADDR and host         \
                                             $DEF_ENTS_IP_ADDR"
...
SetVar R_Accept_NewChildHandle 11
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4CnntOpeningFunc1AssertionGuid005                  \
