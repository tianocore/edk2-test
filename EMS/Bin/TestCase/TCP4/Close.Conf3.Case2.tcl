...
#
CaseGuid          0BA3B549-AD4D-4116-9E1F-80B3F66ED05B
CaseName          Close.Conf3.Case2
CaseCategory      TCP
...
BeginLogPacket close.Conf3.Case2 "host $DEF_EUT_IP_ADDR and host               \
                                             $DEF_ENTS_IP_ADDR"
#
...
#              with CloseToken->CompletionToken.Event is NULL.
#
...
RecordAssertion $assert $Tcp4CloseConf3AssertionGuid002                        \
                "Tcp4.Close() - Close the connection with                      \
                CloseToken->CompletionToken.Event is NULL."                    \
