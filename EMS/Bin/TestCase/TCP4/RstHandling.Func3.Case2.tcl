...
#
CaseGuid          B45D4F27-5F17-4c7a-9725-DD328D910A70
CaseName          RstHandling.Func3.Case2
CaseCategory      TCP
...
global RST
  ...
  EndLogPacket
  EndScope _TCP4_RSTHANDLING_FUNC3_CASE2_
  EndLog
}
...
# BeginScope on OS.
#
BeginScope _TCP4_RSTHANDLING_FUNC3_CASE2_
...
#  According to RFC793, Reset Processing: The receiver of a RST first validates
#  it,then changes state. If the receiver was in the LISTEN state,it ignores it.
#
set L_TcpFlag $RST
...
RecordAssertion pass $Tcp4RstHandlingFunc3AssertionGuid002                     \
