...
#
CaseGuid          951980B3-0246-4e81-B69F-A4C8878A9EC9
CaseName          CongestionCtrl.Func1.Case1
CaseCategory      TCP
CaseDescription   {This item is to test the [EUT] correctly performs the slow  \
                   start at the beginning of the connection transmission.}
################################################################################
...
BeginLogPacket CongestionCtrl.Func1.Case1 "host $DEF_EUT_IP_ADDR and host      \
                                                $DEF_ENTS_IP_ADDR"
...
#
set    L_FragmentLength          8192  ;# 13*MSS = 1+2+4+8
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $CongestionCtrlFunc1AssertionGuid001                   \
