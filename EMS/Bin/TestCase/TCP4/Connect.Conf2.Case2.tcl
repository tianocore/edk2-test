...
#
CaseGuid          2A7BA41A-1179-4937-8088-C4D84CF7964E
CaseName          Connect.Conf2.Case2
CaseCategory      TCP
...
BeginLogPacket Connect.Conf2.Case2 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#
# Check Point: Call TCP.Connect for the instance again,
#              instance is not in Tcp4StateClosed.
#
Tcp4->Connect {&@R_Connect_ConnectionToken, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_ACCESS_DENIED]
RecordAssertion $assert $Tcp4ConnectConf2AssertionGuid002                      \
                "Tcp4.Connect - Call Connect() when the instance is not in     \
                 Tcp4StateClosed state."                                       \
