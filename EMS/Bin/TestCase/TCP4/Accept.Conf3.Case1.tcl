...
#
CaseGuid          7FFA25C4-B7D5-4054-A45E-0300C6883981
...
BeginLogPacket Accept.Conf3.Case1 "host $DEF_EUT_IP_ADDR and host              \
                                             $DEF_ENTS_IP_ADDR"
#
...
#
# Check Point: Call Tcp.Accept(), with ListenToken is NULL.
#
SetVar R_Accept_ListenToken.CompletionToken NULL

Tcp4->Accept {&@R_Accept_ListenToken, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp4AcceptConf3AssertionGuid001                       \
                "Tcp4.Accept - Call Accept() with the parameter ListenToken is NULL."\
