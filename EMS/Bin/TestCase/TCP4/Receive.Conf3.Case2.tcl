...
#
CaseGuid          4999FA16-C02D-4adf-AF1E-C209C0B0E5F2
CaseName          Receive.Conf3.Case2
CaseCategory      TCP
...
BeginLogPacket Receive.Conf6.Case2 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#
# OS send RST segment, to let EUT enter Tcp4StateClosed
#
UpdateTcpSendBuffer TCB -c $RST
SendTcpPacket TCB
...
#              with the current instance is in Tcp4StateClosed state.
#
BS->CreateEvent "$EVT_NOTIFY_SIGNAL, $EFI_TPL_CALLBACK, 1, &@R_Context,        \
...
RecordAssertion $assert $Tcp4ReceiveConf3AssertionGuid002                      \
