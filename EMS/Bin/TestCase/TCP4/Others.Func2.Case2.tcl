...
BeginLogPacket Others.Func2.Case2      "host $DEF_EUT_IP_ADDR"
...
for { set i 1 } { $i <= $SYN_TIMES } { incr i } {
  ...
  #
  CreateTcb TCB$i $DEF_EUT_IP_ADDR $DEF_EUT_PRT $DEF_EUT_IP_ADDR $DEF_EUT_PRT
}
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4OthersFunc2AssertionGuid002                       \
...
for { set i 1 } { $i <= $L_ControlOption_MaxSynBackLog } { incr i } {
