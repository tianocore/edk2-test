...
#
CaseGuid          009EEC35-B024-48a6-9BF1-1C1629F33BC8
CaseName          Options.Func6.Case6
CaseCategory      TCP
CaseDescription   {This case is to test the Functionality.                     \
                   ...
                   -- format 1:                                                \
                     0            7           15           23           31     \
                     +------------+------------+------------+------------+     \
                     |   No-Oper  |   No-Oper  |   No-Oper  |  00000100  |     \
                     +------------+------------+------------+------------+     \
                     +------------+------------+------------+------------+     \
                     |  00000110  |           TS Value (TSval)           |     \
                     +------------+------------+------------+------------+     \
                     +------------+------------+------------+------------+     \
                     |  (TSval)   |         TS Echo Reply (TSecr)        |     \
                     +------------+------------+------------+------------+     \
                     +------------+------------+------------+------------+     \
                     |  (TSecr)   |   No-Oper  |   No-Oper  |   No-Oper  |     \
                     +------------+------------+------------+------------+     \
                  }
################################################################################
...
BeginLogPacket Options.Func8.Case8 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
...
CreatePayload  Option_MSS_WS_TS  Data  24                                      \
                                       0x02  0x04  $L_MSSH  $L_MSSL            \
                                       0x03  0x03  $L_WindowScale  0x01        \
                                       0x01  0x01  0x01  0x08                  \
                                       0x0A  $TSval_3  $TSval_2  $TSval_1      \
                                       $TSval_0  0  0  0                       \
                                       0  0x01  0x01  0x01
...
CreatePayload  Option_TS  Data  16                                                 \
                                0x01  0x01  0x01  0x08                             \
                                0x0A  $TSval_3  $TSval_2  $TSval_1                 \
                                $TSval_0  $EUT_TSval_3  $EUT_TSval_2 $EUT_TSval_1  \
                                $EUT_TSval_0  0x01  0x01  0x01
...
while {1} {
  ...
  if { ${R_Receive_IOToken.CompletionToken.Status} != $EFI_INCOMPATIBLE_VERSION} {
    if { ${R_Receive_IOToken.CompletionToken.Status} != $EFI_SUCCESS} {
      ...
      RecordAssertion $assert $Tcp4OptionsFunc6AssertionGuid006                \
                      "Transmission failed."                                   \
