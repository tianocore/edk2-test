...
#
CaseGuid          7038837E-632B-4a46-BD09-265F152073AD
CaseName          Transmit.Conf3.Case3
CaseCategory      TCP
CaseDescription   {This case is to test the conformace - EFI_ACCESS_DENIED.    \
...
BeginLogPacket Transmit.Conf4.Case3 "host $DEF_EUT_IP_ADDR and host            \
                                             $DEF_ENTS_IP_ADDR"
#
...
SetVar R_FragmentBuffer          "012345ABCDE123456"
...
#              with the current instance is a passive one and it is in         \
#              Tcp4StateListen state.
#
...
RecordAssertion $assert $Tcp4TransmitConf3AssertionGuid003                     \
                "Tcp4.Transmit - Call Transmit() when the current instance     \
                is a passive one and it is in Tcp4StateListen state."          \
