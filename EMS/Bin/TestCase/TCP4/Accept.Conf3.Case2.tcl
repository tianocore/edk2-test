...
#
CaseGuid          1C3C05B0-E465-4cd4-A2FD-2B805B8871E7
CaseName          Accept.Conf3.Case2
CaseCategory      TCP
...
BeginLogPacket Accept.Conf3.Case2 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#
# Check Point: Call Tcp.Accept(),
#              with ListentToken->CompletionToken.Event is NULL.
#
...
RecordAssertion $assert $Tcp4AcceptConf3AssertionGuid002                       \
                "Tcp4.Accept - Call Accept() with the parameter                \
                ListentToken->CompletionToken.Event is NULL."                  \
