...
BeginLogPacket Connect.Conf2.Case1 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#
# Check Point: Call Tcp4.Connect for an TCP instance,
#              with NOT active open.
#
...
RecordAssertion $assert $Tcp4ConnectConf2AssertionGuid001                      \
                "Tcp4.Connect - Call Connect() when the instance is not        \
                 configured as an active one."                                 \
