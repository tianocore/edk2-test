...
#
CaseGuid          361B03FF-CB58-44b6-A099-0C151DA11F37
CaseName          Receive.Conf2.Case2
CaseCategory      TCP
...
BeginLogPacket Receive.Conf3.Case2 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#              with Token->CompletionToken.Event is NULL.
#
...
RecordAssertion $assert $Tcp4ReceiveConf2AssertionGuid002                      \
                "Tcp4.Receive - Call Receive() to receive a packet with        \
                 Token->CompletionToken.Event being NULL."                     \
