...
#
CaseGuid          8C135843-D3B6-48bf-8E6A-78EE5137310B
CaseName          Routes.Conf3.Case6
CaseCategory      TCP
...
#              with *GatewayAddress is not a valid unicast IP address.
#
...
# 
# Given a not unicast IPv4 address, Class D, or E, here is Class D.
# In Tiano\Library\Dxe\Include\IPv4.h, defines Class A, B, C are unicast address
#
SetIpv4Address  R_Routes_GatewayAddress    240.168.0.201

Tcp4->Routes {@R_Routes_DeleteRoute, &@R_Routes_SubnetAddress,                 \
              &@R_Routes_SubnetMask, &@R_Routes_GatewayAddress, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp4RoutesConf3AssertionGuid005                        \
                "Tcp4.Routes() - Call Routes() with *GatewayAddress is not a   \
