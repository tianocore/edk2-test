...
#
CaseGuid          7AB029DC-EE2E-4ffe-9127-D0E92FCB4B90
...
#
# Call Tcp4.Routes(), to add an route entry in route table.
#
...
#              to add the same route entry in route table.
#              The route is already defined in the routing table.
#
Tcp4->Routes {@R_Routes_DeleteRoute, &@R_Routes_SubnetAddress,                 \
              &@R_Routes_SubnetMask, &@R_Routes_GatewayAddress, &@R_Status}
...
RecordAssertion $assert $Tcp4RoutesConf6AssertionGuid001                        \
                "Tcp4.Routes() - Call Routes() to add route entry when the     \
