...
#
CaseGuid          918D43A3-4754-4422-899B-3A5DC29C65CA
...
#
# Call Tcp4.Routes(), to add a route entry in route table.
#
...
#
# Call Tcp4.Routes(), to delete a route entry in route table.
#
...
#
# Check Point: Call Tcp4.Routes(), again,
#              to delete the route entry in route table.
#              This route is not in the routing table.
#
Tcp4->Routes {@R_Routes_DeleteRoute, &@R_Routes_SubnetAddress,                 \
              &@R_Routes_SubnetMask, &@R_Routes_GatewayAddress, &@R_Status}
...
RecordAssertion $assert $Tcp4RoutesConf5AssertionGuid001                       \
                "Tcp4.Routes() - Call Routes() when the route is not in the    \
                routing table."                                                \
