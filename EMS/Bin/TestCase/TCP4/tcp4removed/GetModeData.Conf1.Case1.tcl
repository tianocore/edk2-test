...
#
CaseGuid          8809ABC6-791F-4c0c-B173-B336350A1B96
CaseName          GetModeData.Conf1.Case1
CaseCategory      TCP
CaseDescription   {This case is to test the conformance - EFI_NOT_STARTED.     \
                  -- Tcp4.GetModeData No configuration data is available       \
                  because this instance hasn't been started.}
################################################################################
...
#
# Check Point: Calling GetModeData without Configuration.
#
Tcp4->GetModeData {&@R_Tcp4State, &@R_Tcp4ConfigData, &@R_Ip4ModeData,         \
                   &@R_MnpConfigData, &@R_SnpModeData, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_NOT_STARTED]
RecordAssertion $assert $Tcp4GetModeDataConf1AssertionGuid001                  \
                "Tcp4.GetModeData - Calling GetModeData without Configuration."\
