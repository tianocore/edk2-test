...
#
CaseGuid          FEB55F66-B290-45b8-8AD3-8698BA3467F2
CaseName          Cancel.Conf4.Case1
CaseCategory      TCP
CaseDescription   {This case is to test the conformance - EFI_NOT_FOUND.       \
                  -- The asynchronous I/O request isn¡¯t found in the           \
                   transmission or receive queue.}
################################################################################
...
BeginLogPacket Cancel.Conf4.Case1      "host $DEF_EUT_IP_ADDR and host         \
                                             $DEF_ENTS_IP_ADDR"
...
#
# Check Point: Call Tcp4.Cancel() to Cancel a completed request.
#
SetVar R_Cancel_Token &@R_Connect_CompletionToken

Tcp4->Cancel {@R_Cancel_Token, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_NOT_FOUND]
RecordAssertion $assert $Tcp4CancelConf4AssertionGuid001                       \
                "Tcp4.Cancel - Call Cancel() to cancel a completed request."   \
