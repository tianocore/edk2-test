...
#
CaseGuid          31726D60-561C-4914-8C09-963A01A59FFE
CaseName          Routes.Conf3.Case4
CaseCategory      TCP
...
#              with *SubnetAddress is not a valid subnet address.
#
SetVar          R_Routes_DeleteRoute       FALSE
set SubnetAddress [regexp -inline {\d{1,3}\.\d{1,3}\.\d{1,3}\.} $DEF_EUT_IP_ADDR ]1
...
RecordAssertion $assert $Tcp4RoutesConf3AssertionGuid004                        \
                "Tcp4.Routes() - Call Routes() with *SubnetAddress is not a    \
