...
#              with *SubnetMask is not a valid subnet mask.
#
...
SetIpv4Address  R_Routes_SubnetMask        255.255.0.255
...
RecordAssertion $assert $Tcp4RoutesConf3AssertionGuid005                        \
                "Tcp4.Routes() - Call Routes() with *SubnetMask is not a       \
                valid subnet mask."                                            \
