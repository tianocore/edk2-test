...
#
CaseGuid          01EB23E0-0F5D-4956-AB2F-4CE8929649A1
...
BeginLogPacket Cancel.Conf2.Case1      "host $DEF_EUT_IP_ADDR and host         \
                                             $DEF_ENTS_IP_ADDR"
...
#
# Check Point: Call Tcp4.Cancel() to Cancel the pending request,
#              without previously calling [TCP4]->Configure().
#
Tcp4->Cancel {NULL, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_NOT_STARTED]
RecordAssertion $assert $Tcp4CancelConf2AssertionGuid001                       \
                "Tcp4.Cancel - Call Cancel() to cancel the pending request     \
                without call Configure() previously."                          \
