...
#
CaseGuid          34E1936C-E146-436b-BD8A-4CA1AB0934F9
CaseName          UrgHandling.Func3.Case1
CaseCategory      TCP
...
BeginLogPacket UrgHandling.Func3.Case1 "host $DEF_EUT_IP_ADDR and host         \
                                             $DEF_ENTS_IP_ADDR"
...
UpdateTcpSendBuffer TCB -c $L_TcpFlag -w 1000
SendTcpPacket TCB
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4UrgHandlingFunc3AssertionGuid001                  \
