...
#
CaseGuid          90D20FA2-39A9-4da9-8E39-22A7FB2ECF60
CaseName          CnntOpening.Func1.Case6
CaseCategory      TCP
CaseDescription   {This item is to test the [EUT] correctly establishes the    \
                   TCP connection through simultaneous open, it performs the   \
...
BeginLogPacket CnntOpening.Func1.Case6 "host $DEF_EUT_IP_ADDR and host         \
                                             $DEF_ENTS_IP_ADDR"
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4CnntOpeningFunc1AssertionGuid006                  \
...
UpdateTcpSendBuffer TCB -a $L_AckNum -c $ACK
SendTcpPacket TCB
