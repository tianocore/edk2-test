...
#
CaseGuid          8E9B8474-D603-42f4-9E0C-2E26E9557DE6
...
BeginLogPacket close.Conf3.Case1 "host $DEF_EUT_IP_ADDR and host               \
                                             $DEF_ENTS_IP_ADDR"
#
...
#              with CloseToken is NULL.
#
Tcp4->Close {NULL, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp4CloseConf3AssertionGuid001                        \
                "Tcp4.Close() - Close the connection with CloseToken is NULL." \
