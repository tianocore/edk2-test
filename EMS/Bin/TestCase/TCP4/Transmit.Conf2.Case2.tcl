...
#
CaseGuid          6FA3EDD3-4EC7-4359-961D-B5980458DC32
CaseName          Transmit.Conf2.Case2
CaseCategory      TCP
...
BeginLogPacket Transmit.Conf3.Case2 "host $DEF_EUT_IP_ADDR and host            \
                                             $DEF_ENTS_IP_ADDR"
#
...
RecordAssertion $assert $Tcp4TransmitConf2AssertionGuid002                     \
                "Tcp4.Transmit - Call Transmit() with                          \
                Token->CompletionToken.Event is NULL."                         \
