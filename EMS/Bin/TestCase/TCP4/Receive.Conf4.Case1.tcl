...
#
CaseGuid          BB51C060-3788-4633-B175-7835CCC1C0AD
...
BeginLogPacket Receive.Conf4.Case1 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
if { ${TCB.received} == 1 } {
  if { ${TCB.r_f_ack} != 1 } {
    set assert fail
    RecordAssertion $assert $GenericAssertionGuid                              \
                    "EUT doesn't send out ACK segment to respond FIN segment   \
                     correctly."
...
RecordAssertion $assert $Tcp4ReceiveConf4AssertionGuid001                      \
