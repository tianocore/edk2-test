...
#
CaseGuid          1536E96B-A1E8-4d82-8EE9-F8BEB59FE62C
...
BeginLogPacket Transmit.Conf4.Case2 "host $DEF_EUT_IP_ADDR and host            \
                                             $DEF_ENTS_IP_ADDR"
#
...
#
# OS send RST to let EUT enter Tcp4StateClosed
#
UpdateTcpSendBuffer TCB -c $RST
SendTcpPacket TCB

#
# Call Tcp4.Transmit to transmit a packet, with EUT state is Tcp4StateClosed.
#
BS->CreateEvent "$EVT_NOTIFY_SIGNAL, $EFI_TPL_CALLBACK, 1, &@R_Context,        \
...
RecordAssertion $assert $Tcp4TransmitConf3AssertionGuid002                     \
                "Tcp4.Transmit - Call Transmit() when the current instance     \
                is in Tcp4StateClosed state."                                  \
