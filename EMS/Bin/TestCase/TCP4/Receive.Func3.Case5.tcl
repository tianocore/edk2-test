...
#
CaseGuid          4A0BD31C-DA90-33a8-2284-CF2BC0E6AC32
CaseName          Receive.Func3.Case5
CaseCategory      TCP
...
BeginLogPacket Receive.Func3.Case5 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
set    L_FragmentLength_1        200
set    L_SpaceLength_13          100
set    L_FragmentLength_2        200
set    L_FragmentLength_3        400
set    L_OverlapLength_23L       100
...
# OS send DATA & ACK segment
#
set tmp_seq   [ expr ${TCB.l_isn} + $L_FragmentLength_1 + $L_SpaceLength_13 + $L_OverlapLength_23L ]
set L_TcpFlag [ expr $PSH | $ACK ]
...
# OS send DATA & ACK segment
#
set tmp_seq   [ expr ${TCB.l_isn} + $L_FragmentLength_1 + $L_SpaceLength_13 ]
set L_TcpFlag [ expr $PSH | $ACK ]
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4ReceiveFunc3AssertionGuid005                      \
