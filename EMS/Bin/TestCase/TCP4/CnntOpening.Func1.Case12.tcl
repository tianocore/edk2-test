...
#
CaseGuid          C32FC15B-479E-415b-AA9E-813E681EA149
CaseName          CnntOpening.Func1.Case12
CaseCategory      TCP
...
BeginLogPacket CnntOpening.Func1.Case12 "host $DEF_EUT_IP_ADDR and host        \
                                             $DEF_ENTS_IP_ADDR"
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4CnntOpeningFunc1AssertionGuid012                  \
...
UpdateTcpSendBuffer TCB -a $L_AckNum -s $L_SeqNum -c $L_Flag
SendTcpPacket TCB
