...
#
CaseGuid          249FEEFC-992F-491c-A149-7A526B5388CC
CaseName          Options.Func5.Case6
CaseCategory      TCP
...
BeginLogPacket Options.Func7.Case6 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
...
#
CreatePayload Option_MSS_WS Data 12 0x02 0x04 $L_MSSH $L_MSSL 0x01 0x01 0x03 0x03\
...
while {1 > 0} {
  ...
  if { ${R_Transmit_IOToken.CompletionToken.Status} != $EFI_INCOMPATIBLE_VERSION} {
    if { ${R_Transmit_IOToken.CompletionToken.Status} != $EFI_SUCCESS} {
      set assert fail
      RecordAssertion $assert $Tcp4OptionsFunc5AssertionGuid006                \
