...
#
CaseGuid          00E8931C-36A2-4bf9-9DB1-358CB750258C
CaseName          Options.Func5.Case5
CaseCategory      TCP
CaseDescription   {This case is to test the Functionality.                     \
                   ...
                   -- format 1:                                                \
                     0            7           15           23           31     \
                     +------------+------------+------------+------------+     \
                     |   No-Oper  |  00000011  |  00000011  |  shift.cnt |     \
                     +------------+------------+------------+------------+     \
                   .}
################################################################################
...
BeginLogPacket Options.Func7.Case5 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
...
#
CreatePayload Option_MSS_WS Data 8 0x02 0x04 $L_MSSH $L_MSSL 0x01 0x03 0x03 $L_WindowScale
...
while {1 > 0} {
  ...
  if { ${R_Transmit_IOToken.CompletionToken.Status} != $EFI_INCOMPATIBLE_VERSION} {
    if { ${R_Transmit_IOToken.CompletionToken.Status} != $EFI_SUCCESS} {
      set assert fail
      RecordAssertion $assert $Tcp4OptionsFunc5AssertionGuid005                \
