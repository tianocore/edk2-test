...
#
CaseGuid          3D782B5E-6326-46f9-B446-90F0AB3B7730
CaseName          CnntOpening.Func1.Case2
CaseCategory      TCP
CaseDescription   {This item is to test the [EUT] correctly establishes the    \
                   TCP connection through active open.}
################################################################################
...
BeginLogPacket CnntOpening.Func1.Case2 "host $DEF_EUT_IP_ADDR and host         \
                                             $DEF_ENTS_IP_ADDR"
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4CnntOpeningFunc1AssertionGuid002                  \
