...
#
CaseGuid          E490A605-76B9-4f6c-B040-E149BA8FED52
CaseName          NagleSWSA.Func5.Case3
CaseCategory      TCP
CaseDescription   {This item is to test the [EUT] correctly avoids the Silly   \
                   ...
                   transmit unless a full-sized segment can be sent.}
################################################################################
...
BeginLogPacket NagleSWSA.Func6.Case3   "host $DEF_EUT_IP_ADDR and host         \
                                             $DEF_ENTS_IP_ADDR"
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Tcp4NagleSWSAFunc5AssertionGuid003                    \
...
#
# EUT should set persist timer, configure OS to increase the window size to
# exceed 512 bytes before the persist timer times out.
# Note: 259 is the half of the max window that the receiver advertised.
#
#
...
#
# Repeat the steps before to finish the data transmission.
#
UpdateTcpSendBuffer TCB -c $ACK -w 258
SendTcpPacket TCB
