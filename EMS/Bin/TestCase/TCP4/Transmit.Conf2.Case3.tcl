...
#
CaseGuid          63DF6A2C-7C9F-45b3-A9AE-1BAC8F1EC71E
CaseName          Transmit.Conf2.Case3
CaseCategory      TCP
...
BeginLogPacket Transmit.Conf3.Case3 "host $DEF_EUT_IP_ADDR and host              \
                                             $DEF_ENTS_IP_ADDR"
#
...
#              with Token->Packet.TxData is NULL.
#
BS->CreateEvent "$EVT_NOTIFY_SIGNAL, $EFI_TPL_CALLBACK, 1, &@R_Context,        \
...
RecordAssertion $assert $Tcp4TransmitConf2AssertionGuid003                     \
