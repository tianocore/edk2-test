...
BeginLogPacket Accept.Conf2.Case1 "host $DEF_EUT_IP_ADDR and host              \
                                             $DEF_ENTS_IP_ADDR"
#
...
RecordAssertion $assert $Tcp4AcceptConf2AssertionGuid001                       \
                "Tcp4.Accept - Call Accept() while the instance is not a passive one."\
