...
#
CaseGuid          7F403E1D-4EDF-4b3f-B53F-BC48E67BD0B8
...
#
# Configure TCP instance, with one or more of the control options are not      \
...
SetVar R_Configure_ControlOption.EnableSelectiveAck      TRUE
SetVar R_Configure_ControlOption.EnablePathMtuDiscovery  TRUE
...
RecordAssertion $assert $Tcp4ConfigureConf4AssertionGuid001                    \
                "Tcp4.Configure - Call Configure() with one or more of the     \
                 control options are not supported in the implementation."     \
