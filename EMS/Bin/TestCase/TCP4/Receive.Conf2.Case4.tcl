...
#
CaseGuid          2BBD2031-1006-44fa-B581-8C8AED640C0B
CaseName          Receive.Conf2.Case4
CaseCategory      TCP
...
BeginLogPacket Receive.Conf3.Case4 "host $DEF_EUT_IP_ADDR and host             \
                                             $DEF_ENTS_IP_ADDR"
#
...
#              with Token->Packet.RxData->DataLength is 0.
#
BS->CreateEvent "$EVT_NOTIFY_SIGNAL, $EFI_TPL_CALLBACK, 1, &@R_Context,        \
...
RecordAssertion $assert $Tcp4ReceiveConf2AssertionGuid004                      \
                "Tcp4.Receive - Call Receive() to receive a packet with        \
                 Token->Packet.RxData->DataLength being 0."                    \
