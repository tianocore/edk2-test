...
#
CaseGuid          A059A511-CEDA-4487-BD80-D01B9CBAB483
CaseName          RstHandling.Func2.Case4
CaseCategory      TCP
CaseDescription   {This item is to test the <EUT> correctly handles the        \
                   reception of a RST segment in ESTABLISHED state             \
...
proc CleanUpEutEnvironmentEnd {} {
  EndLogPacket
  EndScope _TCP4_RSTHANDLING_FUNC2_CASE5_
  EndLog
}
...
# BeginScope on OS.
#
BeginScope _TCP4_RSTHANDLING_FUNC2_CASE5_

BeginLogPacket RstHandling.Func2.Case5 "host $DEF_EUT_IP_ADDR and host         \
                                             $DEF_ENTS_IP_ADDR"
...
if { $R_Connection_State!=$Tcp4StateEstablished || $R_Status!=$EFI_SUCCESS} {
  ...
  RecordAssertion $assert $GenericAssertionGuid                                \
                  ...
                  "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"    \
                  "CurState - $R_Connection_State, ExpectedState - ESTABLISHED"
...
RecordMessage DEFAULT "Passive Connection: Enter ESTABLISHED state"
...
if { $R_Connection_State != $Tcp4StateClosed || $R_Status != $EFI_SUCCESS} {
  set assert fail
  RecordAssertion $assert $Tcp4RstHandlingFunc2AssertionGuid004                \
                  "Active Connection, In <ESTABLISHED> state:"                 \
