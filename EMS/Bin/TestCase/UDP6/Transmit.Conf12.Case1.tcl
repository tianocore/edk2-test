...
#
CaseGuid        D674B02F-D383-4a78-946B-8C47EED33D51
CaseName        Transmit.Conf12.Case1
CaseCategory    UDP6
CaseDescription {Test the Transmit Conformance of UDP6 - Invoke Transmit() when \
                 TxData.DataLength beyond the maximum udp6 packet size(65507).\
...
# BeginScope
#
BeginScope _UDP6_TRANSMIT_CONF12_CASE1_
...
# 
# Check point: Call Transmit function when TxData.DataLength beyond the maximum \
#              udp6 packet size. EFI_BAD_BUFFER_SIZE should be returned.
#
...
SetVar                R_TxData.DataLength                  65508
SetVar                R_TxData.FragmentCount               1

EFI_UDP6_FRAGMENT_DATA                                     R_FragmentTable
SetVar                R_FragmentTable.FragmentLength       65508
CHAR8                 R_FragmentBuffer(65510)
...
RecordAssertion $assert $Udp6TransmitConf12AssertionGuid001  \
                "Udp6.Transmit -conf- Call Transmit when TxData beyond the maximum udp packet size"  \
...
# EndScope
#
EndScope    _UDP6_TRANSMIT_CONF12_CASE1_
#
# End Log 
#
EndLog