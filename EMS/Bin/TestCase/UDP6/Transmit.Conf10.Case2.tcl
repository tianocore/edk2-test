...
#
CaseGuid        5B5DB0E2-C92F-4e4e-B554-687716C136FB
CaseName        Transmit.Conf10.Case2
CaseCategory    UDP6
CaseDescription {Test the Transmit Conformance of UDP6 - Invoke Transmit() when \
                 Udp6SessionData is NULL if DestinationAddress is unspecified \
                 in Configure. EFI_INVALID_PARAMETER should be returned.}           
################################################################################
...
# BeginScope
#
BeginScope _UDP6_TRANSMIT_CONF10_CASE2_
...
# 
# Check point: Call Transmit function when Udp6SessionData is NULL \
#              if DestinationAddress is unspecified in Configure. \
...
RecordAssertion $assert $Udp6TransmitConf10AssertionGuid002        \
                "Udp6.Transmit -conf- Call Transmit when Udp6SessionData is NULL if DestinationAddress is unspecified in Configure." \
...
# EndScope
#
EndScope    _UDP6_TRANSMIT_CONF10_CASE2_
#
# End Log 
#
EndLog