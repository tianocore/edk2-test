...
#
CaseGuid        DA5C7779-89BE-49b4-AA10-3ABE7F6A45B2
CaseName        Receive.Conf2.Case1
CaseCategory    UDP6
CaseDescription {Test the Receive Conformance of UDP6 - Invoke Receive() when Token \
...
# BeginScope
#
BeginScope _UDP6_RECEIVE_CONF2_CASE1_
...
# 
# Check point: Call Receive function when the Token is NULL.\
#              EFI_INVALID_PARAMETER should be returned.
#
Udp6->Receive  " NULL, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Udp6ReceiveConf2AssertionGuid001               \
                "Udp6.Receive -conf- Call Receive when the Token is NULL."           \
...
# EndScope
#
EndScope    _UDP6_RECEIVE_CONF2_CASE1_
#
# End Log 
#
EndLog