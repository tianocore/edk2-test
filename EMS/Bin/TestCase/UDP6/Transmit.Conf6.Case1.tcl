...
# BeginScope
#
BeginScope _UDP6_TRANSMIT_CONF6_
...
# 
# Check point: Call Transmit function when TxData.FragmentTable.FragmentLength is zero.  \
#              EFI_INVALID_PARAMETER should be returned.
#
...
RecordAssertion $assert $Udp6TransmitConf6AssertionGuid001                        \
                "Udp6.Transmit -conf- Call Transmit when TxData.FragmentTable.FragmentLength is zero" \
...
# EndScope
#
EndScope    _UDP6_TRANSMIT_CONF6_
#
# End Log 
#
EndLog