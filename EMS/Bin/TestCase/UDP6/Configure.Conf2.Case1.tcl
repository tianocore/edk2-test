...
#
CaseGuid        71AED159-7F2D-4163-B0A3-33925F04B392
CaseName        Configure.Conf2.Case1
CaseCategory    UDP6
CaseDescription {Test the Configure Conformance of UDP6 - Invoke Configure() with \
                 RemoteAddress invalid.EFI_INVALID_PARAMETER should be returned.}
################################################################################
...
# BeginScope
#
BeginScope _UDP6_CONFIGURE_CONF2_
...
# 
# Check point: Call Configure with RemoteAddress invalid.
...
SetIpv6Address  R_Udp6ConfigData.RemoteAddress  "ff02::1"
SetVar  R_Udp6ConfigData.RemotePort             1781
  
Udp6->Configure "&@R_Udp6ConfigData, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Udp6ConfigureConf2AssertionGuid001         \
                "Udp6.Configure - Call Configure with Udp6ConfigData.RemoteAddress invalid." \
...
# EndScope
#
EndScope    _UDP6_CONFIGURE_CONF2_
#
# End Log 
#
EndLog