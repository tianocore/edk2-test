...
#
CaseGuid        72C91F83-05E8-4512-AFC8-C8358C177634
...
#
BeginLog
BeginScope _MNP_TRANSMIT_CONFORMANCE1_CASE1_
...
#
# Call Transmit with Invalid parameter
# R_Token = NULL
#
Mnp->Transmit "NULL, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $MnpTransmitConf1AssertionGuid001                      \
...
EndScope _MNP_TRANSMIT_CONFORMANCE1_CASE1_
