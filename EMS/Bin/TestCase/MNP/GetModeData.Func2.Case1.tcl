...
#
CaseGuid        1125B8A5-1C1B-405e-89D2-009D8F790CD9
CaseName        GetModeData.Func2.Case1
CaseCategory    MNP
CaseDescription {Test the Function of MNP.GetModeData - Call GetModeData()     \
	               with the parameter R_MnpConfData=NULL && R_SnpModeData=NULL}
################################################################################
...
#
BeginLog
BeginScope _MNP_GETMODEDATA_FUNCTION2_CASE1_
...
#      
# R_MnpConfData=NULL && R_SnpModeData=NULL
#      
Mnp->GetModeData {NULL, NULL, &@R_Status}
GetAck 
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $MnpGetModeDataFunc2AssertionGuid001                   \
                "MNP.GetModeData - Basic Func - Call GetModeData() with the    \
                parameter  R_MnpConfData=NULL && R_SnpModeData=NULL"           \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"   
...
EndScope _MNP_GETMODEDATA_FUNCTION2_CASE1_
