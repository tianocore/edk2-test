...
#
CaseGuid        DABF7428-2210-49ea-94EC-643A7D6C840C
...
#
BeginLog
BeginScope  _MNP_GROUPS_CONFORMANCE1_CASE1_
...
#
# Call Groups before child started
#
SetEthMacAddress  R_MacAddr "01:00:5e:00:00:01"
Mnp->Groups {TRUE, &@R_MacAddr, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_NOT_STARTED]
RecordAssertion $assert $MnpGroupsConf1AssertionGuid001                        \
                "Mnp.Groups - Conf1 - Call Groups before child started"        \
...
EndScope _MNP_GROUPS_CONFORMANCE1_CASE1_
