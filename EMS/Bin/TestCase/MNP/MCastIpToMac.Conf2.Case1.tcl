...
#
CaseGuid        80604723-92D8-4793-B511-4DE6021C8EA4
CaseName        MCastIpToMac.Conf2.Case1
CaseCategory    MNP
CaseDescription {Test Conformance of MCastIPToMac of MNP - Call McastlpToMac() \
	               with the parameter IpAddress being NULL. The return status    \
...
#
BeginLog
BeginScope  _MNP_MCASTIPTOMAC_CONFORMANCE2_CASE1_
...
# A). IpAddress is NULL
#
Mnp->MCastIpToMac   "FALSE, NULL, &@R_MacAddr, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $MnpMCastIpToMacConf2AssertionGuid001                  \
                "Mnp.MCaseIpToMac - Invalid parameter - IPADDRESS IS NULL"     \
...
EndScope    _MNP_MCASTIPTOMAC_CONFORMANCE2_CASE1_
