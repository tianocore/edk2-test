...
#
CaseGuid        7094A2DB-FD00-4016-B947-CFD05DD6EE0F
CaseName        Transmit.Conf1.Case3
CaseCategory    MNP
CaseDescription {Test Transmit conformance of MNP - Call MNP.Transmit() with   \
	               the parameter TxData.FragmentCount being zero. The return     \
...
#
BeginLog
BeginScope _MNP_TRANSMIT_CONFORMANCE1_CASE3_
...
#
# R_TxData.FragmentCount = 0
#
BS->CreateEvent "$EVT_NOTIFY_SIGNAL, $EFI_TPL_CALLBACK, 0, NULL, &@R_Token.Event,\
                 &@R_Status"
GetAck
...
RecordAssertion $assert $MnpTransmitConf1AssertionGuid003                      \
...
EndScope _MNP_TRANSMIT_CONFORMANCE1_CASE3_
