...
#
CaseGuid        92E9EA18-84BD-42f7-851C-3E60EF7290CF
CaseName        Transmit.Conf1.Case6
CaseCategory    MNP
CaseDescription {Test Transmit conformance of MNP - Call MNP.Transmit() with   \
	               one or more of the Token.TxData.FragmentTable[].FragmentBuffer\
	               fields being NULL. The return status should be                \
...
#
BeginLog
BeginScope _MNP_TRANSMIT_CONFORMANCE1_CASE6_
...
#
# R_Token->R_TxData.FragmentTable[].Data = NULL
#
SetVar R_FragData.FragmentLength      [Sizeof R_Body]
SetVar R_FragData.FragmentBuffer      NULL
SetVar R_TxData.FragmentTable         @R_FragData
Mnp->Transmit "&@R_Token, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $MnpTransmitConf1AssertionGuid006                      \
                "Mnp.Transmit - Conf - FragmentTable.Data=NULL"                \
...
EndScope _MNP_TRANSMIT_CONFORMANCE1_CASE6_
