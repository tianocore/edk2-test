...
#
CaseGuid        C6A6A2BD-0FA4-4fa4-ABC8-A642606A5EB7
CaseName        Configure.Func2.Case1
CaseCategory    Udp4
CaseDescription {Test the Configure Function of UDP4 - Invoke Configure() to   \
                 reconfigure the TypeOfService before the instance been stopped\
                 or reset.}
################################################################################
...
# Begin scope
# 
BeginScope _UDP4_CONFIGURE_FUNCTION2_CASE1_
...
#
SetVar R_Udp4ConfigData.TypeOfService               1

Udp4->Configure {&@R_Udp4ConfigData, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Udp4ConfigureFunc2AssertionGuid001                    \
...
# End scope
#
EndScope _UDP4_CONFIGURE_FUNCTION2_CASE1_
