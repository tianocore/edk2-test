...
#
CaseGuid        C03A3099-7E7A-4381-9913-DDB80CFEADAF
CaseName        Transmit.Conf1.Case4
CaseCategory    Udp4
CaseDescription {Test the Transmit Conformance of UDP4 - Invoke Transmit() with\
                 the parameter Token.Packet.TxData being NULL.The return status\
...
# BeginScope
#
BeginScope _UDP4_TRANSMIT_CONFORMANCE1_CASE4_
...
RecordAssertion $assert $Udp4TransmitConf1AssertionGuid004                     \
                "Udp4.Transmit - Conf - returns EFI_INVALID_PARAMETER with the \
                 parameter Token.Packet.TxData being NULL."                                                          \
...
# EndScope
#
EndScope _UDP4_TRANSMIT_CONFORMANCE1_CASE4_
