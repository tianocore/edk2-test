...
#
CaseGuid        EB3533AF-E62E-410c-870C-E1577D9D589D
CaseName        Transmit.Conf5.Case1
CaseCategory    Udp4
CaseDescription {Test the Transmit Conformance of UDP4 - Invoke Transmit() when\
                 ...
                 The return status should be EFI_BAD_BUFFER_SIZE.}
################################################################################
...
# BeginScope
#
BeginScope _UDP4_TRANSMIT_CONFORMANCE5_CASE1_
...
SetVar R_Udp4ConfigData.DoNotFragment               FALSE
...
SetVar         R_TxData.DataLength              65536
...
RecordAssertion $assert $Udp4TransmitConf5AssertionGuid001                     \
                "Udp4.Transmit - Conf - Invoke Transmit() when the data length \
                 is greater than the maximum UDP packet size."                 \
...
# EndScope
#
EndScope _UDP4_TRANSMIT_CONFORMANCE5_CASE1_
