...
#
CaseGuid        F72D09B7-DA78-4b2a-8AA0-A3DC4AC9405B
CaseName        Configure.Conf2.Case3
CaseCategory    Udp4
CaseDescription {Test the Configure Conformance of UDP4 - Invoke Configure() to\
                 reconfigure the AcceptAnyPort(FALSE) before the instance been \
...
# BeginScope
#
BeginScope _UDP4_CONFIGURE_CONFORMANCE2_CASE3_
...
RecordAssertion $assert $Udp4ConfigureConf2AssertionGuid003                    \
...
# EndScope
#
EndScope _UDP4_CONFIGURE_CONFORMANCE2_CASE3_
