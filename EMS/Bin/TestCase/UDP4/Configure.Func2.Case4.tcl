...
#
CaseGuid        9D35B55E-1D11-46de-AA7F-FF85538822F6
CaseName        Configure.Func2.Case4
CaseCategory    Udp4
CaseDescription {Test the Configure Function of UDP4 - Invoke Configure() to   \
                 reconfigure the ReceiveTimeout before the instance been stopped\
                 or reset.}
################################################################################
...
# Begin scope
#
BeginScope _UDP4_CONFIGURE_FUNCTION2_CASE4_
...
#
SetVar R_Udp4ConfigData.ReceiveTimeout               1

Udp4->Configure {&@R_Udp4ConfigData, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Udp4ConfigureFunc2AssertionGuid004                    \
...
# End scope
#
EndScope _UDP4_CONFIGURE_FUNCTION2_CASE4_
