...
#
CaseGuid        692B850D-856F-45bc-9C5D-3AE0A53FC680
CaseName        Configure.Func2.Case5
CaseCategory    Udp4
CaseDescription {Test the Configure Function of UDP4 - Invoke Configure() to   \
                 reconfigure the TransmitTimeout before the instance been      \
                 stopped or reset.}
################################################################################
...
# Begin scope
#
BeginScope _UDP4_CONFIGURE_FUNCTION2_CASE5_
...
#
SetVar R_Udp4ConfigData.TransmitTimeout               1

Udp4->Configure {&@R_Udp4ConfigData, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Udp4ConfigureFunc2AssertionGuid005                    \
...
# End scope
#
EndScope _UDP4_CONFIGURE_FUNCTION2_CASE5_
