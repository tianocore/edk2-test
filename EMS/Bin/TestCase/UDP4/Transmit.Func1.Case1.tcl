...
#
CaseGuid        F82C03A2-E1A8-4bdb-9787-E7AF9DB26AC4
CaseName        Transmit.Func1.Case1
CaseCategory    Udp4
CaseDescription {Test the Transmit Function of UDP4 - Invoke Route to add a    \
...
proc CleanUpEutEnvironment {} {
  ...
  EndScope _UDP4_TRANSMIT_FUNCTION1_CASE1_
...
# BeginScope
#
BeginScope _UDP4_TRANSMIT_FUNCTION1_CASE1_
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Udp4TransmitFunc1AssertionGuid001                     \
                "Udp4.Transmit - Func - After add a route entry into the route \
                 table, transmit a packet to the destination IP"               \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
