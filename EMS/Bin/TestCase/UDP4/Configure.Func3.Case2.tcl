...
#
CaseGuid        AC87737B-1A42-4e8c-AFA4-8B85C2915EE8
CaseName        Configure.Func3.Case2
CaseCategory    Udp4
CaseDescription {Test the Configure Function of UDP4 - Invoke Configure() with \
                 the parameter AcceptBroadcast set to TRUE. Check that it can  \
                 receive broadcast packet successfully.}
################################################################################
...
# Begin scope
#
BeginScope _UDP4_CONFIGURE_FUNCTION3_CASE2_
...
RecordAssertion $assert $Udp4ConfigureFunc3AssertionGuid002                    \
...
# End scope
#
EndScope _UDP4_CONFIGURE_FUNCTION3_CASE2_
