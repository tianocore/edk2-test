...
#
CaseGuid        D46449D4-E3E8-43fb-83EA-EBD301959430
CaseName        Groups.Func1.Case1
CaseCategory    Udp4
CaseDescription {Test the Groups Function of UDP4 - Invoke Groups() to join a  \
                 group address and call Receive() to check it can receive UDP  \
                 packets to the group IP.}
################################################################################
...
# Begin Scope
#
BeginScope _UDP4_GROUPS_FUNCTION1_CASE1_
...
SetVar R_Udp4ConfigData.TimeToLive                  7
...
SetVar R_Token.Status 0x09 ;#Make sure it will be modified.
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Udp4GroupsFunc1AssertionGuid001                       \
...
# End scope
#
EndScope _UDP4_GROUPS_FUNCTION1_CASE1_
