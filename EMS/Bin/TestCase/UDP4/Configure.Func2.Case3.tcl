...
#
CaseGuid        5A4CD0F0-6FF7-404b-BE25-2DEC861F566A
CaseName        Configure.Func2.Case3
CaseCategory    Udp4
CaseDescription {Test the Configure Function of UDP4 - Invoke Configure() to   \
                 reconfigure the DoNotFragment before the instance been stopped\
                 or reset.}
################################################################################
...
# Begin scope
#
BeginScope _UDP4_CONFIGURE_FUNCTION2_CASE3_
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Udp4ConfigureFunc2AssertionGuid003                    \
...
# End scope
#
EndScope _UDP4_CONFIGURE_FUNCTION2_CASE3_
