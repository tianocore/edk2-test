...
#
CaseGuid        C7F5484F-DEB1-47ce-963F-A95CF9AB2CCF
CaseName        Configure.Func5.Case1
CaseCategory    Udp4
CaseDescription {Test the Configure Function of UDP4 - Invoke Configure() with \
                 the parameter AcceptAnyPort set to FALSE. Check that it can not\
...
# Begin scope
#
BeginScope _UDP4_CONFIGURE_FUNCTION5_CASE1_
...
RecordAssertion $assert $Udp4ConfigureFunc5AssertionGuid001                    \
                "Udp4.Configure - Func - check Event"                          \
                "Return R_Context - $R_Context, Expected R_Context - 0"

#
# If cannot receive the packet, cancel the token. Bugbug??
#
...
# End scope
#
EndScope _UDP4_CONFIGURE_FUNCTION5_CASE1_
