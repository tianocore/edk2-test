...
#
CaseGuid        AB49C3F1-3A36-4cf0-909C-ACD20E69A824
CaseName        Configure.Conf2.Case1
CaseCategory    Udp4
CaseDescription {Test the Configure Conformance of UDP4 - Invoke Configure() to\
                 reconfigure the AcceptPromiscuous(TRUE) before the instance been\
...
# BeginScope
#
BeginScope _UDP4_CONFIGURE_CONFORMANCE2_CASE1_
...
RecordAssertion $assert $Udp4ConfigureConf2AssertionGuid001                    \
...
# EndScope
#
EndScope _UDP4_CONFIGURE_CONFORMANCE2_CASE1_
