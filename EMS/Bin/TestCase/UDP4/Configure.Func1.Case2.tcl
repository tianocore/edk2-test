...
# Begin scope
# 
BeginScope _UDP4_CONFIGURE_FUNCTION1_CASE2_
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Udp4ConfigureFunc1AssertionGuid002                    \
...
CreatePacket udp_packet -t udp -udp_dp $targetport -udp_sp $hostport -udp_payload aaa
...
# End scope
# 
EndScope _UDP4_CONFIGURE_FUNCTION1_CASE2_
