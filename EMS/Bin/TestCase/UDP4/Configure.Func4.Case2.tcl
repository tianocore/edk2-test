...
#
CaseGuid        84DF3BF8-32EC-450e-970E-22C778E00BC1
CaseName        Configure.Func4.Case2
CaseCategory    Udp4
CaseDescription {Test the Configure Function of UDP4 - Invoke Configure() with \
                 the parameter AcceptPromiscuous set to TRUE. Check that it can\
                 receive packet to other unicast MACs than its own.}
################################################################################
...
# Begin scope
#
BeginScope _UDP4_CONFIGURE_FUNCTION4_CASE2_
...
RecordAssertion $assert Udp4ConfigureFunc4AssertionGuid002                     \
...
# End scope
#
EndScope _UDP4_CONFIGURE_FUNCTION4_CASE2_
