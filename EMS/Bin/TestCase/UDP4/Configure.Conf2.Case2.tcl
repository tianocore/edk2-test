...
#
CaseGuid        1EE35B23-06FD-492d-80CE-3B5365A17EA4
CaseName        Configure.Conf2.Case2
CaseCategory    Udp4
CaseDescription {Test the Configure Conformance of UDP4 - Invoke Configure() to\
                 reconfigure the AcceptBroadcast(FALSE) before the instance been\
...
# BeginScope
#
BeginScope _UDP4_CONFIGURE_CONFORMANCE2_CASE2_
...
RecordAssertion $assert $Udp4ConfigureConf2AssertionGuid002                    \
...
# EndScope
#
EndScope _UDP4_CONFIGURE_CONFORMANCE2_CASE2_
