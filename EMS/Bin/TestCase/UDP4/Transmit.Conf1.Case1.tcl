...
#
CaseGuid        1D387E06-52EF-4cc8-BD3E-3768672207E9
CaseName        Transmit.Conf1.Case1
CaseCategory    Udp4
CaseDescription {Test the Transmit Conformance of UDP4 - Invoke Transmit() with\
                 the parameter Token being NULL.The return status should be    \
...
# BeginScope
#
BeginScope _UDP4_TRANSMIT_CONFORMANCE1_CASE1_
...
Udp4->Transmit {NULL, &@R_Status}
GetAck

set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Udp4TransmitConf1AssertionGuid001                     \
                "Udp4.Transmit - Conf - With CompletionToken is NULL"          \
...
# EndScope
#
EndScope _UDP4_TRANSMIT_CONFORMANCE1_CASE1_
