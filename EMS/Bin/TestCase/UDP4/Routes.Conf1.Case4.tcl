...
#
CaseGuid        F1AC644A-E3E8-495a-947B-B1B255E6CD96
CaseName        Routes.Conf1.Case4
CaseCategory    Udp4
CaseDescription {Test the Routes Conformance of UDP4 - Invoke Routes() with the\
                 parameter *SubnetMask being invalid subnet mask.The return status\
...
# BeginScope
#
BeginScope _UDP4_ROUTES_CONFORMANCE1_CASE4_
...
set invalid_subnetmask  0.0.255.255 
...
SetIpv4Address R_SubnetMask     $invalid_subnetmask
...
RecordAssertion $assert $Udp4RoutesConf1AssertionGuid004                       \
                "Udp4.Routes - Conf - Add route with invalid R_SubnetMask      \
                $invalid_subnetmask"                                           \
...
# EndScope
#
EndScope _UDP4_ROUTES_CONFORMANCE1_CASE4_
