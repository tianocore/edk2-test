...
#
CaseGuid        359A4C7D-9B2A-4aff-ADD7-96F66E682B66
CaseName        Routes.Conf1.Case1
CaseCategory    Udp4
CaseDescription {Test the Routes Conformance of UDP4 - Invoke Routes() with the\
                 parameter SubnetAddress being NULL.The return status should   \
...
# BeginScope
#
BeginScope _UDP4_ROUTES_CONFORMANCE1_CASE1_
...
Udp4->Routes {FALSE, NULL, &@R_SubnetMask, &@R_GatewayAddress, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Udp4RoutesConf1AssertionGuid001                       \
                "Udp4.Routes - Add route with R_SubnetAddress NULL"            \
...
# EndScope
#
EndScope _UDP4_ROUTES_CONFORMANCE1_CASE1_
