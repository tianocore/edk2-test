...
# BeginScope
#
BeginScope _UDP4_RECEIVE_CONFORMANCE1_CASE1_
...
Udp4->Receive {NULL, &@R_Status}
GetAck

set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Udp4ReceiveConf1AssertionGuid001                      \
                "Udp4.Receive - With R_Token is NULL"                          \
...
# EndScope
#
EndScope _UDP4_RECEIVE_CONFORMANCE1_CASE1_
