...
#
CaseGuid        7B7BC144-050C-4757-A8B2-06E82634D658
CaseName        Transmit.Conf1.Case3
CaseCategory    Udp4
CaseDescription {Test the Transmit Conformance of UDP4 - Invoke Transmit() with\
                 the parameter Token.Packet.FragmentCount being zero.The return\
...
# BeginScope
#
BeginScope _UDP4_TRANSMIT_CONFORMANCE1_CASE3_
...
RecordAssertion $assert $Udp4TransmitConf1AssertionGuid003                     \
                "Udp4.Transmit - Conf - With the parameter                     \
                 Token.Packet.TxData.FragmentCount being zero."                \
...
# EndScope
#
EndScope _UDP4_TRANSMIT_CONFORMANCE1_CASE3_
