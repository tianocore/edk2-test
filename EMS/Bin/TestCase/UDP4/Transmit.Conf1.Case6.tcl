...
#
CaseGuid        245969AF-E8F6-4bf4-89EF-9B108DFC6BDF
CaseName        Transmit.Conf1.Case6
CaseCategory    Udp4
CaseDescription {Test the Transmit Conformance of UDP4 - Invoke Transmit() with\
                 the parameter Token.Packet.TxData.FragmentTable[].FragmentLenth\
                 /FragmetBuffer fields being invalid. The return status should \
...
# BeginScope
#
BeginScope _UDP4_TRANSMIT_CONFORMANCE1_CASE6_
...
RecordAssertion $assert $Udp4TransmitConf1AssertionGuid006                     \
                "Udp4.Transmit - Conf - With the parameter                     \
                 Token.Packet.TxData.FragmentTable[].FragmentLenth             \
                 fields being Zero."                                           \
...
RecordAssertion $assert $Udp4TransmitConf1AssertionGuid006                     \
                "Udp4.Transmit - Conf - With the parameter                     \
                 Token.Packet.TxData.FragmentTable[].FragmentBuffer fields being\
                 NULL."                                                        \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"
...
# EndScope
#
EndScope _UDP4_TRANSMIT_CONFORMANCE1_CASE6_
