...
#
CaseGuid        F6D27A0F-96BD-4442-8CB1-C50EC31030BC
CaseName        Routes.Conf1.Case2
CaseCategory    Udp4
CaseDescription {Test the Routes Conformance of UDP4 - Invoke Routes() with the\
                parameter SubnetMask being NULL.The return status should be    \
...
# BeginScope
#
BeginScope _UDP4_ROUTES_CONFORMANCE1_CASE2_
...
Udp4->Routes {FALSE, &@R_SubnetAddress, NULL, &@R_GatewayAddress, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Udp4RoutesConf1AssertionGuid002                       \
                "Udp4.Routes - Conf - Add route with R_SubnetMask NULL."       \
...
# EndScope
#
EndScope _UDP4_ROUTES_CONFORMANCE1_CASE2_
