...
#
CaseGuid        31597BF2-6394-4632-9F29-F8D5222A663F
CaseName        Configure.Func4.Case1
CaseCategory    Udp4
CaseDescription {Test the Configure Function of UDP4 - Invoke Configure() with \
                 the parameter AcceptPromiscuous set to FALSE. Check that it can\
                 not receive packet to other unicast MACs than its own.}
################################################################################
...
# Begin scope
#
BeginScope _UDP4_CONFIGURE_FUNCTION4_CASE1_
...
RecordAssertion $assert $Udp4ConfigureFunc4AssertionGuid001                    \
...
# End scope
#
EndScope _UDP4_CONFIGURE_FUNCTION4_CASE1_
