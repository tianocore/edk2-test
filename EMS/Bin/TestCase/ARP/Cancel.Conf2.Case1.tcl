...
#
CaseGuid        604DCF8C-AE1E-4d57-A74F-C0724C06E596
CaseName        Cancel.Conf2.Case1
CaseCategory    ARP
CaseDescription {This case is to test the EFI_NOT_FOUND conformance of ARP.Cancel}
################################################################################
...
RecordAssertion $assert $ArpCancelConfAssertionGuid003                         \
                "Arp.Cancel - with Event not found"                            \
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_NOT_FOUND]
RecordAssertion $assert $ArpCancelConfAssertionGuid004                         \
