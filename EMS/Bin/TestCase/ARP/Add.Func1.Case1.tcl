...
#
CaseGuid        42F00E0F-CADF-49d0-AC2C-40C945C46743
CaseName        Add.Func1.Case1
CaseCategory    ARP
CaseDescription {This case is to test the function of ARP.Add - Call Arp.Add() \
	               with DenyFlag FALSE and valid TargetSwAddress/TargetHwAddress.}
################################################################################
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $ArpAddFuncAssertionGuid001                            \
