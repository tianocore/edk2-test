...
#
CaseGuid        F00684D5-C762-4e0c-9159-92D876B763FA
CaseName        Add.Func2.Case5
CaseCategory    ARP
CaseDescription {This case is to test the function of ARP.Add}
################################################################################
...
# Check point
#
Arp->Add {TRUE, &@R_TargetSwAddress1, NULL, 0, TRUE, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $ArpAddFuncAssertionGuid010                            \
                "Arp.Add - Add denied entry"                                   \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
