...
#
CaseGuid        EBB31F2E-A8AE-4afc-9AD1-A17045364C9C
CaseName        Delete.Func1.Case1
CaseCategory    ARP
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $ArpDeleteFuncAssertionGuid001                         \
                "Arp.Delete - delete normal entry"                             \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
# Check point
#
Arp->Delete {FALSE, &@R_TargetHwAddress, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $ArpDeleteFuncAssertionGuid002                         \
                "Arp.Delete - delete normal entry"                             \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
