...
#
CaseGuid        6C80C3CB-B798-4098-98C6-0D1AD3CF8AF5
CaseName        Request.Conf4.Case1
CaseCategory    ARP
CaseDescription {This case is to test the EFI_NOT_READY conformance of         \
	               ARP.Request}
################################################################################
proc ArpDestroy {} {
...
RecordAssertion $assert $ArpRequestConfAssertionGuid008                        \
                "Arp.Request - Send request"                                   \
                "ReturnStatus - $R_Status, ExpectedR_Status - $EFI_NOT_READY,  \
...
CreatePacket Pkt2 -t arp -arp_op 2
SendPacket Pkt2

LocalEther 00:02:03:04:05:07
CreatePacket Pkt3 -t arp -arp_op 2
SendPacket Pkt3
...
RecordAssertion $assert $ArpRequestConfAssertionGuid009                        \
