...
#
CaseGuid        046D2458-C454-48c6-9CD9-4D1C0552A6B3
CaseName        Find.Func5.Case1
CaseCategory    ARP
...
RecordAssertion $assert $GenericAssertionGuid                                  \
                ...
                "ReturnStatus - $R_Status, ExpecteStatus - $EFI_SUCCESS"
...
SetIpv4Address R_TargetSwAddress.v4 "171.16.210.160"
SetEthMacAddress R_TargetHwAddress "00:02:03:04:05:06"
SetVar R_IpAddressBuffer @R_TargetSwAddress
SetVar R_MacAddressBuffer @R_TargetHwAddress
...
RecordAssertion $assert $ArpFindFuncAssertionGuid009                           \
...
RecordAssertion $assert $ArpFindFuncAssertionGuid010                           \
                "Arp.Find - Check the entry"                                   \
                 EntryCound - $R_EntryCount, ExpectedCount - 0x1"
