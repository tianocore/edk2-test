...
#
CaseGuid        6E7C5077-0517-4243-B937-4FC3FC19CE68
CaseName        Delete.Func2.Case1
CaseCategory    ARP
CaseDescription {This case is to test the function of ARP.Delete}
################################################################################
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $ArpDeleteFuncAssertionGuid003                         \
                "Arp.Delete - delete all entry"                                \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
RecordAssertion $assert $GenericAssertionGuid                                  \
                ...
                "ReturnStatus - $R_Status, Expected_Status - $EFI_NOT_READY"
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $ArpDeleteFuncAssertionGuid004                         \
                "Arp.Delete - delete all entry"                                \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
