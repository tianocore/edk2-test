...
#
CaseGuid        F17E41F8-BBA6-40b3-AD96-127AD7301A33
CaseName        Add.Func1.Case3
CaseCategory    ARP
CaseDescription {This case is to test the function of ARP.Add with timeout set.}
################################################################################
...
RecordAssertion $assert $ArpAddFuncAssertionGuid003                            \
                "Arp.Add - Add normal entry with timeout"                      \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
