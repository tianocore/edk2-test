...
#
CaseGuid        3A0FADE5-2CC9-49f9-80AC-5234F99AD7F7
CaseName        Configure.Func8.Case1
CaseCategory    ARP
CaseDescription {This case is test the function of ARP.Configure -             \
...
CreatePayload Pld data 52 0x00 0x01 0x08 0x00 0x06 0x10 0x00 0x02 0x00 0x02 0x03\
                          0x04 0x05 0x06 0xac 0x10 0xd2 0xa1 0x00 0x00 0x00 0x00\
                          0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x$temp0     \
                          0x$temp1 0x$temp2 0x$temp3 0x$temp4 0x$temp5 0xac 0x10\
                          0xd2 0x66 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00\
                          0x00 0x00 0x00

CreatePacket Pkt1 -t eth -eth_type 0x0806 -eth_payload Pld
SendPacket Pkt1
...
RecordAssertion $assert $ArpConfigureFuncAssertionGuid010                      \
...
CreatePayload Pld data 52 0x00 0x01 0x08 0x00 0x06 0x10 0x00 0x01 0x00 0x02 0x03\
                          0x04 0x05 0x06 0xac 0x10 0xd2 0xa1 0x00 0x00 0x00 0x00\
                          0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00\
                          0x00 0x00 0x00 0xac 0x10 0xd2 0x66 0x00 0x00 0x00 0x00\
                          0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00
CreatePacket Pkt2 -t eth -eth_type 0x0806 -eth_payload Pld 
SendPacket Pkt2
