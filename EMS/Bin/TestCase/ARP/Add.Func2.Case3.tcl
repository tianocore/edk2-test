...
#
CaseGuid        D7BD5DC1-7688-4fda-B6ED-997D58232184
CaseName        Add.Func2.Case3
CaseCategory    ARP
CaseDescription {This case is to test the function of ARP.Add - Call Arp.Add() \
	               to overwrite the existed entry with a deny entry and the      \
	               TargetHwAddress is still ¡°00:02:03:04:05:06¡±.}
################################################################################
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $ArpAddFuncAssertionGuid007                            \
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $ArpAddFuncAssertionGuid008                            \
                "Arp.Add - Add deny entry overwrite"                           \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
