...
#
CaseGuid           0D621B1B-D3F6-4359-8DD9-0E1FE9298BE0
CaseName           Routes.Conf6.Case1
CaseCategory       IP6
CaseDescription    { Test the Routes Function of IP6 - invoke Routes()                       \
                     when DeleteRoute is TRUE and this entry is not in current routing table \
...
# Begin Scope ...
#
BeginScope        IP6_ROUTES_CONF6_CASE1_
...
#
# Check point:Call Routes when DeleteRoute is TRUE and this entry is not in current routing table.
#             EFI_NOT_FOUND should be returned.
#
...
RecordAssertion $assert $Ip6RoutesConf6AssertionGuid001           \
...
# End scope
#
EndScope          IP6_ROUTES_CONF6_CASE1_
#
# End log
#
EndLog
