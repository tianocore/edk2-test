...
#
CaseGuid           F6CC85C1-7B16-4db8-A9EF-99758ADA9377
CaseName           Groups.Conf3.Case1
CaseCategory       IP6
CaseDescription    { Test the Groups Function of IP6 - invoke Groups()   \
                     when GroupAddress is not NULL and GroupAddress is   \
                     not a multicase IPv6 address .EFI_INVALID_PARAMETER \
                     should be returned.
                   }
################################################################################
...
# Begin Scope ...
#
BeginScope         IP6_GROUPS_CONF3_CASE1_
...
SetIpv6Address              R_GroupAddress    "2002::1"

#
#Check point: Call Groups when GroupAddress is not NULL and *GroupAddress is not a multicast IPv6 address.
#             EFI_INVALID_PARAMETER should be returned. 
#
Ip6->Groups     "TRUE, &@R_GroupAddress, &@R_Status"
GetAck
set assert      [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Ip6GroupsConf3AssertionGuid001                \
                "Ip6->Groups - Conf - Invalid Parameter"                          \
...
#End scope
#
EndScope        IP6_GROUPS_CONF3_CASE1_
#
#End log
#
EndLog
