...
#
CaseGuid          E8A887BA-CB8D-4b18-8296-F2F85E391A52
CaseName          Config.Conf1.Case1
CaseCategory      IP6
CaseDescription   {Test the Configure Function of IP6 - Invoke Configure() when             \
                  Ip6ConfigData->StationAddress is neither zero nor an unicast IPV6 Address.\
...
# Begin scope ...
#
BeginScope         _IP6_CONFIGURE_CONF1_CASE1_
...
SetIpv6Address R_Ip6ConfigData.StationAddress        "ff02::1"
...
#
# Check point: Configure this child with Ip6ConfigData->StationAddress neither zero nor a valid unicast Ipv6 #              address. EFI_INVALID_PARAMETER should be returned.
#
Ip6->Configure "&@R_Ip6ConfigData, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Ip6ConfigureConf1AssertionGuid001       \
                "Ip6.Configure - Conf- Configure child with Ip6ConfigData.StationAddress  neither zero nor a valid unicast Ipv6 address"     \
...
# End scope
#
EndScope         _IP6_CONFIGURE_CONF1_CASE1_
#
# End Log
#
EndLog
