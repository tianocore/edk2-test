...
#
CaseGuid        5AE74E46-2216-4a69-B4E1-62D275DA5FF4
CaseName        Neighbors.Func2.Case1
CaseCategory    IP6
CaseDescription {Test the Neighbors Function of IP6 - Invoke Neighbors() \
                 to override an existed a neighbor entry.}
################################################################################
...
# Begin Scope ...
#
BeginScope   _IP6_NEIGHBORS_FUNCTION2_CASE1_
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Ip6NeighborsFunc2AssertionGuid001         \
                "Ip6.Neighbors - Func - Add a neighbor entry"                 \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"

#
# Change TargetLinkAddress to "0A:97:3B:34:CD:9A"
# Call Neighbors to update the neighbor cache
#
SetEthMacAddress R_TargetLinkAddress          "0A:97:3B:34:CD:9A"
Ip6->Neighbors "FALSE, &@R_TargetIp6Address, &@R_TargetLinkAddress, @R_Timeout, TRUE, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Ip6NeighborsFunc2AssertionGuid002         \
                "Ip6.Neighbors - Func - Update a neighbor entry"              \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
RecordAssertion $assert $Ip6NeighborsFunc2AssertionGuid003       \
...
RecordAssertion $assert $Ip6NeighborsFunc2AssertionGuid004       \
...
RecordAssertion $assert $Ip6NeighborsFunc2AssertionGuid005       \
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Ip6NeighborsFunc2AssertionGuid006         \
...
RecordAssertion $assert $Ip6NeighborsFunc2AssertionGuid007       \
...
# End scope
#
EndScope _IP6_NEIGHBORS_FUNCTION2_CASE1_
#
# End Log
#
EndLog