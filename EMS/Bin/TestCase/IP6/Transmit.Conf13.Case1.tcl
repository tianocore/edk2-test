...
#
CaseGuid           4230EED0-1D23-4c89-AD48-B993A6A5F46E
CaseName           Transmit.Conf13.Case1
CaseCategory       IP6
CaseDescription    { Test the Transmit Function of IP6 - invoke Transmit()    \
                     when Token->Event has already been queued                \
...
# Begin Scope ...
#
BeginScope        IP6_TRANSMIT_CONF13_CASE1_
...
SetVar         R_Ip6ConfigData.ReceiveTimeout      10000000
SetVar         R_Ip6ConfigData.TransmitTimeout     10000000
...
#
# Call Transmit Function for the first time
#    
...
#
# Check point:Call Transmit Function with the same Event Again. EFI_ACCESS_DENIED should be returned.
#
Ip6->Transmit    "&@R_Token, &@R_Status"
GetAck
set  assert      [VerifyReturnStatus R_Status  $EFI_ACCESS_DENIED]
RecordAssertion  $assert       $Ip6TransmitConf13AssertionGuid001    \
                 "Ip6->Transmit -Conf- Call Transmit again with the same Event "      \
...
# End scope
#
EndScope        IP6_TRANSMIT_CONF13_CASE1_
#
# End log
#
EndLog
