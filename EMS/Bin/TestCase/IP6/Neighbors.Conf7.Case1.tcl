...
#
CaseGuid           251997D0-3AD6-4780-B00E-FD5C4CA97879
CaseName           Neighbors.Conf7.Case1
CaseCategory       IP6
CaseDescription    { Test the Neighbors Function of IP6 - invoke Neighbors()                 \
                     when DeleteFlag is TRUE and this entry isn't in current neighbor cache. \
...
# Begin Scope ...
#
BeginScope         IP6_NEIGHBORS_CONF7_CASE1_
...
#
# Check point:Call Neighbors Function when DeleteFlag is TRUE and this entry is not in current neighbor cache.
#             EFI_NOT_FOUND should be returned. 
#
...
RecordAssertion  $assert $Ip6NeighborsConf7AssertionGuid001                   \
                 "Ip6->Neighbors - Conf - Delete a neighbor which isn't in current neighbor cache "  \
...
# End scope
#
EndScope          IP6_NEIGHBORS_CONF7_CASE1_
#
# End log
#
EndLog
