...
#
CaseGuid           FCB375C7-E580-4641-8A9C-F67C5B3AAF9C
CaseName           Transmit.Conf10.Case1
CaseCategory       IP6
CaseDescription    { Test the Transmit Function of IP6 - invoke Transmit()                             \
                     when Token->Packet.TxData->DataLength is not equal to the sum of fragments length \    
...
# Begin Scope ...
#
BeginScope         IP6_TRANSMIT_CONF10_CASE1_
...
EFI_IP6_FRAGMENT_DATA                                   R_FragmentTable(2)
SetVar                R_FragmentTable(0).FragmentLength 4 
CHAR8                 R_FragmentBuffer(1600)
SetVar                R_FragmentBuffer                  "Transmit"
SetVar                R_FragmentTable(0).FragmentBuffer &@R_FragmentBuffer

SetVar                R_FragmentTable(1).FragmentLength 8
CHAR8                 R_FragmentBuffer1(1600)
SetVar                R_FragmentBuffer1                 "TestCase"
SetVar                R_FragmentTable(1).FragmentBuffer &@R_FragmentBuffer1
SetVar                R_TxData.FragmentTable            @R_FragmentTable
SetVar                R_Token.Packet                    &@R_TxData

#
# Check point:Call Transmit Function with Token->Packet.TxData->DataLength \
#             is not equal to the sum of fragments length.                 \
#             EFI_INVALID_PARAMETER should be returned.
#
Ip6->Transmit      " &@R_Token, &@R_Status"
GetAck
set assert         [VerifyReturnStatus  R_Status  $EFI_INVALID_PARAMETER]
RecordAssertion    $assert           $Ip6TransmitConf10AssertionGuid001      \
                   "Ip6->Transmit -Conf- Call Transmit  withToken->Packet.TxData->DataLength     \
                    is not equal to the sum of fragments length  "                         \
...
# End scope
#
EndScope          IP6_TRANSMIT_CONF10_CASE1_
#
# End log
#
EndLog
