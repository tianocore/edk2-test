...
#
CaseGuid           64A0D0B3-8A95-4c24-9654-9B048350A6DE
CaseName           Routes.Conf4.Case1
CaseCategory       IP6
CaseDescription    { Test the Routes Function of IP6 - invoke Routes()                            \
                     when GateWayAddress isn't a valid unicast IPv6 address\
...
# Begin Scope ...
#
BeginScope        IP6_ROUTES_CONF4_CASE1_
...
SetIpv6Address  R_GatewayAddress   "ff02::1"

#
# Check point:Call Routes when *GatewayAddress is not a valid unicast IPv6 address.
#             EFI_INVALID_PARAMETER should be returned.
#
Ip6->Routes    "@R_DeleteRoute, &@R_Destination, @R_PrefixLength, &@R_GatewayAddress,&@R_Status"
GetAck
set assert      [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Ip6RoutesConf4AssertionGuid001                  \
...
# End scope
#
EndScope          IP6_ROUTES_CONF4_CASE1_
#
# End log
#
EndLog
