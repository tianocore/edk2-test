...
#
CaseGuid           97A139B1-D566-441d-9819-857DC9FAA427
CaseName           Routes.Conf3.Case1
CaseCategory       IP6
CaseDescription    { Test the Routes Function of IP6 - invoke Routes()                            \
                     when DeleteRoute is FALSE ,Destiniation is NULL,and GateWayAddress isn't NULL\
...
# Begin Scope ...
#	
BeginScope        IP6_ROUTES_CONF3_CASE1_
...
SetIpv6Address  R_GatewayAddress   "2002::2"

#
# Check point:Call Routes Function when *GatewayAddress is not a valid unicast IPv6 address.
#             EFI_INVALID_PARAMETER should be returned.
#
Ip6->Routes     "@R_DeleteRoute, &@R_Destination, @R_PrefixLength, &@R_GatewayAddress,&@R_Status"
GetAck
set assert      [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Ip6RoutesConf3AssertionGuid001                 \
...
# End scope
#
EndScope         IP6_ROUTES_CONF3_CASE1_
#
# End log
#
EndLog
