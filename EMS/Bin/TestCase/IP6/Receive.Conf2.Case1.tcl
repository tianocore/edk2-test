...
#
CaseGuid           06127A44-9EBB-4e39-A711-19DD271F14D6
CaseName           Receive.Conf2.Case1
CaseCategory       IP6
CaseDescription    { Test the Receive Function of IP6 - invoke Receive()  \
                     when Token is NULL.EFI_INVALID_PARAMETER should be returned. \
                   }
################################################################################
...
# Begin Scope ...
#
BeginScope         IP6_RECEIVE_CONF2_CASE1_
...
#
# Check point:Call Receive Function when Token is NULL.EFI_INVALID_PARAMETER should be returned.
#    
Ip6->Receive      "&@R_Token, &@R_Status"
GetAck
set  assert       [VerifyReturnStatus R_Status  $EFI_INVALID_PARAMETER]
RecordAssertion   $assert       $Ip6ReceiveConf2AssertionGuid001            \
                  "Ip6->Receive -Conf- Call Receive  Function with Token is NULL "          \
...
# End scope
#
EndScope          IP6_RECEIVE_CONF2_CASE1_
#
# End log
#
EndLog
