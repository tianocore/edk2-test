...
#
CaseGuid           BA274C14-D2B2-4ea7-8FE4-DAA3224FC4CF
CaseName           Neighbors.Conf2.Case1
CaseCategory       IP6
CaseDescription    { Test the Neighbors Function of IP6 - invoke Neighbors()     \
                     when TargetIp6Address is NULL                  \
...
# Begin Scope ...
#
BeginScope      IP6_NEIGHBORS_CONF2_CASE1_
...
#
# Check point: Call Neighbors when TargetIp6Address is NULL.EFI_INVALID_PARAMETER should be returned.
#
Ip6->Neighbors "@R_DeleteFlag, &@R_TargetIp6Address, &@R_TargetLinkAddress, @R_Timeout, @R_Override, &@R_Status"
GetAck
set assert       [VerifyReturnStatus  R_Status  $EFI_INVALID_PARAMETER]
RecordAssertion  $assert $Ip6NeighborsConf2AssertionGuid001                        \
...
#End scope
#
EndScope         IP6_NEIGHBORS_CONF2_CASE1_
#
#End log
#
EndLog
