...
#
CaseGuid           936C8805-AAC2-4091-BE84-30028C7C25CF
CaseName           Groups.Conf4.Case1
CaseCategory       IP6
CaseDescription    { Test the Groups Function of IP6 - invoke Groups()   \
                     when JoinFlag is TRUE and GroupAddress is   \
                     in the group table.EFI_ALREADY_STARTED \
                     should be returned.
                   }
################################################################################
...
# Begin Scope ...
#
BeginScope        IP6_GROUPS_CONF4_CASE1_
...
#
# Call Groups Function 
#
Ip6->Groups   "TRUE, &@R_GroupAddress, &@R_Status"
GetAck
set assert      [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                \
                "Ip6->Groups - Conf - Join Group"                  \
                "ReturnStatus -$R_Status, ExpectedStatus -$EFI_SUCCESS"

#
# Check point:Call Groups Function when JoinFlag is TRUE and*GroupAddress is in the group table.
#             EFI_ALREADY_STARTED should be returned
#
Ip6->Groups    "TRUE, &@R_GroupAddress, &@R_Status"
GetAck 
set assert      [VerifyReturnStatus R_Status $EFI_ALREADY_STARTED]
RecordAssertion $assert  $Ip6GroupsConf4AssertionGuid001               \
                "Ip6->Groups - Conf - Already  Join Group "                        \
...
#End scope
#
EndScope          IP6_GROUPS_CONF4_CASE1_
#
#End log
#
EndLog
