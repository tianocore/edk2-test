...
#
CaseGuid           6ABF3411-9997-4d5b-9DDF-1652ACDE694B

CaseName           Transmit.Conf12.Case1
CaseCategory       IP6
CaseDescription    { Test the Transmit Function of IP6 - invoke Transmit()    \
                     when Token->Packet.TxData->DestinationAddress is zero    \
                     if DestinationAddress is configured as zero in Configure \
...
# Begin Scope ...
#
BeginScope       IP6_TRANSMIT_CONF12_CASE1_
...
SetVar         R_Ip6ConfigData.AcceptAnyProtocol   TRUE
...
SetIpv6Address   R_TxData.DestinationAddress     0
...
#
# Check point:Call Transmit Function when Token->Packet.TxData->DestinationAddress is zero if DestinationAddress is 
#             configured as zero in Configure.EFI_INVALID_PARAMETER should be returned.
#
Ip6->Transmit    "&@R_Token, &@R_Status"
GetAck
set assert       [VerifyReturnStatus   R_Status  $EFI_INVALID_PARAMETER]
RecordAssertion  $assert           $Ip6TransmitConf12AssertionGuid001   \
                 "Ip6->Transmit -Conf- Call the Transmit Function  "                   \
...
# End scope
#
EndScope        IP6_TRANSMIT_CONF12_CASE1_
#
# End log
#
EndLog
