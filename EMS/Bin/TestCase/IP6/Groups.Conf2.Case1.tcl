...
#
CaseGuid           7B4FE345-DB8F-4eea-85F2-294A2D5B5305
CaseName           Groups.Conf2.Case1
CaseCategory       IP6
CaseDescription    { Test the Groups Function of IP6 - invoke Groups()   \
                     when JoinFlag is TRUE and GroupAddress is NULL      \
...
# Begin Scope ...
#
BeginScope        IP6_GROUPS_CONF2_CASE1_
...
#
#Check point: Call Groups Function when JoinFlag is TRUE and GroupAddress is NULL.
#             EFI_INVALID_PARAMETER should be returned 
#
Ip6->Groups   "TRUE, NULL, &@R_Status"
GetAck
set assert      [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Ip6GroupsConf2AssertionGuid001                \
...
#End scope
#
EndScope         IP6_GROUPS_CONF2_CASE1_
#
#End log
#
EndLog
