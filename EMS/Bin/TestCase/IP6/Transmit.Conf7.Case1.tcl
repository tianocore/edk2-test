...
#
CaseGuid           2DDB8A4A-9120-40de-A456-A04F7A8B9139
CaseName           Transmit.Conf7.Case1
CaseCategory       IP6
CaseDescription    { Test the Transmit Function of IP6 - invoke Transmit()          \
                     Token->Packet.TxData->FragmentTable[].FragmentLength is zero    \    
...
# Begin Scope ...
#
BeginScope        IP6_TRANSMIT_CONF7_CASE1_
...
#
# Check point:Call Transmit Function when Token->Packet.TxData.FragmentTable.FragmentLength is Zero.
#             EFI_INVALID_PARAMETER should be returned.
#
Ip6->Transmit         " &@R_Token, &@R_Status"
GetAck
set assert            [VerifyReturnStatus  R_Status  $EFI_INVALID_PARAMETER]
RecordAssertion       $assert           $Ip6TransmitConf7AssertionGuid001                                     \
                      "Ip6->Transmit -Conf- Call the function Transmit  with Token->Packet.TxData.FragmentTable.FragmentLength is Zero " \
...
# End scope
#
EndScope          IP6_TRANSMIT_CONF7_CASE1_
#
# End log
#
EndLog
