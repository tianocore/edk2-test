...
#
CaseGuid        1E8F4FDA-8DD3-4bf5-91D4-F8BD9A6973F4
CaseName        Release.Func3.Case1
CaseCategory    DHCP6
...
# EndScope
#
EndScope _DHCP6_RELEASE_FUNC3_
#
# End Log 
#
EndLog
...
# BeginScope
#
BeginScope  _DHCP6_RELEASE_FUNC3_
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Dhcp6ReleaseFunc3AssertionGuid001 \
                "Dhcp6.Release-Release all the Ipv6 addresses that have already assigned to the configured IA" \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
#
# Check point: After all the Ipv6 addresses are released,the IaInfoEvent should be signaled,\
#              and the state of IA should be Dhcp6Init.
#
...
RecordAssertion $assert $Dhcp6ReleaseFunc3AssertionGuid002 \
                "Dhcp6.Release- When  Ipv6 Address of  IA changed,the IaInfoEvent will be signaled and IaInfoEventcontext add 1"
...
RecordAssertion $assert  $Dhcp6ReleaseFunc3AssertionGuid003 \
