...
# BeginScope
#
BeginScope  _DHCP6_CONFIGURE_CONF1_
...
# o CallbackContext            0          
# o OptionCount                1          NOTE: larger than zero
# o OptionList                 0          NOTE: NULL
...
#
# Check point: Configure this child with an invalid ConfigData
#              EFI_INVALID_PARAMETER should be returned.
#
Dhcp6->Configure  "&@R_ConfigData, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Dhcp6ConfigureConf1AssertionGuid001                   \
                "Dhcp6.Config - OptionCount is larger than zero and OptionList is NULL"          \
...
# EndScope
#
EndScope _DHCP6_CONFIGURE_CONF1_
#
# End Log 
#
EndLog
