...
#
CaseGuid        9DA68F88-D0D7-4881-9AEB-EB9EE722FF21
CaseName        Release.Conf4.Case1
CaseCategory    DHCP6
...
proc CleanUpEutEnvironment {} {
    ...
    # EndScope
    #
    EndScope _DHCP6_RELEASE_CONF4_
    #
    # End Log 
    #
    EndLog
...
# BeginScope
#
BeginScope  _DHCP6_RELEASE_CONF4_
...
#
# Check point: Call Release() when any specified address in Addresses 
...
RecordAssertion $assert $Dhcp6ReleaseConf4AssertionGuid001           \
                "Dhcp6.Release - AddressCount is zero."                       \
