...
#
CaseGuid        46782D2C-F9F0-4d15-9D9E-A46AB0898C5F
CaseName        Release.Conf2.Case1
CaseCategory    DHCP6
...
# BeginScope
#
BeginScope  _DHCP6_RELEASE_CONF2_
...
#              Call Release when the instance is not in Dhcp6Bound state.
#              EFI_ACCESS_DENIED should be returned.
#
...
RecordAssertion $assert $Dhcp6ReleaseConf2AssertionGuid001                   \
                "Dhcp6.Release - Call Release when the instance is not in the Dhcp6Bound state."  \
...
# EndScope
#
EndScope _DHCP6_RELEASE_CONF2_
#
# End Log 
#
EndLog
