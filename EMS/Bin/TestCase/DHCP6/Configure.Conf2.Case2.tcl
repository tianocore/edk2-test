...
#
# Build an option of Reconfig Accept
#
UINT8          R_OpData
SetVar         R_OpData                             0
EFI_DHCP6_PACKET_OPTION                             R_OptPacketReconfigAccept
SetVar         R_OptPacketReconfigAccept.OpCode     $Dhcp6OptReconfigAccept
SetVar         R_OptPacketReconfigAccept.OpLen      0
SetVar         R_OptPacketReconfigAccept.Data       @R_OpData

POINTER        R_OptionPtr
SetVar         R_OptionPtr                    &@R_OptPacketReconfigAccept
...
# o CallbackContext            0          
# o OptionCount                1
# o OptionList                 Invalid:   Contains ReconfigAccept option       
...
#
# Check point: Configure this child with a ConfigData containing Reconfig Accept option.
#              EFI_INVALID_PARAMETER should be returned.
#
Dhcp6->Configure  "&@R_ConfigData, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Dhcp6ConfigureConf2AssertionGuid002                   \
                "Dhcp6.Config - Option List contains Reconfigure Accept option"                \
