...
#
CaseGuid        393F706E-4DBC-40bd-8A68-606340BEAFCE
...
# BeginScope
#
BeginScope  _DHCP6_START_CONF4_
...
# o Dhcp6Callback              1          0:NULL 1:Abort 2:DoNothing
# o CallbackContext            0          
# o OptionCount                0        
# o OptionList                 0          
...
SetVar R_ConfigData.Dhcp6Callback              1
...
#
# Check point: Call Start() when the user returns error status from callback function.
#              EFI_ABORTED should be returned.
#
Dhcp6->Start "&@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_ABORTED]
RecordAssertion $assert $Dhcp6StartConf4AssertionGuid001                   \
                "Dhcp6.Start - The user returns error from callback function"                \
