...
#
CaseGuid        249CA827-53FD-4fd6-9EBF-FA13271DFB9E
CaseName        InfoRequest.Conf4.Case1
CaseCategory    DHCP6
CaseDescription {Test the InfoRequest Conformance of DHCP6 - Invoke InfoRequest() \
                 with Retransmission NULL. \
...
# BeginScope
#
BeginScope  _DHCP6_INFOREQUEST_CONF4_
...
#
# Check point: Call InfoRequest with Retrasmission being NULL
#              EFI_INVALID_PARAMETER should be returned.
#
Dhcp6->InfoRequest "@R_SendClientId, &@R_OptionRequest, @R_OptionCount, @R_OptionList, \
                                                    0, 0, @R_ReplyCallback, &@R_CallbackContext, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Dhcp6InfoRequestConf4AssertionGuid001   \
                        "Dhcp6.InfoRequest - Retransmission is NULL"      \
...
# EndScope
#
EndScope _DHCP6_INFOREQUEST_CONF4_
#
# End Log 
#
EndLog
