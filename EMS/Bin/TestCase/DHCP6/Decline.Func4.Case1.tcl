...
#
CaseGuid        38D426C1-07B4-45f0-8944-8795B6200A6B
CaseName        Decline.Func4.Case1
CaseCategory    DHCP6
...
# EndScope
#
EndScope _DHCP6_DECLINE_FUNC4_
#
# End Log 
#
EndLog
...
# BeginScope
#
BeginScope  _DHCP6_DECLINE_FUNC4_
...
#
# Call the Decline function with no response from server,the Decline must succeed.
#
GetAck
set assert [VerifyReturnStatus R_Status $EFI_NO_RESPONSE]
RecordAssertion $assert $Dhcp6DeclineFunc4AssertionGuid001 \
...
#
# Check point: This is a synchronous call and when Decline returns,the state of the IA should be Dhcp6Init. 
#
...
RecordAssertion $assert  $Dhcp6DeclineFunc4AssertionGuid002 \
                "When Decline-with no response from server, the state of IA should be Dhcp6Init"
