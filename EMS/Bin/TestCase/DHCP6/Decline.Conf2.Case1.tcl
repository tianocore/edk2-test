...
#
CaseGuid        0418B3A6-14F2-487b-A3C7-FB8F6DC3B820
CaseName        Decline.Conf2.Case1
CaseCategory    DHCP6
...
# BeginScope
#
BeginScope  _DHCP6_DECLINE_CONF2_
...
#              Call Decline when the instance is not in Dhcp6Bound state.
#              EFI_ACCESS_DENIED should be returned.
#
...
RecordAssertion $assert $Dhcp6DeclineConf2AssertionGuid001                   \
                "Dhcp6.Decline - Call Decline when the instance is not in the Dhcp6Bound state."  \
...
# EndScope
#
EndScope _DHCP6_DECLINE_CONF2_
#
# End Log 
#
EndLog
