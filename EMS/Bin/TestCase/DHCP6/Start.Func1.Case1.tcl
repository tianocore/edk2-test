...
#
CaseGuid        76BCC018-E922-4cfd-B392-E123D72F83EB
CaseName        Start.Func1.Case1
CaseCategory    DHCP6

CaseDescription {Test the Start Function of DHCP6 - Invoke Start() \
                 to start DHCPv6 S.A.R.R process.
                }
################################################################################
...
# BeginScope
#
BeginScope  _DHCP6_START_FUNC1_
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Dhcp6StartFunc1AssertionGuid001 \
...
RecordAssertion $assert  $Dhcp6StartFunc1AssertionGuid002 \
...
RecordAssertion $assert  $Dhcp6StartFunc1AssertionGuid003 \
