...
#
CaseGuid        5890416D-50AB-4810-A1D3-8507064D74EB
CaseName        InfoRequest.Conf6.Case1
CaseCategory    DHCP6
CaseDescription {Test the InfoRequest Conformance of DHCP6 - Invoke InfoRequest() \
                 with ReplyCallback NULL. \
...
# BeginScope
#
BeginScope  _DHCP6_INFOREQUEST_CONF6_
...
SetVar R_ReplyCallback                  0

#
# Check point: Call InfoRequest() with ReplyCallback being NULL.
#              EFI_INVALID_PARAMETER should be returned.
#
...
RecordAssertion $assert $Dhcp6InfoRequestConf6AssertionGuid001   \
                        "Dhcp6.InfoRequest - ReplyCallback is NULL"       \
...
# EndScope
#
EndScope _DHCP6_INFOREQUEST_CONF6_
#
# End Log 
#
EndLog