...
#
CaseGuid        0CCBC09A-3BD2-4f01-8724-30B24407DC3C
...
# EndScope
#
EndScope _DHCP6_RELEASE_FUNC1_
#
# End Log 
#
EndLog
...
# BeginScope
#
BeginScope  _DHCP6_RELEASE_FUNC1_
...
#
# Call Release to release one of the Ipv6 address that has already assigned to the configured IA.
#
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Dhcp6ReleaseFunc1AssertionGuid001 \
                "Dhcp6.Release-Release one of the Ipv6 address that has already assigned to the configured IA" \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"

#
# Check point: After the Release exchange process returns,the state of IA should be Dhcp6Bound.
#
...
RecordAssertion $assert  $Dhcp6ReleaseFunc1AssertionGuid002 \
                "When Release-Reply process finished, the state of IA should be Dhcp6Bound"
