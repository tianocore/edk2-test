...
#
CaseGuid        9B611AD5-F664-4860-9FCD-51436CBBB8F6
CaseName        ReadFile.Func2.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile, Server  \
                 don't copy the client's option strings verbatim from the RRQ  \
                 packet to the OACK packet.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION2_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION2_CASE1_
...
#
# If have captured the packet. Server don't copy the client's option strings   
#  verbatim from the RRQ packet to the OACK packet.
#
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid004                    \
                "Mtftp4.ReadFile - Server don't copy the client's option strings\
                 verbatim from the RRQ packet to the OACK packet."             \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
