...
#
CaseGuid        0506F6DE-0F4E-4f31-83E9-315F51FC65CD
CaseName        WriteFile.Func2.Case3
CaseCategory    MTFTP4
CaseDescription {This case is to test the function of Mtftp4.WriteFile, Server \
                 replies WRQ with an invalid BlockNo ACK instead of OACK, client\
                 should ignore this packet and continue the normal process.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_WRITEFILE_FUNCTION2_CASE3_
  EndLog
}
...
BeginScope _MTFTP4_WRITEFILE_FUNCTION2_CASE3_
...
#
# If have captured the packet. Server replies WRQ with an invalid BlockNo ACK 
# instead of OACK, client should ignore this packet and continue the normal 
# process.
#
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4WriteFileFuncAssertionGuid006                   \
                "Mtftp4.WriteFile - Server replies WRQ with an invalid BlockNo \
                 ACK instead of OACK, client should ignore this packet and     \
