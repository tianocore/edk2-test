...
#
CaseGuid        C6FD7241-36E9-4860-969C-E4CEA5FD4DAA
CaseName        ReadFile.Conf2.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the conformance of Mtftp4.ReadFile -     \
                 Active client receives an MTFTPv4 ERROR packet.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE2_CASE2_
  EndLog
}
#
# Begin log ...
...
BeginScope _MTFTP4_READFILE_CONFORMANCE2_CASE2_
...
#
# If have captured the packet. Active client receive an MTFTPv4 ERROR packet.
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid004                    \
                "Mtftp4.ReadFile - Active client receives an MTFTPv4 ERROR     \
                 packet."                                                      \
