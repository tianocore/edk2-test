...
#
CaseGuid        9D4548EA-4ACA-434a-BFE0-9C2711B12925
CaseName        ReadFile.Conf2.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_TFTP_ERROR conformance of        \
                 Mtftp4.ReadFile with an MTFTPv4 ERROR packet being received.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE2_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE2_CASE1_
...
#
# If have captured the packet. Send an Mtftp4 Error packet.
#
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid003                    \
                "Mtftp4.ReadFile()- returns EFI_TFTP_ERROR with an MTFTPv4     \
                 ERROR packet being received."                                 \
