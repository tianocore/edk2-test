...
#
CaseGuid        9985D25B-CF37-46bd-BE19-41C993BA83BB
CaseName        ReadFile.Conf9.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_ICMP_ERROR conformance of        \
                 Mtftp4.ReadFile with an ICMP ERROR packet being received.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE9_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE9_CASE1_
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid040                    \
                "Mtftp4.ReadFile - Server responses with ICMP error packet,    \
