...
#
CaseGuid        5C76DEB2-7D35-48d9-8FD9-F5E111744D93
CaseName        ReadFile.Conf8.Case3
CaseCategory    MTFTP4
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE8_CASE3_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE8_CASE3_
...
# the passive download process in CheckPacket callback routine when receiving 
# data packets.
...
#
# wait for passive client to join in the multicast group
#
Stall 1
RemoteIp            234.5.6.7
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid036                    \
