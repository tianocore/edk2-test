...
#
CaseGuid          1D3DED3E-69E8-4068-BDB4-228ED4EF391C
CaseName          GetInfo.Conf6.Case2
CaseCategory      MTFTP4
CaseDescription   {This case is to test the EFI_NETWORK_UNREACHABLE conformance of      \
                   Mtftp4.GetInfo when an ICMP net unreachable packet was received and in\
                   the buffer.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_GETINFO_CONFORMANCE6_CASE2_
  EndLog
}
...
BeginScope _MTFTP4_GETINFO_CONFORMANCE6_CASE2_
...
RecordAssertion $assert $Mtftp4GetInfoConfAssertionGuid014                     \
                "Mtftp4.GetInfo - Server responses with ICMP net unreachable packet,     \
