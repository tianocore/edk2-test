...
CaseDescription {This case is to test the Function of Mtftp4.ReadFile, Server  \
                 responses with normal OACK packet - active flag is set.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION1_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION1_CASE1_
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid001                    \
