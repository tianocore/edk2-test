...
#
CaseGuid        C421EA2D-951E-4610-B340-A6E63C7FD119
CaseName        ReadFile.Conf2.Case3
CaseCategory    MTFTP4
CaseDescription {This case is to test the Conformance of Mtftp4.ReadFile -     \
                Passive client received an MTFTPv4 ERROR packet.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE2_CASE3_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE2_CASE3_
...
#
# If have captured the packet,send an MTFTPv4 ERROR packet to Passive client.
...
#
# wait for the client to join in the multicast group
#
Stall 1

SendPacket [ Mtftp4CreateError $client_prt ]

GetAck

set assert [VerifyReturnStatus R_Status $EFI_TFTP_ERROR]
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid005                    \
                "Mtftp4.ReadFile - returns EFI_TFTP_ERROR for passive client   \
                 has received an MTFTPv4 ERROR packet."                        \
