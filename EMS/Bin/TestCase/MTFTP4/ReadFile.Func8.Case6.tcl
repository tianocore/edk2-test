...
#
CaseGuid        DD1EE918-8D6E-49e0-B458-FD07AEA0280A
CaseName        ReadFile.Func8.Case6
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile- passive \
                 client receive unexpected OACK packet when downloading file.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION8_CASE6_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION8_CASE6_
...
SetVar R_MtftpConfigData.TimeoutValue        5
...
#
# If have captured the packet. active client receive unexpected OACK packet when
# downloading file.
...
#
# Send the OACK packet again when client is waiting for the data.
#
RemoteIp            192.168.88.88
RemoteEther         [GetTargetMac]
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid020                    \
                "Mtftp4.ReadFile - passive client receives unexpected OACK packet\
