...
#
CaseGuid        46DC76FF-FC85-41d4-8658-8D24F8503B2B
CaseName        Poll.Conf1.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_NOT_STARTED conformance of       \
                Mtftp4.Poll, with the EFI MTFTPv4 Protocol driver having not  \
                been started.}
################################################################################
...
BeginScope _MTFTP4_POLL_CONFORMANCE1_CASE1_
...
# check point
#
Mtftp4->Poll {&@R_Status}
GetAck

set assert [VerifyReturnStatus R_Status $EFI_NOT_STARTED]
RecordAssertion $assert $Mtftp4PollConfAssertionGuid001                        \
                "Mtftp4.Poll - returns EFI_NOT_STARTED with the EFI MTFTPv4    \
                 Protocol driver having not been started."                     \
...
EndScope _MTFTP4_POLL_CONFORMANCE1_CASE1_
