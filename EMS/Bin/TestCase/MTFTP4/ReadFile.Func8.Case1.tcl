...
#
CaseGuid        345D897E-E4CB-4466-B6CE-BDD34F9113D3
CaseName        ReadFile.Func8.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile, client is\
                 passive client and it receives unexpected packet(BlockNo is   \
                 before).}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION8_CASE1_
  EndLog
}
#
# Begin log ...
...
BeginScope _MTFTP4_READFILE_FUNCTION8_CASE1_
...
#
# If have captured the packet. client is passive client and it receives        
# unexpected packet(BlockNo is before).
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid015                    \
                "Mtftp4.ReadFile - client is passive and it receives           \
                 unexpected packet(BlockNo is before)."                        \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
