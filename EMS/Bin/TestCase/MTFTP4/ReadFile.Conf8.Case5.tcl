...
#
CaseGuid        1595FD4F-A301-46d4-ACEA-E417203793F6
CaseName        ReadFile.Conf8.Case5
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_ABORTED Conformance of           \
                 Mtftp4.ReadFile - User aborts the active download process when\
                 having receive Ack in TimeoutCallback routine.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE8_CASE5_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE8_CASE5_
...
# the active download process in TimeOutCallback routine when receiving 
# Ack.
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid038                    \
                "Mtftp4.ReadFile - returns EFI_ABORTED. User aborts the active \
                 download process in TimeoutCallback routine when receiving    \
                 Ack"                                                          \
