...
#
CaseGuid        0866DA7C-06A3-41df-A083-BB8D0A18F2B1
CaseName        WriteFile.Func1.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the function of Mtftp4.WriteFile - upload \
                 a packet with data length equal to 1 byte.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_WRITEFILE_FUNCTION1_CASE2_
  EndLog
}
...
BeginScope _MTFTP4_WRITEFILE_FUNCTION1_CASE2_
...
#
# If have captured the packet. upload a packet with data length equal to 1 byte.
#
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4WriteFileFuncAssertionGuid002                   \
                "Mtftp4.WriteFile - upload a packet with data length equaling to\
                 1 byte."                                                      \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
