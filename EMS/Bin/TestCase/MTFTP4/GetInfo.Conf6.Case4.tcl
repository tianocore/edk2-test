...
#
CaseGuid          A297E199-0FAF-4de2-8E50-63333B3CCDF9
CaseName          GetInfo.Conf6.Case4
CaseCategory      MTFTP4
CaseDescription   {This case is to test the EFI_PROTOCOL_UNREACHABLE conformance of      \
                   Mtftp4.GetInfo when an ICMP protocol unreachable packet was received and in\
                   the buffer.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_GETINFO_CONFORMANCE6_CASE4_
  EndLog
}
...
BeginScope _MTFTP4_GETINFO_CONFORMANCE6_CASE4_
...
#
# If have captured the packet. Sends out a ICMP protocol unreachable packet.
#
...
RecordAssertion $assert $Mtftp4GetInfoConfAssertionGuid016                     \
                "Mtftp4.GetInfo - Server responses with ICMP protocol unreachable packet,     \
