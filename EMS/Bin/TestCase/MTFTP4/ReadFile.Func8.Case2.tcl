...
#
CaseGuid        73A3A1FA-0C96-42bd-99E6-E2B1FE894FE7
CaseName        ReadFile.Func8.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile - client \
                 is passive client and it receives unexpected packet(BlockNo is\
                 further).}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION8_CASE2_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION8_CASE2_
...
SendPacket [ Mtftp4CreateData 1234 $EFI_MTFTP4_OPCODE_DATA 6 100]

GetAck

set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid016                    \
                "Mtftp4.ReadFile - client is passive and it receives unexpected\
                 packet(BlockNo is further)."                                  \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
