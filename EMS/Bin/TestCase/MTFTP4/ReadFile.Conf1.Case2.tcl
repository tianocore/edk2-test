...
#
CaseGuid        4095B2AB-15FB-4112-9948-CA85E155278C
CaseName        ReadFile.Conf1.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_TIMEOUT conformance, for Passive \
                 Client doesn't receive any data packet from the server.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE1_CASE2_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE1_CASE2_
...
#
# If have captured the packet. Passive Client doesn't receive any data 
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid002                    \
                "Mtftp4.ReadFile - returns EFI_TIMEOUT for passive Client      \
                 doesn't receive any data packet from the server."             \
