...
#
CaseGuid        D27646C0-7E67-49fc-B1F5-233D68FC78C7
CaseName        ReadFile.Conf9.Case5
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_PORT_UNREACHABLE conformance of        \
                 Mtftp4.ReadFile with an ICMP port unreachable packet being received.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE9_CASE5_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE9_CASE5_
...
#
# If have captured the packet. Sends out an ICMP port unreachable packet.
#
...
CreatePacket icmp_error -t icmp -icmp_type 3 -icmp_code 3 -icmp_orig_len 66    \
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid045                    \
                "Mtftp4.ReadFile - Server responses with ICMP port unreachable packet,    \
