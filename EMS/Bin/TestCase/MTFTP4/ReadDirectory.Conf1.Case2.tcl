...
#
CaseGuid        2B7EA107-E9C9-475d-8635-9B0196445DBD
CaseName        ReadDirectory.Conf1.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_INVALID_PARAMETER conformance of \
                 Mtftp4.ReadDirectory with Token->Filename being NULL.}
################################################################################
...
BeginScope _MTFTP4_READDIRECTORY_CONFORMANCE1_CASE2_
...
RecordAssertion $assert $Mtftp4ReadDirectoryConfAssertionGuid002               \
                "Mtftp4.ReadDirectory - Token->Filename is NULL."              \
...
EndScope _MTFTP4_READDIRECTORY_CONFORMANCE1_CASE2_
