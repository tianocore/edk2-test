...
#
CaseGuid        48AC9381-DEDF-4ed6-A07A-09D9AD08C2E9
CaseName        WriteFile.Conf1.Case4
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_INVALID_PARAMETER conformance of \
                 Mtftp4.WriteFile for Token->Buffer and Token->PacketNeeded    \
                 are both NULL.}
################################################################################
...
BeginScope _MTFTP4_WRITEFILE_CONFORMANCE1_CASE4_
...
RecordAssertion $assert $Mtftp4WriteFileConfAssertionGuid004                   \
                "Mtftp4.WriteFile - R_Token->Buffer and R_Token->PacketNeeded  \
                 are both NULL."                                               \
...
EndScope _MTFTP4_WRITEFILE_CONFORMANCE1_CASE4_
