...
#
CaseGuid        105186B3-FDF3-43e6-B5F9-40FC39FF4CB7
CaseName        WriteFile.Conf7.Case3
CaseCategory    MTFTP4
CaseDescription {This case is to test the function of Mtftp4.WriteFile - User  \
                 aborts the upload process in PacketNeeded callback routine.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_WRITEFILE_CONFORMANCE7_CASE3_
  EndLog
}
...
BeginScope _MTFTP4_WRITEFILE_CONFORMANCE7_CASE3_
...
Mtftp4->WriteFile {&@R_Token, 1, 1, 2, &@R_Status}
...
RecordAssertion $assert $Mtftp4WriteFileConfAssertionGuid015                   \
                "Mtftp4.WriteFile - returns EFI_ABORTED, User aborts the upload\
                 process in PacketNeeded callback routine."                    \
