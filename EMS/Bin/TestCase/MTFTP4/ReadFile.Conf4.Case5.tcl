...
#
CaseGuid        22C07630-BB72-44c2-A36A-C7498018F4AB
CaseName        ReadFile.Conf4.Case5
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_INVALID_PARAMETER conformance of \
                 Mtftp4.ReadFile with Token->OverrideData being not valid      \
                 unicast IPV4 addresses if Token.OverrideData is not NULL.}
################################################################################
...
BeginScope _MTFTP4_READFILE_CONFORMANCE4_CASE5_
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid024                    \
                "Mtftp4.ReadFile - returns EFI_INVALID_PARAMETE with           \
                 OverrideData.GatewayIp being invalid."                        \
...
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid025                    \
                "Mtftp4.ReadFile - returns EFI_INVALID_PARAMETER with          \
                 OverrideData.ServerIp being invalid."                         \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"
...
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid026                    \
                "Mtftp4.ReadFile - returns EFI_INVALID_PARAMETE when           \
                 OverrideData.GatewayIp is not in the same subnet with stationIP."\
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"
...
EndScope _MTFTP4_READFILE_CONFORMANCE4_CASE5_
