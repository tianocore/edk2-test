...
BeginScope _MTFTP4_READFILE_CONFORMANCE4_CASE1_
...
Mtftp4->ReadFile {NULL, 1, 1, 1, &@R_Status}

GetAck

set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid020                    \
                "Mtftp4.ReadFile() - returns EFI_INVALID_PARAMETER with Token  \
                 being NULL."                                                  \
...
EndScope _MTFTP4_READFILE_CONFORMANCE4_CASE1_
