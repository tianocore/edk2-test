...
#
CaseGuid        4B1B3707-18C9-460a-8F83-A4FEE5D8DC2D
CaseName        ReadFile.Conf4.Case4
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_INVALID_PARAMETER conformance of \
                 Mtftp4.ReadFile with Token->Buffer and Token->CheckPacket     \
                 are both NULL.}
################################################################################
...
BeginScope _MTFTP4_READFILE_CONFORMANCE4_CASE4_
...
Mtftp4->ReadFile {&@R_Token, 4, 1, 1, &@R_Status}

GetAck

set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid023                    \
...
EndScope _MTFTP4_READFILE_CONFORMANCE4_CASE4_
#
# End Log
#
EndLog
