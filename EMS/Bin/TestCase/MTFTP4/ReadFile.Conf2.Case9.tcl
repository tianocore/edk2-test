...
#
CaseGuid        F6AFDFCD-B1F0-4688-AFD7-083894415A62
CaseName        ReadFile.Conf2.Case9
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_TFTP_ERROR Conformance of        \
                Mtftp4.ReadFile - Server add more other options in the OACK    \
                packet.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE2_CASE9_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE2_CASE9_
...
#
# If have captured the packet. Server add more other options in the OACK packet.
#
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid016                    \
                "Mtftp4.ReadFile - Server add more other options in the OACK   \
                 packet."                                                      \
