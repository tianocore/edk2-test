...
CaseDescription {This case is to test the Function of Mtftp4.ReadFile, Server  \
                response the Data with incorrect sequence of the block numbers.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION6_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION6_CASE1_
...
#
# If have captured the packet. Server response the Data with incorrect sequence
...
SendPacket [ Mtftp4CreateData 1234 $EFI_MTFTP4_OPCODE_DATA 2 100] 

#
# client still sends ack1 for the second data packet
#
...
ValidateAck TempPacket5 2

GetAck

set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid010                    \
                "Mtftp4.ReadFile - Server responses the Data with incorrect    \
                 sequence of the block numbers."                               \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
