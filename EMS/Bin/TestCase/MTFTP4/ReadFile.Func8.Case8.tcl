...
#
CaseGuid        3CC00185-F6EA-42dc-AA19-3C8B047FB119
CaseName        ReadFile.Func8.Case8
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile - the    \
                 passive client download while missing the last packet. after  \
                 client is timeout, server sets client to be passive again and \
                 sends out all the packets.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION8_CASE8_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION8_CASE8_
...
#
# If have captured the packet. Test the passive client download, miss the last 
# packet. after client timeout, server sets client to be passive again and sends
# out all the packets.
...
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid022                    \
                "Mtftp4.ReadFile - When the passive client downloads, it misses\
                 the last packet. After client is timeout, server sets client to\
