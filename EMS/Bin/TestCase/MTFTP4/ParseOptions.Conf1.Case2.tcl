...
#
CaseGuid        A1A9096E-2234-4751-BE98-0437F9603187
CaseName        ParseOptions.Conf1.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_INVALID_PARAMETER conformance of \
                 Mtftp4.ParseOptions when Packet is NULL or Packet is not a    \
                 valid MTFTPv4 Packet.}
################################################################################
...
BeginScope _MTFTP4_PARSEOPTIONS_CONFORMANCE1_CASE2_
...
Mtftp4->ParseOptions {@R_PacketLen, NULL, &@R_OptionCount, &@R_OptionList,     \
                     &@R_Status}

GetAck

set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4ParseOptionsConfAssertionGuid002                \
                "Mtftp4.ParseOptions - returns EFI_INVALID_PARAMETER when      \
                 Packet is NULL."                                              \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"
#
# check point
# Not a valid MTFTP4 OpCode
#
SetVar R_PacketLen          50
SetVar R_Packet.OpCode      0x11
SetVar R_Packet.Oack.OpCode 0x11
...
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4ParseOptionsConfAssertionGuid003                \
                "Mtftp4.ParseOptions - returns EFI_INVALID_PARAMETER when      \
                 Packet is not a valid MTFTPv4 Packet."                        \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"
...
# Not a valid MTFTP4 OpCode
#
SetVar R_PacketLen          5
SetVar R_Packet.OpCode      0x01
SetVar R_Packet.Oack.OpCode 0x01
...
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4ParseOptionsConfAssertionGuid004                \
                "Mtftp4.ParseOptions - returns EFI_INVALID_PARAMETER when      \
                 Packet is not a valid MTFTPv4 Packet."                        \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"
...
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4ParseOptionsConfAssertionGuid005                \
                "Mtftp4.ParseOptions - returns EFI_INVALID_PARAMETER when      \
                 Packet is not a valid MTFTPv4 Packet."                        \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"
...
EndScope _MTFTP4_PARSEOPTIONS_CONFORMANCE1_CASE2_
