...
#
CaseGuid        FC992AEF-47EA-4464-875B-AC863CF45B04
CaseName        WriteFile.Conf4.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_UNSUPPORTED conformance of       \
                Mtftp4.WriteFile, one or more options in the R_Token->OptionList\
                are in the unsupported list of this implementation.}
################################################################################
...
BeginScope _MTFTP4_WRITEFILE_CONFORMANCE4_CASE1_
...
RecordAssertion $assert $Mtftp4WriteFileConfAssertionGuid010                   \
                "Mtftp4.WriteFile - One or more options in the                 \
...
EndScope _MTFTP4_WRITEFILE_CONFORMANCE4_CASE1_
