...
#
CaseGuid        F528AAF5-3E36-4b99-AE8C-6219C15376C1 
CaseName        ReadFile.Conf4.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_INVALID_PARAMETER conformance of \
                 Mtftp4.ReadFile with Token->Filename being NULL.}
################################################################################
...
BeginScope _MTFTP4_READFILE_CONFORMANCE4_CASE2_
...
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid021                    \
                "Mtftp4.ReadFile - Token->Filename being NULL."                \
...
EndScope _MTFTP4_READFILE_CONFORMANCE4_CASE2_
#
# End Log
#
EndLog