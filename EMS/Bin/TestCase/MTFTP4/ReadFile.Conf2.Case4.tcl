...
#
CaseGuid        AFEE9DE1-0A30-44bb-B90F-01D79A1D5A84
CaseName        ReadFile.Conf2.Case4
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_TFTP_ERROR conformance of        \
                 Mtftp4.ReadFile - Server responses with error OACK packet -   \
                 active/passive flag error.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE2_CASE4_
  EndLog
}
#
# Begin log ...
...
BeginScope _MTFTP4_READFILE_CONFORMANCE2_CASE4_
UINTN                            R_Status
UINTN                            R_Handle1
...
#
# If have captured the packet. Server responses with error OACK packet - active/
# passive flag error.
#
DumpPacket TempPacket1
set client_prt [ Mtftp4GetSrcPort TempPacket1 ]

set option_value_array(multicast) "234.5.6.7,1234,3"
...
#
# Capture ack and check whether it is a packet with Error Code.
#
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid006                    \
                "Mtftp4.ReadFile - returns EFI_TFTP_ERROR for Server responses \
                 with error OACK packet -  active/passive flag error."         \
