...
#
CaseGuid        431C0D34-E5CB-4fca-A7C5-CDCEA199E7B2
CaseName        ReadFile.Func8.Case7
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile - the    \
                 passive client downloads while missing the last packet. after \
                 client is timeout, server sets client to be passive again and \
                 sends out the lost packet.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION8_CASE7_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION8_CASE7_
...
#
# If have captured the packet - the passive client download while missing the 
# last packet. after client is timeout, server sets client to be passive again 
# and sends out the lost packet.
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid021                    \
                "Mtftp4.ReadFile - Test the passive client downloading while   \
                 missing the last packet. after client is timeout, server sets \
                 client to be passive again and sends out the lost packet."    \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
