...
#
CaseGuid        190442C8-82C2-4677-B0AB-F1E8EB503559
CaseName        ReadFile.Func6.Case4
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile, User    \
                 Override Data to replace the configure data and retry counter \
                 is set to zero in override data.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION6_CASE4_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION6_CASE4_
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid013                    \
                "Mtftp4.ReadFile - User Override Data to replace the configure \
                 data and retry counter is set to zero in override data"       \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
