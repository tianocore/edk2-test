...
#
CaseGuid        C3092110-533E-44e0-88D6-06D9852E2A22
CaseName        ReadFile.Conf9.Case4
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_PROTOCOL_UNREACHABLE conformance of        \
                 Mtftp4.ReadFile with an ICMP protocol unreachable packet being received.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE9_CASE4_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE9_CASE4_
...
#
# If have captured the packet. Sends out an ICMP protocol unreachable packet.
#
...
CreatePacket icmp_error -t icmp -icmp_type 3 -icmp_code 2 -icmp_orig_len 66    \
...
set assert [VerifyReturnStatus R_Status $EFI_PROTOCOL_UNREACHABLE]
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid044                    \
                "Mtftp4.ReadFile - Server responses with ICMP protocol unreachable packet,    \
                 client should terminate the session."                         \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_PROTOCOL_UNREACHABLE"
