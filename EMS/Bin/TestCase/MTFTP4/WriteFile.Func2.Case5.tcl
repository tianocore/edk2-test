...
#
CaseGuid        7089729E-7E32-4fca-8A44-A8386AB03DF3
CaseName        WriteFile.Func2.Case5
CaseCategory    MTFTP4
CaseDescription {This case is to test the function of Mtftp4.WriteFile, Client \
                 receives an unexpected OACK when waiting for ACK packet during\
                 uploading file.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_WRITEFILE_FUNCTION2_CASE5_
  EndLog
}
...
BeginScope _MTFTP4_WRITEFILE_FUNCTION2_CASE5_
...
#
# If have captured the packet, respond an ACK packet.
#
...
#
# Client receive an unexpected OACK when waiting for ACK packet during uploading
# file.
#
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4WriteFileFuncAssertionGuid008                   \
                 "Mtftp4.WriteFile - Client receive an unexpected OACK when    \
                  waiting for ACK packet during uploading file."               \
                 "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
