...
#
CaseGuid          2DB4E48E-6D0A-4973-98A6-6F9E6463501B
CaseName          GetInfo.Conf6.Case5
CaseCategory      MTFTP4
CaseDescription   {This case is to test the EFI_PORT_UNREACHABLE conformance of      \
                   Mtftp4.GetInfo when an ICMP port unreachable packet was received and in\
                   the buffer.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_GETINFO_CONFORMANCE6_CASE5_
  EndLog
}
...
BeginScope _MTFTP4_GETINFO_CONFORMANCE6_CASE5_
...
#
# If have captured the packet. Sends out a ICMP port unreachable packet.
#
...
RecordAssertion $assert $Mtftp4GetInfoConfAssertionGuid017                     \
                "Mtftp4.GetInfo - Server responses with ICMP port unreachable packet,     \
