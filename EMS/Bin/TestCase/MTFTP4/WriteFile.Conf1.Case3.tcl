...
#
CaseGuid        DE184DB1-71C8-4311-B90E-698F8FA23F74
CaseName        WriteFile.Conf1.Case3
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_INVALID_PARAMETER conformance of \
                 Mtftp4.WriteFile when Token->OptionCount is not zero and      \
...
BeginScope _MTFTP4_WRITEFILE_CONFORMANCE1_CASE3_
...
RecordAssertion $assert $Mtftp4WriteFileConfAssertionGuid003                   \
                "Mtftp4.WriteFile - returns EFI_INVALID_PARAMETER for          \
                 R_Token->OptionCount is not zero and R_Token->OptionList is   \
                 NULL."                                                        \
...
EndScope _MTFTP4_WRITEFILE_CONFORMANCE1_CASE3_
