...
#
CaseGuid        C15D3073-44A5-4ecc-80DE-0A7D778E182C
CaseName        ReadFile.Func8.Case5
CaseCategory    MTFTP4
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION8_CASE5_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION8_CASE5_
...
# Client should send out an ACK packet again.
#
SendPacket [ Mtftp4CreateOack $client_prt $EFI_MTFTP4_OPCODE_OACK]
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid019                    \
                "Mtftp4.ReadFile - active client receive unexpected OACK packet\
