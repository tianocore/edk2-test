...
#
CaseGuid        4CDB4A62-E36E-4afa-A9F1-D03C255084ED
CaseName        ReadFile.Func6.Case3
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile, download\
                  a file with length equal to 1 byte.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION6_CASE3_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION6_CASE3_
...
#
# If have captured the packet. download a file with length equal to 1 byte.
...
#
# Capture ack and response with data packet.
#
...
SendPacket [ Mtftp4CreateData 1234 $EFI_MTFTP4_OPCODE_DATA 1 1] 
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid012                    \
                "Mtftp4.ReadFile - download a file with length equaling to 1   \
                 byte."                                                        \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
