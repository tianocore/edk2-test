...
#
CaseGuid        AB75CD58-36C6-4d09-AC4F-036AE55885A1
CaseName        ReadFile.Conf8.Case4
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_ABORTED Conformance of           \
                 ...
                 CheckPacket callback routine when receiving OACK packets.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE8_CASE4_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE8_CASE4_
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid037                    \
