...
#
CaseGuid        1712793D-8B24-45ec-8C46-057AF011D609
...
CaseDescription {This case is to test the EFI_ABORTED Conformance of           \
                 ...
                 CheckPacket callback routine when receiving data packets.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE8_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE8_CASE1_
...
Mtftp4->ReadFile {&@R_Token, 2, 1, 1, &@R_Status}
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid034                    \
