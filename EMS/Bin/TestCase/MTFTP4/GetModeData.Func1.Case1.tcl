...
#
CaseGuid          A53EA665-66CA-4d2a-AF0E-041D75A608E7
CaseName          GetModeData.Func1.Case1
CaseCategory      MTFTP4
CaseDescription   {This case is to test the Function of Mtftp4.GetModeData().  \
                   GetModeData() returns EFI_SUCCESS with all valid invocation.}
################################################################################
...
BeginScope _MTFTP4_GETMODEDATA_FUNCTION1_CASE1_
...
EFI_MTFTP4_MODE_DATA             R_ModeData
...
# Check point
#
Mtftp4->GetModeData {&@R_ModeData, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4GetModeDataFuncAssertionGuid001                 \
                "Mtftp4.GetModeData - GetModeData() returns                    \
                 EFI_SUCCESS with all valid invocation."                       \
...
EndScope _MTFTP4_GETMODEDATA_FUNCTION1_CASE1_
