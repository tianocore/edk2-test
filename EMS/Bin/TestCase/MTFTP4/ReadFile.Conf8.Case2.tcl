...
#
CaseGuid        B23EF552-43DC-49ae-A9F3-D970C2D9F251
CaseName        ReadFile.Conf8.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_ABORTED Conformance of           \
                 Mtftp4.ReadFile - User aborts the active download process in  \
                 CheckPacket callback routine when receiving OACK packet.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE8_CASE2_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE8_CASE2_
...
Mtftp4->ReadFile {&@R_Token, 3, 1, 1, &@R_Status}
...
# the active download process in CheckPacket callback routine when receiving 
# OACK packet.
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid035                    \
                "Mtftp4.ReadFile - returns EFI_ABORTED. User aborts the active \
                 download process in CheckPacket callback routine when receiving\
                 OACK packet."                                                 \
                "ReturnR_Status - $R_Status, ExpectedR_Status - $EFI_ABORTED"
