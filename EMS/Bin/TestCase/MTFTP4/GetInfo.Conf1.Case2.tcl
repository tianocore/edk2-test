...
#
CaseGuid          E60CA233-523D-40e7-80F2-621CCA7BD9D3
CaseName          GetInfo.Conf1.Case2
CaseCategory      MTFTP4
CaseDescription   {This case is to test the EFI_INVALID_PARAMETER conformance  \
                   of Mtftp4.GetInfo with OverrideData being invalid.}
################################################################################
...
BeginScope _MTFTP4_GETINFO_CONFORMANCE1_CASE2_
...
RecordAssertion $assert $Mtftp4GetInfoConfAssertionGuid002                     \
                "Mtftp4.GetInfo() - returns EFI_INVALID_PARAMETER              \
                 with OverrideData.GatewayIp is invalid."                      \
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4GetInfoConfAssertionGuid003                     \
                "Mtftp4.GetInfo() - returns EFI_INVALID_PARAMETER              \
                 with OverrideData.ServerIp is invalid."                       \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_INVALID_PARAMETER"
...
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp4GetInfoConfAssertionGuid004                     \
                "Mtftp4.GetInfo() - returns EFI_INVALID_PARAMETER              \
                 when OverrideData.GatewayIp and OverrideData.ServerIp are     \
...
EndScope _MTFTP4_GETINFO_CONFORMANCE1_CASE2_
