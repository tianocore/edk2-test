...
#
CaseGuid        34538E37-A2D0-42b3-9B82-2BE22F510D65
CaseName        ReadFile.Conf2.Case5
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_TFTP_ERROR conformance of        \
                 Mtftp4.ReadFile - timeout option value in OACK packet is      \
                 invalid.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE2_CASE5_
  EndLog
}
#
# Begin log ...
...
BeginScope _MTFTP4_READFILE_CONFORMANCE2_CASE5_
...
set option_value_array(timeout) "256"
set option_value_len(timeout) 3
...
#
# Capture ack and validate whether it is an error packet.
#
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid007                    \
                "Mtftp4.ReadFile - returns EFI_TFTP_ERROR with timeout option\
                 value in OACK packet being invalid."                          \
