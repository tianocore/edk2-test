...
#
CaseGuid        20D5B765-8954-4c04-815D-C3AEE7B32F15
CaseName        WriteFile.Func2.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the function of Mtftp4.WriteFile - server \
                 responds with incorrect ack packet.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_WRITEFILE_FUNCTION2_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_WRITEFILE_FUNCTION2_CASE1_
...
#
# If have captured the packet. server response with incorrect ack packet.
#
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4WriteFileFuncAssertionGuid004                   \
                "Mtftp4.WriteFile - server responds with incorrect ack packet."\
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
