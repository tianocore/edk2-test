...
#
CaseGuid        DDE0814A-C04F-4d15-8A3C-7601627E063E
CaseName        WriteFile.Conf7.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_ABORTED conformance of           \
                 Mtftp4.WriteFile - User aborts the upload process in          \
                 CheckPacket callback routine.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_WRITEFILE_CONFORMANCE7_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_WRITEFILE_CONFORMANCE7_CASE1_
...
Mtftp4->WriteFile {&@R_Token, 2, 1, 1, &@R_Status}
...
#
# If have captured the packet. Test the function of Mtftp4.WriteFile, User 
#  aborts the upload process in CheckPacket callback routine.
#
...
RecordAssertion $assert $Mtftp4WriteFileConfAssertionGuid013                   \
                "Mtftp4.WriteFile - returns EFI_ABORTED,User aborts the upload \
                 process in CheckPacket callback routine."                     \
