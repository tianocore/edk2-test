...
#
CaseGuid        62FC1572-4356-47e7-B035-B8F557F48D8E
CaseName        WriteFile.Func2.Case6
CaseCategory    MTFTP4
CaseDescription {This case is to test the function of Mtftp4.WriteFile, Client \
                 receive an error server source port ACK when waiting for ACK  \
                 packet.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_WRITEFILE_FUNCTION2_CASE6_
  EndLog
}
...
BeginScope _MTFTP4_WRITEFILE_FUNCTION2_CASE6_
...
CreatePacket  mtftp4_ack -t udp -udp_sp 6666 -udp_dp $client_prt -udp_payload  \
              mtftp4_ack_pld
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4WriteFileFuncAssertionGuid009                   \
                "Mtftp4.WriteFile - Client receives an error server source port\
                 ACK when waiting for ACK packet."                             \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
