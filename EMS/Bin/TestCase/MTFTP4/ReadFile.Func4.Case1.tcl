...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION4_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION4_CASE1_
...
#
# If have captured the packet. Server don't support option extension.
# Send back with Data packet.
#
...
#
# Validate the response ack packet from the client.
#
...
#
ValidateAck TempPacket2 1 

GetAck

set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid007                    \
                "Mtftp4.ReadFile - Server don't support option extension."     \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
