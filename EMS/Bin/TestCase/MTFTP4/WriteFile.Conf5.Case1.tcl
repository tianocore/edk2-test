...
#
CaseGuid        579AC6E8-464D-4b62-BABC-E0C55027C056
CaseName        WriteFile.Conf5.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_TFTP_ERROR conformance of        \
                 Mtftp4.WriteFile - client receives an MTFTPv4 ERROR packet    \
                 during uploading.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_WRITEFILE_CONFORMANCE5_CASE1_
  EndLog
}
...
BeginScope _MTFTP4_WRITEFILE_CONFORMANCE5_CASE1_
...
#
# If have captured the packet. client receive an MTFTPv4 ERROR packet during 
# uploading.
#
...
RecordAssertion $assert $Mtftp4WriteFileConfAssertionGuid011                   \
                "Mtftp4.WriteFile - returns EFI_TFTP_ERROR, client receives an \
                 MTFTPv4 ERROR packet during uploading."                       \
