...
#
CaseGuid        E8904F8C-8BDE-40a6-97C7-1241770A37A9
CaseName        ReadFile.Func8.Case4
CaseCategory    MTFTP4
CaseDescription {This case is to test the Function of Mtftp4.ReadFile - client \
                 receive unexpected ACK packet when downloading file.}
################################################################################
...
#
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_FUNCTION8_CASE4_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_FUNCTION8_CASE4_
...
#
# If have captured the packet. Server responses with normal OACK packet - active
# flag is set.
# Need to set the option array as the following:
# set option_value_array(blksize) "512"
# set option_value_len(blksize) 3
#
...
#
# send an unexpected ack to client
#
set blk_number 1
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp4ReadFileFuncAssertionGuid018                    \
                "Mtftp4.ReadFile - client receive unexpected ACK packet when   \
                 downloading file."                                            \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
