...
#
CaseGuid        3F736F53-9437-46d1-BD85-39F3FCDC66CE
CaseName        ParseOptions.Conf1.Case1
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_INVALID_PARAMETER conformace of  \
                Mtftp4.ParseOptions with PacketLen being 0.}
################################################################################
...
BeginScope _MTFTP4_PARSEOPTIONS_CONFORMANCE1_CASE1_
#
...
RecordAssertion $assert $Mtftp4ParseOptionsConfAssertionGuid001                \
               "Mtftp4.ParseOptions() - return EFI_INVALID_PARAMETER with      \
                PacketLen being 0."                                            \
...
EndScope _MTFTP4_PARSEOPTIONS_CONFORMANCE1_CASE1_
