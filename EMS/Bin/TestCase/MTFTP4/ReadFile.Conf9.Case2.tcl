...
#
CaseGuid        E751C483-1AF4-4dd8-A896-FAE25222C1F2
CaseName        ReadFile.Conf9.Case2
CaseCategory    MTFTP4
CaseDescription {This case is to test the EFI_NETWORK_UNREACHABLE conformance of        \
                 Mtftp4.ReadFile with an ICMP net unreachable packet being received.}
################################################################################
...
proc CleanUpEutEnvironment {} {
  ...
  EndCapture
  EndScope _MTFTP4_READFILE_CONFORMANCE9_CASE2_
  EndLog
}
...
BeginScope _MTFTP4_READFILE_CONFORMANCE9_CASE2_
...
#
# If have captured the packet. Sends out an ICMP net unreachable packet.
#
...
CreatePacket icmp_error -t icmp -icmp_type 3 -icmp_code 0 -icmp_orig_len 66    \
...
RecordAssertion $assert $Mtftp4ReadFileConfAssertionGuid042                    \
                "Mtftp4.ReadFile - Server responses with ICMP net unreachable packet,    \
