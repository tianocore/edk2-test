...
#
CaseGuid           B5B247CC-4D75-48c9-94CD-3EE2F2F5807F
CaseName           Close.Conf3.Case1
CaseCategory       TCP6
CaseDescription    {This case is to test the conformance - EFI_INVALID_PARAMETER.     \
                   -- Close must not succeed when completion token event is NULL.}
################################################################################
...
# BeginScope
#
BeginScope _TCP6_CLOSE_CONF3_CASE1_
...
#
# Check Point: Call Tcp6.Close() to close a connection with the event NULL
#
SetVar R_Close_CloseToken.CompletionToken.Event    0
SetVar R_Close_CloseToken.AbortOnClose             FALSE

Tcp6->Close {&@R_Close_CloseToken, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp6CloseConf3AssertionGuid001                     \
                "Tcp6.Close with the event NULL."                                   \
...
# EndScope
#
EndScope _TCP6_CLOSE_CONF3_CASE1_
