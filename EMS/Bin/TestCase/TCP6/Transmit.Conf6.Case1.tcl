...
#
CaseGuid           1943D949-6B99-444e-B2FD-9413BBEA9E40
CaseName           Transmit.Conf6.Case1
CaseCategory       TCP6
CaseDescription    {This case is to test the conformance - EFI_INVALID_PARAMETER.     \
                   -- Transmit must not succeed when data length isn't the sum of all fragment buffer length.}
################################################################################
...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_TRANSMIT_CONF6_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_TRANSMIT_CONF6_CASE1_
...
set  L_FragmentLength1           16
set  L_FragmentLength2           32
...
#             when data length isn't the sum of all fragment buffer length.
#

set L_TCPTransmitPayload1 "0123456789ABCDEF"
set L_TCPTransmitPayload2 "0123456789ABCDEF0123456789ABCDEF"

SetVar R_TxData.Push                      FALSE
SetVar R_TxData.Urgent                    FALSE
SetVar R_TxData.DataLength                64
SetVar R_TxData.FragmentCount             2

SetVar R_FragmentBuffer1                   $L_TCPTransmitPayload1
...
SetVar R_TxData.FragmentTable(0)          @R_FragmentTable1
SetVar R_TxData.FragmentTable(1)          @R_FragmentTable2
...
RecordAssertion $assert $Tcp6TransmitConf6AssertionGuid001                     \
                "Tcp6.Transmit - Call Transmit() with data length isn't the sum of all fragment buffer length."     \
