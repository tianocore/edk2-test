...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_RECEIVE_CONF2_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_RECEIVE_CONF2_CASE1_
...
#              with the token NULL.
#
Tcp6->Receive {NULL, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp6ReceiveConf2AssertionGuid001                     \
                "Tcp6.Receive - Call Receive() with the token NULL."     \
