...
#
CaseGuid           89E384A3-1A8F-4ace-BB5A-772E757C81A3
CaseName           Receive.Conf8.Case1
CaseCategory      TCP6
CaseDescription   {This case is to test the conformance - EFI_ACCESS_DENIED.     \
                   -- Receive must not succeed when instance has not connected in active mode.}
################################################################################
...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_RECEIVE_CONF8_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_RECEIVE_CONF8_CASE1_
...
#              with the instance hasn't connected in active mode.
#
...
RecordAssertion $assert $Tcp6ReceiveConf8AssertionGuid001                     \
                "Tcp6.Receive - Call Receive() with the instance hasn't connected in active mode."     \
