...
#
CaseGuid          072DD0DB-2E3C-4bec-9966-91AC796D24BD
CaseName          Connect.Conf2.Case1
CaseCategory      TCP6
CaseDescription   {This case is to test the conformance - EFI_INVALID_PARAMETER.     \
                  -- Connect must not succeed when connection token is NULL.}
################################################################################
...
# BeginScope
#
BeginScope _TCP6_CONNECT_CONF2_CASE1_
...
#              connection token is NULL.
#

Tcp6->Connect {NULL, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp6ConnectConf2AssertionGuid001                      \
                "Tcp6.Connect - Open an active connection after config with ConnectionToken is NULL."      \
...
# End Scope
#
EndScope _TCP6_CONNECT_CONF2_CASE1_
