...
#
CaseGuid          228A394D-43F0-4485-AB03-2774280176A5
CaseName          Accept.Conf2.Case1
CaseCategory      TCP6
CaseDescription   {This case is to test the conformance - EFI_ACCESS_DENIED.     \
                  -- Accept must not succeed when instance isn't in passive mode.}
################################################################################
...
# BeginScope
#
BeginScope _TCP6_ACCEPT_CONF2_CASE1_
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $GenericAssertionGuid                \
                "Tcp6.Configure - Call Configure() with valid config data (active mode)"         \
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"


#
# Check Point: Call Tcp6.Accept() in active mode.
#
...
RecordAssertion $assert $Tcp6AcceptConf2AssertionGuid001                       \
                "Tcp6.Accept - Call Accept() in active mode."           \
...
# EndScope
#
EndScope _TCP6_ACCEPT_CONF2_CASE1_
