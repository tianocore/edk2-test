...
#
CaseGuid           E0700E47-95CF-4c43-A997-57766F8BB3B1
CaseName           Close.Conf4.Case1
CaseCategory       TCP6
CaseDescription    {This case is to test the conformance - EFI_ACCESS_DENIED.     \
                   -- Close must not succeed when completion token event has already been used.}
################################################################################
...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_CLOSE_CONF4_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_CLOSE_CONF4_CASE1_
...
#
# Check Point: Call Tcp6.Close() to close a connection with the event has 
#              already been used. 
#
SetVar R_Close_CloseToken2.CompletionToken.Event @R_Close_CompletionToken1.Event
SetVar R_Close_CloseToken2.AbortOnClose   FALSE

Tcp6->Close {&@R_Close_CloseToken2, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_ACCESS_DENIED]
RecordAssertion $assert $Tcp6CloseConf4AssertionGuid001                     \
                "Tcp6.Close with the event has already been used."                      \
