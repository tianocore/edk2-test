...
#
CaseGuid           308C035F-E611-41bf-AF92-4CF8011B95EC
CaseName          Connect.Conf4.Case1
CaseCategory      TCP6
CaseDescription   {This case is to test the conformance - EFI_ACCESS_DENIED.     \
                  -- Connect must not succeed when the instance is configured as passive mode.}
################################################################################
...
# BeginScope
#
BeginScope _TCP6_CONNECT_CONF4_CASE1_
...
#
# Check Point: Call Tcp6.Connect() in passive mode with valid parameters.
#
SetVar R_Context 0
...
RecordAssertion $assert $Tcp6ConnectConf4AssertionGuid001                      \
                "Tcp6.Connect - Connect cannot succeed when configured in passive mode."      \
...
# End Scope
#
EndScope _TCP6_CONNECT_CONF4_CASE1_
