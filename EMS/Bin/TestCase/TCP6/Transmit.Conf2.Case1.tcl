...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_TRANSMIT_CONF2_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_TRANSMIT_CONF2_CASE1_
...
Tcp6->Transmit {NULL, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp6TransmitConf2AssertionGuid001                     \
                "Tcp6.Transmit - Call Transmit() with TransmitToken NULL."     \
