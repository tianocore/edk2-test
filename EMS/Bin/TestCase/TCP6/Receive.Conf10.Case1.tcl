...
#
CaseGuid           81A00243-33E7-4fcb-A4B3-A0FFD11D1E7A
CaseName           Receive.Conf10.Case1
CaseCategory       TCP6
CaseDescription    {This case is to test the conformance - EFI_ACCESS_DENIED.     \
                   -- Receive must not succeed when user has closed the connection.}
################################################################################
...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_RECEIVE_CONF10_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_RECEIVE_CONF10_CASE1_
...
#              with the connection has already been closed by user.
#
...
RecordAssertion $assert $Tcp6ReceiveConf10AssertionGuid001                     \
                "Tcp6.Receive - Call Receive() when user has closed the connection."     \
