...
#
CaseGuid           A3A4B458-A746-4aea-BFB7-A4057E604635
CaseName           Receive.Conf6.Case1
CaseCategory       TCP6
CaseDescription    {This case is to test the conformance - EFI_INVALID_PARAMETER.     \
                   -- Receive must not succeed when data length isn't the sum of all fragment buffer length.}
################################################################################
...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_RECEIVE_CONF6_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_RECEIVE_CONF6_CASE1_
...
#              with datalength isn't the sum of fragment lengths.
#
...
RecordAssertion $assert $Tcp6ReceiveConf6AssertionGuid001                     \
                "Tcp6.Receive - Call Receive() with the datalength isn't the sum of fragment lengths."     \
