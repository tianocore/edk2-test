...
#
CaseGuid           4FF25AC3-CF08-4cec-9AF8-E25EADF652C9
...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_TRANSMIT_CONF9_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_TRANSMIT_CONF9_CASE1_
...
#             when the instance has not been accepted in passive mode
#
...
RecordAssertion $assert $Tcp6TransmitConf9AssertionGuid001                     \
                "Tcp6.Transmit - Call Transmit() with the instance has not accepted in passive mode ."     \
