...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_RECEIVE_CONF4_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_RECEIVE_CONF4_CASE1_
...
SetVar R_Receive_IOToken.Packet_Buffer    0

Tcp6->Receive {&@R_Receive_IOToken, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp6ReceiveConf4AssertionGuid001                     \
                "Tcp6.Receive - Call Receive() with the RxData NULL."     \
