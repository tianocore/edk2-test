...
#
CaseGuid          8F0AC5EE-EF00-4414-BBD6-4B46E8E52A24
CaseName          Accept.Conf4.Case1
CaseCategory      TCP6
CaseDescription   {This case is to test the conformance - EFI_INVALID_PARAMETER.     \
                  -- Accpet must not succeed when listen token is NULL.}
################################################################################
...
# BeginScope
#
BeginScope _TCP6_ACCEPT_CONF4_CASE1_
...
#
# Check Point: Call Tcp6.Accept(), with ListenToken is NULL.
#
Tcp6->Accept {NULL, &@R_Status}
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Tcp6AcceptConf4AssertionGuid001                       \
                "Tcp6.Accept - Call Accept() with ListenToken NULL."           \
...
# EndScope
#
EndScope _TCP6_ACCEPT_CONF4_CASE1_
