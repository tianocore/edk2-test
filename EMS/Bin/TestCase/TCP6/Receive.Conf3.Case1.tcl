...
proc CleanUpEUTEnvironmentEnd {} {
  ...
  DestroyPacket
  EndCapture
  EndScope _TCP6_RECEIVE_CONF3_CASE1_
  EndLog
}
...
# BeginScope
#
BeginScope _TCP6_RECEIVE_CONF3_CASE1_
...
SetVar R_Receive_CompletionToken.Event    0
...
RecordAssertion $assert $Tcp6ReceiveConf2AssertionGuid001                     \
                "Tcp6.Receive - Call Receive() with the event NULL."     \
