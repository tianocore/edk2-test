...
proc CleanUpEutEnvironment {} {
  EndCapture
  EndScope _IP4CONFIG_GETDATA_CONF1
  EndLog
}
...
# BeginScope
#
BeginScope _IP4CONFIG_GETDATA_CONF1
...
#
# Check Point: Call Ip4Config->GetData to Get data when not started.
#
Ip4Config->GetData "&@R_Ip4IpConfigDataSize, &@R_Ip4IpConfigData, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_NOT_STARTED]
RecordAssertion $assert $Ip4ConfigGetDataConf1AssertionGuid001                 \
                "Ip4Config.GetData - Call GetData when not started."           \
