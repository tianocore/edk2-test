...
#
CaseGuid        a81a775c-3a92-4442-9c21-f6c6701ca1d2
...
CaseDescription {This case is to test the Conformance - EFI_BUFFER_TOO_SMALL   \
                -- IpConfigDataSize is smaller than the configuration data     \
                buffer.}
...
#
# Check Point: Call DDhcp4->GetData to with Ip4ConfigDataSize smaller than the 
...
RecordAssertion $assert $Ip4ConfigGetDataConf3AssertionGuid001                 \
                "Ip4Config.GetData - Ip4ConfigDataSize smaller than data buffer."\
