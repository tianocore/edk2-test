...
#
CaseGuid        CA539453-FEA9-4870-90E9-1A03BC58E3B7
CaseName        Start.Func1.Case1
CaseCategory    IP4Config
CaseDescription {Test the function of IP4Config.Start.}
...
proc CleanUpEutEnvironment {} {
  ...
  EndScope _IP4CONFIG_START_FUNC1
...
# BeginScope
#
BeginScope _IP4CONFIG_START_FUNC1
...
#
# Check Point: Call Ip4Config->Start to start configuration.
#
Ip4Config->Start "@R_DoneEvent, @R_ReconfigEvent, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Ip4ConfigStartFunc1AssertionGuid001                   \
