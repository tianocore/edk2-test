...
BeginScope _MTFTP6_READFILE_CONFORMANCE6_CASE1_
...
#
# Check Point: Call ReadFile when buffer and check packet are \
#              both NULL.EFI_INVALID_PARAMETER should be returned.
# 
...
Mtftp6->ReadFile "&@R_Token, 4, 1, 1, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp6ReadFileConf6AssertionGuid001    \
                "Mtftp6.ReadFile -Conf- Call ReadFile when the buffer and check packet are both NULL"\
...
EndScope _MTFTP6_READFILE_CONFORMANCE6_CASE1_
