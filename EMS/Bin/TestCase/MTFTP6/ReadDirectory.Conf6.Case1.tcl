...
#
CaseGuid        CC92FF1C-8DCE-4093-86C5-955BCBF1FE23
CaseName        ReadDirectory.Conf6.Case1
CaseCategory    MTFTP6
...
BeginScope _MTFTP6_READDIRECTORY_CONFORMANCE6_CASE1_
...
#
# Check Point: Call ReadDirectory when buffer and Check Packet are both NULL. \
#              EFI_INVALID_PARAMETER should be returned.
# 
...
Mtftp6->ReadDirectory "&@R_Token, 4, 1, 1, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp6ReadDirectoryConf6AssertionGuid001       \
                "Mtftp6.ReadDirectory -Conf- Call ReadDirectory when buffer and CheckPacket are both NULL."  \
...
EndScope _MTFTP6_READDIRECTORY_CONFORMANCE6_CASE1_
