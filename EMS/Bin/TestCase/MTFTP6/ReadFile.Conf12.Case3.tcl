...
#
CaseGuid        46EABFB4-24F0-456e-8C16-32051066FA9C
CaseName        ReadFile.Conf12.Case3
CaseCategory    MTFTP6
CaseDescription {Test ReadFile conformance of MTFTP6,invoke ReadFile() when\
                 a icmp6 host unreachable error packet received for synchronous \
                 calling.EFI_HOST_UNREACHABLE should be returned.
                }
################################################################################
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READFILE_CONFORMANCE12_CASE3_
...
BeginScope _MTFTP6_READFILE_CONFORMANCE12_CASE3_
...
#
# If have captured the packet. Send an Icmpv6 host unreachable packet.
#
...
RecordAssertion $assert $Mtftp6ReadFileConf12AssertionGuid003    \
                "Mtftp6.ReadFile -Conf- Call ReadFile when a icmp6 host unreachable packet received for synchronous calling"\
