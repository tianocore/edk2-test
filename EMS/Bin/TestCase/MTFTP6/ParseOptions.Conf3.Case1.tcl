...
#
CaseGuid        CD432ED3-BE19-45f2-B25C-CEEECA0BE4B9
CaseName        ParseOptions.Conf3.Case1
CaseCategory    MTFTP6
CaseDescription {Test ParseOptions Conformance of MTFTP6 - Invoke ParseOptions()when  \
                 packet isn't a valid Mtftp6 format.EFI_INVALID_PARAMETER should be returned.}
################################################################################
...
BeginScope _MTFTP6_PARSEOPTIONS_CONFORMANCE3_CASE1_
...
#
# check point:Call ParseOptions when the packet isn't a valid Mtftp6 packet.\
...
RecordAssertion $assert $Mtftp6ParseOptionsConf3AssertionGuid001     \
               "Mtftp6.ParseOptions() -Conf- Call ParseOption when Packet isn't valid mtftp6 packet." \
...
EndScope _MTFTP6_PARSEOPTIONS_CONFORMANCE3_CASE1_
