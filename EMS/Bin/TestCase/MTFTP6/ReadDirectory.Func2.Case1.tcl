...
#
CaseGuid        6235F1AF-AD7B-4288-8738-4F9EAF24C697
CaseName        ReadDirectory.Func2.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadDirectory function of MTFTP6,invoke ReadDirectory() with valid  \
                 parameters for synchronous calling. EFI_SUCCESS should be returned. 
                }
################################################################################
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READDIRECTORY_FUNCTION2_CASE1_
...
BeginScope _MTFTP6_READDIRECTORY_FUNCTION2_CASE1_
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp6ReadDirectoryFunc2AssertionGuid001    \
...
RecordAssertion $assert $$Mtftp6ReadDirectoryFunc2AssertionGuid002              \
...
RecordAssertion $assert $$Mtftp6ReadDirectoryFunc2AssertionGuid003              \
