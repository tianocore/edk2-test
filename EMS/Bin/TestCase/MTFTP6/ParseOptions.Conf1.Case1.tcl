...
#
CaseGuid        55C953D7-82DB-4934-BC92-1AF9B81FAB9C
CaseName        ParseOptions.Conf1.Case1
CaseCategory    MTFTP6
CaseDescription {Test ParseOptions Conformance of MTFTP6 - Invoke ParseOptions()  \
                 when packet size is zero.EFI_INVALID_PARAMETER should be returned.}
################################################################################
...
BeginScope _MTFTP6_PARSEOPTIONS_CONFORMANCE1_CASE1_
...
#
# check point:Call ParseOptions when the packet size is zero.\
#             EFI_INVALID_PARAMETER should be returned.
#
UINT32                      R_PacketLen
SetVar R_PacketLen          0
...
RecordAssertion $assert $Mtftp6ParseOptionsConf1AssertionGuid001     \
               "Mtftp6.ParseOptions() -Conf- Call ParseOption when PacketLen is zero." \
...
EndScope _MTFTP6_PARSEOPTIONS_CONFORMANCE1_CASE1_
