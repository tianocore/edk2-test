...
#
CaseGuid        1A8D882A-AD46-4562-8001-AAB57A80FF3D
CaseName        ReadFile.Conf10.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadFile conformance of MTFTP6,invoke ReadFile() when\
                 aborted by user for synchronous calling.\
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READFILE_CONFORMANCE10_CASE1_
...
BeginScope _MTFTP6_READFILE_CONFORMANCE10_CASE1_
...
#
# Check Point: Call ReadFile when aborted by user for synchronous calling.\
#              EFI_ABORTED should be returned.
# 
...
Mtftp6->ReadFile "&@R_Token, 2, 1, 1, &@R_Status"
...
RecordAssertion $assert $Mtftp6ReadFileConf10AssertionGuid001    \
                "Mtftp6.ReadFile -Conf- Call ReadFile when aborted by user for synchronous calling"\
