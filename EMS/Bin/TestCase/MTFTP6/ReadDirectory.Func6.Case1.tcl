...
#
CaseGuid        03673D71-721C-4318-BBF4-E47381E9DA9D
CaseName        ReadDirectory.Func6.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadDirectory function of MTFTP6,invoke ReadDirectory() with no response \
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READDIRECTORY_FUNCTION6_CASE1_
...
BeginScope _MTFTP6_READDIRECTORY_FUNCTION6_CASE1_
...
Mtftp6->ReadDirectory "&@R_Token, 4, 1, 4, &@R_Status"
GetAck
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp6ReadDirectoryFunc6AssertionGuid001    \
                "Mtftp6.ReadDirectory -Func- Call ReadDirectory with no response received for asynchronous calling"\
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
RecordAssertion $assert $$Mtftp6ReadDirectoryFunc6AssertionGuid002              \
...
RecordAssertion $assert $$Mtftp6ReadDirectoryFunc6AssertionGuid003              \
                "When returned the Token.Status should be EFI_TIMEOUT."
