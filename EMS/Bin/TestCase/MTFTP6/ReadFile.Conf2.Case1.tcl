...
#
CaseGuid        A3E6314E-FAC3-4bef-B55F-D6B7680A5EE7
...
BeginScope _MTFTP6_READFILE_CONFORMANCE2_CASE1_
...
#
# Check Point: Call ReadFile when the token is NULL.\
#              EFI_INVALID_PARAMETER should be returned.
# 
Mtftp6->ReadFile "NULL, 1, 1, 1, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp6ReadFileConf2AssertionGuid001    \
                "Mtftp6.ReadFile -Conf- Call ReadFile when the token is NULL"   \
...
EndScope _MTFTP6_READFILE_CONFORMANCE2_CASE1_
