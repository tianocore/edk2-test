...
#
CaseGuid        E5E4E6B0-C1DD-4b5e-884E-510CCE5C59F4
CaseName        ReadFile.Func7.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadFile function of MTFTP6,invoke ReadFile()with no \
                 response received for asynchronous calling.  \
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READFILE_FUNCTION7_CASE1_
...
BeginScope _MTFTP6_READFILE_FUNCTION7_CASE1_
...
#
# Check Point: Call ReadFile with no response received for \
...
Mtftp6->ReadFile "&@R_Token, 4, 1, 4, &@R_Status"
GetAck
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp6ReadFileFunc7AssertionGuid001    \
                "Mtftp6.ReadFile -Func- Call ReadFile with no response received for synchronous calling"\
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
RecordAssertion $assert $Mtftp6ReadFileFunc7AssertionGuid002     \
...
RecordAssertion $assert $Mtftp6ReadFileFunc7AssertionGuid003       \
