...
#
CaseGuid        11D071BC-F2D9-4f90-B7D3-48CAA502B41E
CaseName        WriteFile.Func4.Case1
CaseCategory    MTFTP6
CaseDescription {Test WriteFile function of MTFTP6,invoke WriteFile()with a mtftp6 error \
                 packet received for asynchronous calling.EFI_SUCCESS should be returned.
                }
################################################################################
...
DestroyPacket
EndCapture
EndScope _MTFTP6_WRITEFILE_FUNCTION4_CASE1_
...
BeginScope _MTFTP6_WRITEFILE_FUNCTION4_CASE1_
...
#
# Check Point: Call WriteFile with a mtftp6 error packet for asynchronous\
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp6ReadFileFunc4AssertionGuid001    \
                "Mtftp6.WriteFile -Func- Call WriteFile with a mtftp6 error packet received for synchronous calling"\
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
RecordAssertion $assert $Mtftp6WriteFileFunc4AssertionGuid002     \
...
RecordAssertion $assert $Mtftp6WriteFileFunc4AssertionGuid003       \
