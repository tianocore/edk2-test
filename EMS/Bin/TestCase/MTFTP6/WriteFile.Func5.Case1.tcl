...
#
CaseGuid        EB9D3677-0FBD-484a-8CA9-3BA2086C526F
CaseName        WriteFile.Func5.Case1
CaseCategory    MTFTP6
CaseDescription {Test WriteFile function of MTFTP6,invoke WriteFile()with a icmp6 port \
                 unreachable error packet received for asynchronous calling.EFI_SUCCESS \
                 should be returned.
                }
################################################################################
...
DestroyPacket
EndCapture
EndScope _MTFTP6_WRITEFILE_FUNCTION5_CASE1_
...
BeginScope _MTFTP6_WRITEFILE_FUNCTION5_CASE1_
...
#
# Check Point: Call WriteFile with a icmp6 error packet for asynchronous\
...
Mtftp6->WriteFile "&@R_Token, 1, 4, 4, &@R_Status"
GetAck

ReceiveCcbPacket CCB Mtftp6Packet1 20
if { ${CCB.received} == 0} {
#
...
#
ParsePacket Mtftp6Packet1 -t IPv6 -IPv6_src IPV6Src -IPv6_dst IPV6Dst
SendPacket [Icmp6DstPortUnreach $IPV6Src $IPV6Dst]

set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp6WriteFileFunc5AssertionGuid001    \
                "Mtftp6.WriteFile -Func- Call WriteFile with a icmp6 error packet received for asynchronous calling"\
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
RecordAssertion $assert $Mtftp6WriteFileFunc5AssertionGuid002     \
...
RecordAssertion $assert $Mtftp6WriteFileFunc5AssertionGuid003       \
                "When returned, the R_Token.Status should be EFI_PORT_UNREACHABLE"
