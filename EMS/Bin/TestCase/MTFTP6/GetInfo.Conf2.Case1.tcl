...
#
CaseGuid          C822673A-0845-43f9-A7B6-E6B211906C96
CaseName          GetInfo.Conf2.Case1
CaseCategory      MTFTP6
CaseDescription   {Test GetInfo Conformance of MTFTP6 - Invoke GetInfo() \
                   when filename is NULL.EFI_NOT_STARTED should be returned.
                  }
################################################################################
...
BeginScope _MTFTP6_GETINFO_CONFORMANCE2_CASE1_
...
#
# check point: Call GetInfo function when filename is NULL. \
...
Mtftp6->GetInfo "&@R_OverrideData, NULL, NULL, @R_OptionCount, \
                                     &@R_OptionList, &@R_PacketLength, &@R_Packet, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp6GetInfoConf2AssertionGuid001               \
                "Mtftp6.GetInfo -conf- Call GetInfo when filename is NULL."  \
...
EndScope _MTFTP6_GETINFO_CONFORMANCE2_CASE1_
