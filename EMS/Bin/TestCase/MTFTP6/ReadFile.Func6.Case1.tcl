...
#
CaseGuid        6E14C310-06F7-4a26-B82A-1352ACFFA166
CaseName        ReadFile.Func6.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadFile function of MTFTP6,invoke ReadFile()with a \
                 icmp6 port unreachable error packet received for asynchronous \
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READFILE_FUNCTION6_CASE1_
...
BeginScope _MTFTP6_READFILE_FUNCTION6_CASE1_
...
#
# Check Point: Call ReadFile with a icmp6 error packet received for \
...
#
# If have captured the packet. Send a icmp6 Error packet.
#
ParsePacket Mtftp6Packet -t IPv6 -IPv6_src IPV6Src -IPv6_dst IPV6Dst
SendPacket [Icmp6DstPortUnreach $IPV6Src $IPV6Dst]

set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp6ReadFileFunc6AssertionGuid001    \
                "Mtftp6.ReadFile -Func- Call ReadFile with a icmp6 error packet received for synchronous calling"\
                "ReturnStatus - $R_Status, ExpectedStatus - $EFI_SUCCESS"
...
RecordAssertion $assert $Mtftp6ReadFileFunc6AssertionGuid002     \
...
RecordAssertion $assert $Mtftp6ReadFileFunc6AssertionGuid003       \
