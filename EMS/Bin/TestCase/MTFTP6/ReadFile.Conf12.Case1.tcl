...
#
CaseGuid        A23B444E-0BC4-42c1-93B1-17BEB8EDABBD
CaseName        ReadFile.Conf12.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadFile conformance of MTFTP6,invoke ReadFile() when\
                 a icmp6 port unreachable error packet received for synchronous \
                 calling.EFI_PORT_UNREACHABLE should be returned.
                }
################################################################################
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READFILE_CONFORMANCE12_CASE1_
...
BeginScope _MTFTP6_READFILE_CONFORMANCE12_CASE1_
...
RecordAssertion $assert $Mtftp6ReadFileConf12AssertionGuid001    \
                "Mtftp6.ReadFile -Conf- Call ReadFile when a icmp6 error packet received for synchronous calling"\
