...
#
CaseGuid        A78EB5F1-7579-48fb-B17B-8512B7FE581F
...
BeginScope _MTFTP6_WRITEFILE_CONFORMANCE4_CASE1_
...
RecordAssertion $assert $Mtftp6WriteFileConf4AssertionGuid001                     \
                "Mtftp6.WriteFile -Conf- Call WriteFile when OptionCount isn't zero and OptionList is NULL."\
...
EndScope _MTFTP6_WRITEFILE_CONFORMANCE4_CASE1_
