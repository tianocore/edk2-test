...
#
CaseGuid        3C6A65AC-BD5E-4be1-ADB0-99752FFD0AA9
CaseName        ReadDirectory.Conf3.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadDirectory conformance of MTFTP6,invoke ReadDirectory()when  \
                 FileName is NULL.EFI_INVALID_PARAMETER should be returned. 
                }
################################################################################
...
BeginScope _MTFTP6_READDIRECTORY_CONFORMANCE3_CASE1_
...
#
# Check Point: Call ReadDirectory when FileName is NULL.   \
...
RecordAssertion $assert $Mtftp6ReadDirectoryConf3AssertionGuid001       \
                "Mtftp6.ReadDirectory -Conf- Call ReadDirectory when FileName is NULL."  \
...
EndScope _MTFTP6_READDIRECTORY_CONFORMANCE3_CASE1_
