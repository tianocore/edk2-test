...
#
CaseGuid        FDF84170-FA01-49dd-9840-A371C711DDD5
CaseName        ReadDirectory.Func3.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadDirectory function of MTFTP6,invoke ReadDirectory() with aborted  \
                 by user for synchronous calling. EFI_SUCCESS should be returned. 
                }
################################################################################
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READDIRECTORY_FUNCTION3_CASE1_
...
BeginScope _MTFTP6_READDIRECTORY_FUNCTION3_CASE1_
...
Mtftp6->ReadDirectory "&@R_Token, 2, 4, 4, &@R_Status"
GetAck
...
set assert [VerifyReturnStatus R_Status $EFI_SUCCESS]
RecordAssertion $assert $Mtftp6ReadDirectoryFunc3AssertionGuid001    \
...
RecordAssertion $assert $$Mtftp6ReadDirectoryFunc3AssertionGuid002              \
...
RecordAssertion $assert $$Mtftp6ReadDirectoryFunc3AssertionGuid003              \
                "When returned the Token.Status should be EFI_ABORTED."
