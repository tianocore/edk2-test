...
#
CaseGuid        FCB30357-BE31-4012-8CF0-451BD4124137
CaseName        ReadDirectory.Conf12.Case1
CaseCategory    MTFTP6
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READDIRECTORY_CONFORMANCE12_CASE1_
...
BeginScope _MTFTP6_READDIRECTORY_CONFORMANCE12_CASE1_
...
#
# Check Point: Call ReadDirectory when no response received for synchronous calling. \
#              EFI_TIMEOUT should be returned.
# 
...
RecordAssertion $assert $Mtftp6ReadDirectoryConf12AssertionGuid001    \
                "Mtftp6.ReadDirectory -Conf- Call ReadDirectory when no response received for synchronous calling"\
