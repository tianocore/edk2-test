...
#
CaseGuid          3694EB25-2AB1-43d4-A865-FDC11B202C70
CaseName          GetInfo.Conf8.Case1
CaseCategory      MTFTP6
CaseDescription   {Test GetInfo Conformance of MTFTP6 - Invoke GetInfo() \
                   when a mtftp6 error packet received from the other side. 
...
DestroyPacket
EndCapture
EndScope _MTFTP6_GETINFO_CONFORMANCE8_CASE1_
...
BeginScope _MTFTP6_GETINFO_CONFORMANCE8_CASE1_
...
#
# check point: Call GetInfo function when a mtftp6 error packet received \
#              from the other side.EFI_TFTP_ERROR should be returned.
#
...
#
# If have captured the packet. Send back an MTFTPv6 ERROR packet.
#
...
set ErrorCodes $EFI_MTFTP6_ERRORCODE_NOT_DEFINED 
set ErrorMsg   "Not defined ErrorType"
CreatePayload  OpCode      Data   2  0x00 $EFI_MTFTP6_OPCODE_ERROR
CreatePayload  EndOfPacket const  1  0x00
CreatePayload  ErrorCodes  Data   2  0x00 $ErrorCodes
CreatePayload  ErrorMsg    string 22 $ErrorMsg
ConcatPayload  mtftp6error OpCode ErrorCodes ErrorMsg EndOfPacket
CreatePacket   mtftp6_error -t udp -Udp_sp $server_port -Udp_dp $client_port -Udp_len 35\
               -Udp_payload mtftp6error -IP_ver 6

SendPacket mtftp6_error
GetAck
set assert [VerifyReturnStatus R_Status $EFI_TFTP_ERROR]
RecordAssertion $assert $Mtftp6GetInfoConf8AssertionGuid001                         \
                "Mtftp6.GetInfo -conf- Call GetInfo when a mtftp6 error packet received from the other side."  \
