...
BeginScope _MTFTP6_WRITEFILE_CONFORMANCE6_CASE1_
...
#
# Check Point: Call WriteFile when buffer and PacketNeeded are both NULL. \
#              EFI_INVALID_PARAMETER should be returned.
# 
...
Mtftp6->WriteFile "&@R_Token, 1, 1, 3, &@R_Status"
GetAck
set assert [VerifyReturnStatus R_Status $EFI_INVALID_PARAMETER]
RecordAssertion $assert $Mtftp6WriteFileConf6AssertionGuid001                        \
                "Mtftp6.WriteFile -Conf- Call WriteFile when buffer and packet needed are both NULL."\
...
EndScope _MTFTP6_WRITEFILE_CONFORMANCE6_CASE1_
