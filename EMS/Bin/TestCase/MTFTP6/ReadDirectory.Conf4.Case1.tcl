...
#
CaseGuid        B453BF45-975C-405f-ADA1-563692A48E82
...
BeginScope _MTFTP6_READDIRECTORY_CONFORMANCE4_CASE1_
...
#
# Check Point: Call ReadDirectory when OptionCount isn't zero and OptionList is NULL. \
#              EFI_INVALID_PARAMETER should be returned.
# 
...
RecordAssertion $assert $Mtftp6ReadDirectoryConf4AssertionGuid001       \
                "Mtftp6.ReadDirectory -Conf- Call ReadDirectory when OptionCount isn't zero and OptionList is NULL."  \
...
EndScope _MTFTP6_READDIRECTORY_CONFORMANCE4_CASE1_
