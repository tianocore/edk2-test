...
#
CaseGuid        8FD31FE1-8D12-4d87-B5DC-9212AB6F27D7
CaseName        ReadDirectory.Conf10.Case1
CaseCategory    MTFTP6
CaseDescription {Test ReadDirectory conformance of MTFTP6,invoke ReadDirectory()    \
                 when a mtftp6 error packet received for synchronous calling.  \
...
DestroyPacket
EndCapture
EndScope _MTFTP6_READDIRECTORY_CONFORMANCE10_CASE1_
...
BeginScope _MTFTP6_READDIRECTORY_CONFORMANCE10_CASE1_
...
#
# Check Point: Call ReadDirectory when a mtftp6 error packet received for synchronous calling. \
#              EFI_TFTP_ERROR should be returned.
# 
...
RecordAssertion $assert $Mtftp6ReadDirectoryConf10AssertionGuid001    \
                "Mtftp6.ReadFile -Conf- Call ReadDirectory when a mtftp6 error packet received for synchronous calling"\
