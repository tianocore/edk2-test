...
#
CaseGuid          27410307-FAB9-41d7-936B-719E984E4192
CaseName          GetInfo.Conf6.Case1
CaseCategory      MTFTP6
CaseDescription   {Test GetInfo Conformance of MTFTP6 - Invoke GetInfo() \
                   when OverrideData.ServerIp is invalid unicast address. 
...
BeginScope _MTFTP6_GETINFO_CONFORMANCE6_CASE1_
...
#
# check point: Call GetInfo function when OverrideData.ServerIp is invalid  \
...
RecordAssertion $assert $Mtftp6GetInfoConf6AssertionGuid001                         \
                "Mtftp6.GetInfo -conf- Call GetInfo when OverrideData.ServerIp is invalid unicast address."  \
...
EndScope _MTFTP6_GETINFO_CONFORMANCE6_CASE1_
