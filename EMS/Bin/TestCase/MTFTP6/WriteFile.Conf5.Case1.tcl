...
#
CaseGuid        D6F7EDB9-198B-4528-BC3C-D713AE52F258
...
BeginScope _MTFTP6_WRITEFILE_CONFORMANCE5_CASE1_
...
#
# Check Point: Call WriteFile when one or more options in Optionlist is wrong format. \
#              EFI_INVALID_PARAMETER should be returned.
# 
...
RecordAssertion $assert $Mtftp6WriteFileConf5AssertionGuid001                        \
                "Mtftp6.WriteFile -Conf- Call WriteFile when one or more options in Optionlist is wrong formate."\
...
EndScope _MTFTP6_WRITEFILE_CONFORMANCE5_CASE1_
