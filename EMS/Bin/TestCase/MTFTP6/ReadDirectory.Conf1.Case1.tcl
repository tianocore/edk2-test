...
#
CaseGuid        A20DDFE7-A544-4614-8B35-273C6E8422F9
...
BeginScope _MTFTP6_READDIRECTORY_CONFORMANCE1_CASE1_
...
#
# Check Point: Call ReadDirectory when instance hasn't been configured.\
...
RecordAssertion $assert $Mtftp6ReadDirectoryConf1AssertionGuid001                  \
                "Mtftp6.ReadDirectory -Conf- Call ReadDirectory when the instance hasn't been configured."\
...
EndScope _MTFTP6_READDIRECTORY_CONFORMANCE1_CASE1_
