...
#
CaseGuid          4181AD27-D827-4346-90F9-790EE97D84A7
CaseName          GetInfo.Conf10.Case1
CaseCategory      MTFTP6
CaseDescription   {Test GetInfo Conformance of MTFTP6 - Invoke GetInfo() \
                   when a ICMPv6 port unreachable packet received from the other side. 
...
DestroyPacket
EndCapture
EndScope _MTFTP6_GETINFO_CONFORMANCE10_CASE1_
...
BeginScope _MTFTP6_GETINFO_CONFORMANCE10_CASE1_
...
#
# check point: Call GetInfo function when a ICMPv6 port unreachable packet received \
...
#
# If have captured the packet. Send back an ICMPv6 port unreachable packet.
#
ParsePacket Mtftp6Packet -t IPv6 -IPv6_src IPV6Src -IPv6_dst IPV6Dst
SendPacket [Icmp6Unreach $IPV6Src $IPV6Dst 0x04]
GetAck

set assert [VerifyReturnStatus R_Status $EFI_PORT_UNREACHABLE]
RecordAssertion $assert $Mtftp6GetInfoConf10AssertionGuid001                         \
                "Mtftp6.GetInfo -conf- Call GetInfo when a ICMPv6 port unreachable packet received from the other side."  \
